"""This module defines functionality for samples/02-agents/vector_stores/vector_store_models.
...
@dataclass
class LegacyFaq:
    """Represents the LegacyFaq type and related behavior.
    """
...
@dataclass
class LegacyArticle:
    """Represents the LegacyArticle type and related behavior.
    """
    article_id: int
    heading: str
...
class Note:
    """Represents the Note type and related behavior.
    """
    def __init__(
        self,
        ...
        Args:
            ...
            note_id: Description of note_id.
...
class Document(msgspec.Struct):
    """Represents the Document type and related behavior.
    """
...
@dataclass
class Hotel:
    """Represents the Hotel type and related behavior.
    """
...
class Product(BaseModel):
    """Represents the Product type and related behavior.
    """
