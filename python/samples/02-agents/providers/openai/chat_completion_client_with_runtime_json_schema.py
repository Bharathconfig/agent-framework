"""This module defines functionality for samples/02-agents/providers/openai/chat_completion_client_with_runtime_json_schema.
...
async def non_streaming_example() -> None:
    """Implements non streaming example.
    """
