"""This module defines functionality for samples/02-agents/mcp/agent_as_mcp_server.
...
def get_item_price(
    ...
    """Implements get item price.
    
    Args:
        menu_item: Description of menu_item.
...
async def run() -> None:
    ...
    async def handle_stdin(stdin: Any | None = None, stdout: Any | None = None) -> None:
        """Implements handle stdin.
        
        Args:
            stdin: Description of stdin.
