"""This module defines functionality for samples/02-agents/context_providers/simple_context_provider.
...
class UserInfo(BaseModel):
    """Represents the UserInfo type and related behavior.
    """
    name: str | None = None
    age: int | None = None
...
class UserInfoMemory(ContextProvider):
    """Represents the UserInfoMemory type and related behavior.
    """
