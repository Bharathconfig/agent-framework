"""This module defines functionality for samples/02-agents/context_providers/azure_content_understanding/04_invoice_processing.
...
class LineItem(BaseModel):
    """Represents the LineItem type and related behavior.
    """
    description: str
...
class LowConfidenceField(BaseModel):
    """Represents the LowConfidenceField type and related behavior.
    """
    field_name: str
    confidence: float
...
class InvoiceResult(BaseModel):
    """Represents the InvoiceResult type and related behavior.
    """
    vendor_name: str
