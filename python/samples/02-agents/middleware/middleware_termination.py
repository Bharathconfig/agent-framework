"""This module defines functionality for samples/02-agents/middleware/middleware_termination.
...
class PreTerminationMiddleware(AgentMiddleware):
    ...
    def __init__(self, blocked_words: list[str]):
        ...
        Args:
            ...
            blocked_words: Description of blocked_words.
        """
...
class PostTerminationMiddleware(AgentMiddleware):
    ...
    def __init__(self, max_responses: int = 1):
        ...
        Args:
            self: Description of self.
            max_responses: Description of max_responses.
        """
