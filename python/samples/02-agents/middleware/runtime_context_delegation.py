"""This module defines functionality for samples/02-agents/middleware/runtime_context_delegation.
...
async def pattern_2_hierarchical_with_kwargs_propagation() -> None:
    ...
    async def email_kwargs_tracker(
        ...
        """Implements email kwargs tracker.
