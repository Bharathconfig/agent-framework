"""This module defines functionality for samples/05-end-to-end/m365-agent/m365_agent_demo/app.
...
@dataclass
class AppConfig:
    """Represents the AppConfig type and related behavior.
    """
