"""This module defines functionality for samples/03-workflows/checkpoint/checkpoint_with_human_in_the_loop.
...
class ReviewGateway(Executor):
    ...
    def __init__(self, id: str, writer_id: str) -> None:
        ...
        Args:
            self: Description of self.
            id: Description of id.
            writer_id: Description of writer_id.
        """
        super().__init__(id=id)
