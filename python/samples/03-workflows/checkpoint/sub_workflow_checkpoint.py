"""This module defines functionality for samples/03-workflows/checkpoint/sub_workflow_checkpoint.
...
class DraftFinaliser(Executor):
    ...
    async def on_review_decision(
        ...
        """Implements on review decision.
        
        Args:
            self: Description of self.
            review_decision: Description of review_decision.
            ctx: Description of ctx.
        """
...
class LaunchCoordinator(Executor):
    ...
    async def collect_final(self, draft: FinalDraft, ctx: WorkflowContext[None, FinalDraft]) -> None:
        """Implements collect final.
        
        Args:
            self: Description of self.
            draft: Description of draft.
            ctx: Description of ctx.
        """
