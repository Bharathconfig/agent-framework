"""This module defines functionality for samples/03-workflows/agents/workflow_as_agent_reflection_pattern.
...
class Worker(Executor):
    ...
    async def handle_user_messages(self, user_messages: list[Message], ctx: WorkflowContext[ReviewRequest]) -> None:
        """Implements handle user messages.
        
        Args:
            self: Description of self.
            user_messages: Description of user_messages.
            ctx: Description of ctx.
        """
    ...
    async def handle_review_response(
        ...
        """Implements handle review response.
