"""This module defines functionality for samples/03-workflows/human-in-the-loop/agents_with_HITL.
...
class Coordinator(Executor):
    ...
    def __init__(self, id: str, writer_name: str, final_editor_name: str) -> None:
        ...
        Args:
            ...
            writer_name: Description of writer_name.
            final_editor_name: Description of final_editor_name.
        """
        super().__init__(id)
