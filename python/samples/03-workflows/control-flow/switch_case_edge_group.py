"""This module defines functionality for samples/03-workflows/control-flow/switch_case_edge_group.
...
class DetectionResult:
    ...
    """Represents the DetectionResult type and related behavior.
    """
    spam_decision: str
    reason: str
    email_id: str
...
async def to_detection_result(response: AgentExecutorResponse, ctx: WorkflowContext[DetectionResult]) -> None:
    ...
    """Implements to detection result.
