...
class ChatCompletionGroupChatManager(GroupChatManager):
    ...
    def __init__(self, *, topic: str, service: ChatCompletionClientBase, max_rounds: int | None = None) -> None:
        ...
        Args:
            ...
            max_rounds: Description of max_rounds.
        """
    ...
    async def should_request_user_input(self, chat_history: ChatHistory) -> BooleanResult:
        """Implements should request user input.
    ...
    async def select_next_agent(
        ...
        """Implements select next agent.
        
        Args:
            self: Description of self.
            chat_history: Description of chat_history.
            participant_descriptions: Description of participant_descriptions.
...
async def sk_agent_response_callback(message: ChatMessageContent | Sequence[ChatMessageContent]) -> None:
    """Implements sk agent response callback.
