...
class OrderStatusPlugin:
    """Represents the OrderStatusPlugin type and related behavior.
    """
    @kernel_function
    def check_order_status(self, order_id: str) -> str:
        """Implements check order status.
...
class OrderRefundPlugin:
    """Represents the OrderRefundPlugin type and related behavior.
    """
    @kernel_function
    def process_refund(self, order_id: str, reason: str) -> str:
        """Implements process refund.
...
class OrderReturnPlugin:
    """Represents the OrderReturnPlugin type and related behavior.
    """
    @kernel_function
    def process_return(self, order_id: str, reason: str) -> str:
        """Implements process return.
...
def build_semantic_kernel_agents() -> tuple[list[SKAgent], OrchestrationHandoffs]:
    """Implements build semantic kernel agents.
...
def _make_sk_human_responder(script: Iterator[str]) -> Callable[[], ChatMessageContent]:
    """Implements  make sk human responder.
...
async def run_semantic_kernel_example(initial_task: str, scripted_responses: Sequence[str]) -> str:
    """Implements run semantic kernel example.
    
    Args:
        initial_task: Description of initial_task.
        scripted_responses: Description of scripted_responses.
...
def _collect_handoff_requests(events: list[WorkflowEvent]) -> list[WorkflowEvent]:
    """Implements  collect handoff requests.
...
def _extract_final_conversation(events: list[WorkflowEvent]) -> list[Message]:
    """Implements  extract final conversation.
...
async def run_agent_framework_example(initial_task: str, scripted_responses: Sequence[str]) -> str:
    """Implements run agent framework example.
