"""This module defines functionality for packages/hyperlight/agent_framework_hyperlight/_instructions.
...
def _format_tool_summaries(tools: Sequence[FunctionTool]) -> str:
    """Implements  format tool summaries.
...
def _format_filesystem_capabilities(
    *,
    ...
    """Implements  format filesystem capabilities.
    
    Args:
        filesystem_enabled: Description of filesystem_enabled.
        workspace_enabled: Description of workspace_enabled.
        mounted_paths: Description of mounted_paths.
...
def _format_network_capabilities(
    *,
    ...
    """Implements  format network capabilities.
