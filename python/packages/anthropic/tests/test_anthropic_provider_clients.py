"""This module defines functionality for packages/anthropic/tests/test_anthropic_provider_clients.
...
def _create_mock_transport(base_url: str) -> MagicMock:
    """Implements  create mock transport.
...
def test_provider_client_wraps_raw_client_with_standard_layer_order(public_client, raw_client) -> None:
    """Validates behavior for provider client wraps raw client with standard layer order.
    
    Args:
        public_client: Description of public_client.
        raw_client: Description of raw_client.
    """
...
def test_agent_accepts_anthropic_foundry_clients() -> None:
    """Validates behavior for agent accepts anthropic foundry clients.
    """
...
def test_agent_accepts_anthropic_bedrock_clients() -> None:
    """Validates behavior for agent accepts anthropic bedrock clients.
    """
...
def test_agent_accepts_anthropic_vertex_clients() -> None:
    """Validates behavior for agent accepts anthropic vertex clients.
    """
...
def test_raw_anthropic_foundry_client_creates_sdk_client_from_settings(tmp_path) -> None:
    """Validates behavior for raw anthropic foundry client creates sdk client from settings.
...
def test_raw_anthropic_foundry_client_creates_sdk_client_from_base_url_settings(tmp_path) -> None:
    """Validates behavior for raw anthropic foundry client creates sdk client from base url settings.
...
def test_raw_anthropic_foundry_client_requires_resource_or_base_url() -> None:
    """Validates behavior for raw anthropic foundry client requires resource or base url.
    """
...
def test_raw_anthropic_bedrock_client_creates_sdk_client_from_arguments() -> None:
    """Validates behavior for raw anthropic bedrock client creates sdk client from arguments.
    """
    mock_transport = _create_mock_transport("https://bedrock-runtime.us-east-1.amazonaws.com")
...
def test_raw_anthropic_vertex_client_creates_sdk_client_from_arguments() -> None:
    """Validates behavior for raw anthropic vertex client creates sdk client from arguments.
    """
    mock_transport = _create_mock_transport("https://us-central1-aiplatform.googleapis.com/v1")
