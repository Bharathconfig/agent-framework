"""This module defines functionality for packages/anthropic/agent_framework_anthropic/_chat_client.
...
class RawAnthropicClient(
    ...
    def _prepare_text_instructions_for_anthropic(self, messages: Sequence[Message], instructions: Any) -> str:
        """Implements  prepare text instructions for anthropic.
    ...
    def _is_text_instructions(self, instructions: Any) -> bool:
        """Implements  is text instructions.
    ...
    def _parse_citations_from_anthropic(
        ...
        """Implements  parse citations from anthropic.
        
        Args:
            self: Description of self.
            content_block: Description of content_block.
