"""This module defines functionality for packages/purview/agent_framework_purview/_client.
...
class PurviewClient:
    ...
    async def get_user_info_from_token(self, *, tenant_id: str | None = None) -> dict[str, Any]:
        """Implements get user info from token.
    ...
    async def get_protection_scopes(self, request: ProtectionScopesRequest) -> ProtectionScopesResponse:
        """Implements get protection scopes.
    ...
    async def send_content_activities(self, request: ContentActivitiesRequest) -> ContentActivitiesResponse:
        """Implements send content activities.
    ...
    async def _post(
        ...
        Args:
            ...
            return_response: Description of return_response.
