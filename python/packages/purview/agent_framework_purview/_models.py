"""This module defines functionality for packages/purview/agent_framework_purview/_models.
...
class DlpAction(str, Enum):
    """Represents the DlpAction type and related behavior.
    """
...
class RestrictionAction(str, Enum):
    """Represents the RestrictionAction type and related behavior.
    """
    BLOCK = "block"
    OTHER = "other"
...
class ProtectionScopeState(str, Enum):
    """Represents the ProtectionScopeState type and related behavior.
    """
...
class ExecutionMode(str, Enum):
    """Represents the ExecutionMode type and related behavior.
    """
...
class PolicyPivotProperty(str, Enum):
    """Represents the PolicyPivotProperty type and related behavior.
    """
    NONE = "none"
    ACTIVITY = "activity"
    LOCATION = "location"
...
class _AliasSerializable(SerializationMixin):
    ...
    def model_dump(self, *, by_alias: bool = True, exclude_none: bool = True, **_: Any) -> dict[str, Any]:
        ...
        """Implements model dump.
        
        Args:
            self: Description of self.
            by_alias: Description of by_alias.
            exclude_none: Description of exclude_none.
            **_: Description of _.
...
class PolicyLocation(_AliasSerializable):
    """Represents the PolicyLocation type and related behavior.
    """
...
class ActivityMetadata(_AliasSerializable):
    """Represents the ActivityMetadata type and related behavior.
    """
...
class OperatingSystemSpecifications(_AliasSerializable):
    """Represents the OperatingSystemSpecifications type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            self: Description of self.
            operating_system_platform: Description of operating_system_platform.
            operating_system_version: Description of operating_system_version.
            **kwargs: Description of kwargs.
        """
...
class DeviceMetadata(_AliasSerializable):
    """Represents the DeviceMetadata type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            self: Description of self.
            ip_address: Description of ip_address.
            operating_system_specifications: Description of operating_system_specifications.
            **kwargs: Description of kwargs.
        """
...
class IntegratedAppMetadata(_AliasSerializable):
    """Represents the IntegratedAppMetadata type and related behavior.
    """
...
class ProtectedAppMetadata(_AliasSerializable):
    """Represents the ProtectedAppMetadata type and related behavior.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            name: Description of name.
            version: Description of version.
            application_location: Description of application_location.
            **kwargs: Description of kwargs.
        """
...
class DlpActionInfo(_AliasSerializable):
    """Represents the DlpActionInfo type and related behavior.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            restriction_action: Description of restriction_action.
            **kwargs: Description of kwargs.
        """
...
class AccessedResourceDetails(_AliasSerializable):
    """Represents the AccessedResourceDetails type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
        "label_id": "labelId",
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            label_id: Description of label_id.
            access_type: Description of access_type.
            status: Description of status.
            is_cross_prompt_injection_detected: Description of is_cross_prompt_injection_detected.
            **kwargs: Description of kwargs.
        """
...
class AiInteractionPlugin(_AliasSerializable):
    """Represents the AiInteractionPlugin type and related behavior.
    """
    def __init__(
        self,
        identifier: str | None = None,
...
class AiAgentInfo(_AliasSerializable):
    """Represents the AiAgentInfo type and related behavior.
    """
    def __init__(
        self,
        identifier: str | None = None,
...
class GraphDataTypeBase(_AliasSerializable):
    """Represents the GraphDataTypeBase type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {"data_type": "@odata.type"}
...
class ContentBase(GraphDataTypeBase):
    """Represents the ContentBase type and related behavior.
    """
    pass


class PurviewTextContent(ContentBase):
    """Represents the PurviewTextContent type and related behavior.
    """
...
class PurviewBinaryContent(ContentBase):
    """Represents the PurviewBinaryContent type and related behavior.
    """
...
class ProcessConversationMetadata(GraphDataTypeBase):
    """Represents the ProcessConversationMetadata type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            name: Description of name.
            is_truncated: Description of is_truncated.
            data_type: Description of data_type.
            correlation_id: Description of correlation_id.
            sequence_number: Description of sequence_number.
            length: Description of length.
            created_date_time: Description of created_date_time.
            modified_date_time: Description of modified_date_time.
            parent_message_id: Description of parent_message_id.
            accessed_resources: Description of accessed_resources.
            plugins: Description of plugins.
...
class ContentToProcess(_AliasSerializable):
    """Represents the ContentToProcess type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            self: Description of self.
            content_entries: Description of content_entries.
            activity_metadata: Description of activity_metadata.
            device_metadata: Description of device_metadata.
            integrated_app_metadata: Description of integrated_app_metadata.
            protected_app_metadata: Description of protected_app_metadata.
            **kwargs: Description of kwargs.
        """
...
class ProcessContentRequest(_AliasSerializable):
    """Represents the ProcessContentRequest type and related behavior.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            self: Description of self.
            content_to_process: Description of content_to_process.
            user_id: Description of user_id.
            tenant_id: Description of tenant_id.
            correlation_id: Description of correlation_id.
            process_inline: Description of process_inline.
            scope_identifier: Description of scope_identifier.
            **kwargs: Description of kwargs.
        """
...
class ProtectionScopesRequest(_AliasSerializable):
    """Represents the ProtectionScopesRequest type and related behavior.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            locations: Description of locations.
            pivot_on: Description of pivot_on.
            device_metadata: Description of device_metadata.
            integrated_app_metadata: Description of integrated_app_metadata.
            correlation_id: Description of correlation_id.
            scope_identifier: Description of scope_identifier.
...
class ContentActivitiesRequest(_AliasSerializable):
    """Represents the ContentActivitiesRequest type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
        "user_id": "userId",
...
class ErrorDetails(_AliasSerializable):
    """Represents the ErrorDetails type and related behavior.
    """
...
class ProcessingError(_AliasSerializable):
    """Represents the ProcessingError type and related behavior.
    """
...
class ProcessContentResponse(_AliasSerializable):
    """Represents the ProcessContentResponse type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            self: Description of self.
            id: Description of id.
            protection_scope_state: Description of protection_scope_state.
            policy_actions: Description of policy_actions.
            processing_errors: Description of processing_errors.
            correlation_id: Description of correlation_id.
            **kwargs: Description of kwargs.
        """
...
class PolicyScope(_AliasSerializable):
    """Represents the PolicyScope type and related behavior.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            locations: Description of locations.
            policy_actions: Description of policy_actions.
            execution_mode: Description of execution_mode.
            **kwargs: Description of kwargs.
        """
        if "policyActions" in kwargs:
            policy_actions = kwargs["policyActions"]
...
class ProtectionScopesResponse(_AliasSerializable):
    """Represents the ProtectionScopesResponse type and related behavior.
    """
    _ALIASES: ClassVar[dict[str, str]] = {
        "scope_identifier": "scopeIdentifier",
        "scopes": "value",
...
class ContentActivitiesResponse(_AliasSerializable):
    """Represents the ContentActivitiesResponse type and related behavior.
    """
    DEFAULT_EXCLUDE: ClassVar[set[str]] = {"correlation_id"}
