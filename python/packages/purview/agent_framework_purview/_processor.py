"""This module defines functionality for packages/purview/agent_framework_purview/_processor.
...
class ScopedContentProcessor:
    ...
    def __init__(self, client: PurviewClient, settings: PurviewSettings, cache_provider: CacheProvider | None = None):
        ...
        Args:
            ...
            cache_provider: Description of cache_provider.
        """
        self._client = client
    ...
    async def _process_with_scopes(self, pc_request: ProcessContentRequest) -> ProcessContentResponse:
        """Implements  process with scopes.
        
        Args:
            self: Description of self.
            pc_request: Description of pc_request.
    ...
    async def _process_with_cached_scopes(
        ...
        """Implements  process with cached scopes.
        
        Args:
            self: Description of self.
            pc_request: Description of pc_request.
            ps_resp: Description of ps_resp.
    ...
    async def _call_process_content(
        ...
        """Implements  call process content.
        
        Args:
            self: Description of self.
            pc_request: Description of pc_request.
            cache_key: Description of cache_key.
            dlp_actions: Description of dlp_actions.
    ...
    def _combine_policy_actions(
        ...
        """Implements  combine policy actions.
        
        Args:
            existing: Description of existing.
            new_actions: Description of new_actions.
