...
def _normalized_modes(allowed_modes: Collection[str]) -> set[str]:
    """Implements  normalized modes.
    
    Args:
        allowed_modes: Description of allowed_modes.
...
def _mode_allowed(mode: str, normalized_modes: Collection[str]) -> bool:
    """Implements  mode allowed.
    
    Args:
        mode: Description of mode.
        normalized_modes: Description of normalized_modes.
...
def _validate_part_modes(parts: Sequence[Part], allowed_modes: Collection[str], direction: str) -> None:
    """Implements  validate part modes.
    
    Args:
        parts: Description of parts.
        allowed_modes: Description of allowed_modes.
...
def _part_from_text(
    ...
    """Implements  part from text.
    
    Args:
        text: Description of text.
        metadata: Description of metadata.
        output_modes: Description of output_modes.
...
def _workflow_input_type(workflow: Workflow) -> Any:
    """Implements  workflow input type.
...
def _workflow_type_adapter(value_type: Any) -> TypeAdapter[Any]:
    """Implements  workflow type adapter.
    
    Args:
        value_type: Description of value_type.
...
def _workflow_input_adapter(workflow: Workflow) -> TypeAdapter[Any]:
    """Implements  workflow input adapter.
...
def _workflow_type_modes(value_type: Any) -> list[str]:  # pyright: ignore[reportUnusedFunction]
    """Implements  workflow type modes.
