...
def _resolve_designated_participants(
    ...
    *,
    ...
    """Implements  resolve designated participants.
    
    Args:
        designations: Description of designations.
        kind: Description of kind.
        participants_by_id: Description of participants_by_id.
        known_participants: Description of known_participants.
