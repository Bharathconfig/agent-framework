"""This module defines functionality for packages/orchestrations/tests/test_sequential.
...
class _SummarizerTerminator(Executor):
    ...
    async def summarize(
        ...
        Args:
            self: Description of self.
            agent_response: Description of agent_response.
...
def test_sequential_builder_does_not_mark_custom_workflow() -> None:
    """Validates behavior for sequential builder does not mark custom workflow.
    """
...
def test_sequential_builder_rejects_empty_participants() -> None:
    """Validates behavior for sequential builder rejects empty participants.
    """
...
async def test_sequential_checkpoint_resume_round_trip() -> None:
    """Validates behavior for sequential checkpoint resume round trip.
    """
