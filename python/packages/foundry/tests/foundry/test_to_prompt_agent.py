"""This module defines functionality for packages/foundry/tests/foundry/test_to_prompt_agent.
...
def test_to_prompt_agent_rejects_unknown_tool_type() -> None:
    ...
    class NotATool:
        """Represents the NotATool type and related behavior.
        """
        pass
...
def test_to_prompt_agent_lifts_response_format_pydantic_to_text() -> None:
    ...
    class WeatherReply(BaseModel):
        """Represents the WeatherReply type and related behavior.
        """
        location: str
        condition: str
