...
class RawFoundryAgentChatClient(
    ...
    def _parse_response_from_openai(
        ...
        """Implements  parse response from openai.
    ...
    def _prepare_tools_for_openai(
        ...
        """Implements  prepare tools for openai.
...
class _FoundryAgentChatClient(
    ...
    def _update_function_invocation_continuation_state(
        ...
        *,
        ...
        """Implements  update function invocation continuation state.
...
class RawFoundryAgent(
    ...
    def _update_session_from_chat_response(
        ...
        """Implements  update session from chat response.
    ...
    def _update_session_from_chat_response_update(
        ...
        """Implements  update session from chat response update.
