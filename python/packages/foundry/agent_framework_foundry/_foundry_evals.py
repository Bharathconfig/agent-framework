...
def _filter_tool_evaluators(
    ...
    def _is_tool_only(spec: str | GeneratedEvaluatorRef) -> bool:
        """Implements  is tool only.
        
        Args:
            spec: Description of spec.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            project_client: Description of project_client.
            model: Description of model.
            evaluators: Description of evaluators.
            conversation_split: Description of conversation_split.
            poll_interval: Description of poll_interval.
