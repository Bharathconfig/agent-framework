"""This module defines functionality for packages/github_copilot/agent_framework_github_copilot/_agent.
...
def _parse_telemetry_config(raw: str) -> TelemetryConfig | None:
    ...
    # agent from starting.
    """Implements  parse telemetry config.
...
class RawGitHubCopilotAgent(BaseAgent, Generic[OptionsT]):
    ...
    def _parse_usage_details_from_copilot(data: AssistantUsageData) -> UsageDetails | None:
        """Implements  parse usage details from copilot.
    ...
    async def _run_impl(
        ...
        *,
        ...
        def usage_event_handler(event: SessionEvent) -> None:
            """Implements usage event handler.
    ...
    def _build_session_hooks(
        ...
        def default_pre_tool_use(
            ...
            """Implements default pre tool use.
            
            Args:
                hook_input: Description of hook_input.
