...
def test_truncate_under_cap_returns_original() -> None:
    """Validates behavior for truncate under cap returns original.
    """
...
def test_truncate_at_cap_returns_original() -> None:
    """Validates behavior for truncate at cap returns original.
    """
...
def test_truncate_over_cap_marks_truncated_and_reports_bytes() -> None:
    """Validates behavior for truncate over cap marks truncated and reports bytes.
    """
    data = b"A" * 10
...
def test_truncate_odd_cap_keeps_extra_byte_in_tail() -> None:
    ...
    """Validates behavior for truncate odd cap keeps extra byte in tail.
    """
    data = b"ABCDEFGHIJ"
...
def test_truncate_text_uses_utf8_byte_budget() -> None:
    ...
    """Validates behavior for truncate text uses utf8 byte budget.
    """
    text = "😀" * 10
...
def test_truncate_zero_cap_raises() -> None:
    """Validates behavior for truncate zero cap raises.
    """
...
def test_truncate_negative_cap_raises() -> None:
    """Validates behavior for truncate negative cap raises.
    """
    with pytest.raises(ValueError):
...
def test_quote_posix_blocks_dollar_expansion() -> None:
    """Validates behavior for quote posix blocks dollar expansion.
    """
...
def test_quote_posix_escapes_embedded_single_quote() -> None:
    """Validates behavior for quote posix escapes embedded single quote.
    """
...
def test_quote_powershell_blocks_dollar_expansion() -> None:
    """Validates behavior for quote powershell blocks dollar expansion.
    """
...
def test_quote_powershell_doubles_embedded_single_quote() -> None:
    """Validates behavior for quote powershell doubles embedded single quote.
    """
