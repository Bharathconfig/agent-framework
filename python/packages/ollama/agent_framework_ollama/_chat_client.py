"""This module defines functionality for packages/ollama/agent_framework_ollama/_chat_client.
...
class OllamaChatClient(
    ...
    def _prepare_messages_for_ollama(self, messages: Sequence[Message]) -> list[OllamaMessage]:
        """Implements  prepare messages for ollama.
    ...
    def _prepare_message_for_ollama(self, message: Message) -> list[OllamaMessage]:
        """Implements  prepare message for ollama.
    ...
    def _format_system_message(self, message: Message) -> list[OllamaMessage]:
        """Implements  format system message.
    ...
    def _format_tool_message(self, message: Message) -> list[OllamaMessage]:
        ...
        """Implements  format tool message.
    ...
    def _parse_contents_from_ollama(self, response: OllamaChatResponse) -> list[Content]:
        """Implements  parse contents from ollama.
    ...
    def _get_finish_reason_from_ollama(self, response: OllamaChatResponse) -> FinishReason | None:
        """Implements  get finish reason from ollama.
    ...
    def _parse_streaming_response_from_ollama(self, response: OllamaChatResponse) -> ChatResponseUpdate:
        """Implements  parse streaming response from ollama.
    ...
    def _parse_response_from_ollama(
        ...
        *,
        ...
        """Implements  parse response from ollama.
        
        Args:
            self: Description of self.
            response: Description of response.
            response_format: Description of response_format.
    ...
    def _parse_tool_calls_from_ollama(self, tool_calls: Sequence[OllamaMessage.ToolCall]) -> list[Content]:
        """Implements  parse tool calls from ollama.
