"""This module defines functionality for packages/ollama/tests/test_ollama_chat_client.
...
def test_agent_accepts_ollama_chat_client(ollama_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for agent accepts ollama chat client.
    
    Args:
        ollama_unit_test_env: Description of ollama_unit_test_env.
    """
...
def mock_streaming_chat_completion_response() -> AsyncStream[OllamaChatResponse]:
    """Implements mock streaming chat completion response.
...
def mock_streaming_chat_completion_response_reasoning() -> AsyncStream[OllamaChatResponse]:
    """Implements mock streaming chat completion response reasoning.
...
def mock_chat_completion_response() -> OllamaChatResponse:
    """Implements mock chat completion response.
...
def mock_chat_completion_response_reasoning() -> OllamaChatResponse:
    """Implements mock chat completion response reasoning.
...
def mock_streaming_chat_completion_tool_call() -> AsyncStream[OllamaChatResponse]:
    """Implements mock streaming chat completion tool call.
...
def mock_chat_completion_tool_call() -> OllamaChatResponse:
    """Implements mock chat completion tool call.
...
def test_init_client(ollama_unit_test_env: dict[str, str]) -> None:
    ...
    """Validates behavior for init client.
...
def test_with_invalid_settings(ollama_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for with invalid settings.
...
def test_chat_middleware(ollama_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for chat middleware.
...
def test_additional_properties(ollama_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for additional properties.
...
async def test_empty_messages() -> None:
    """Validates behavior for empty messages.
    """
    ollama_chat_client = OllamaChatClient(
        host="http://localhost:12345",
        model="test-model",
...
async def test_cmc(
    ...
    """Validates behavior for cmc.
    
    Args:
        mock_chat: Description of mock_chat.
        ollama_unit_test_env: Description of ollama_unit_test_env.
        chat_history: Description of chat_history.
        mock_chat_completion_response: Description of mock_chat_completion_response.
    """
...
async def test_cmc_maps_done_reason_to_finish_reason(
    ...
    """Validates behavior for cmc maps done reason to finish reason.
...
async def test_cmc_preserves_unknown_done_reason(
    ...
    """Validates behavior for cmc preserves unknown done reason.
...
async def test_cmc_omits_usage_when_token_counts_are_missing(
    ...
    """Validates behavior for cmc omits usage when token counts are missing.
...
async def test_cmc_response_format_dict(
    ...
    """Validates behavior for cmc response format dict.
...
async def test_cmc_reasoning(
    ...
    """Validates behavior for cmc reasoning.
    
    Args:
        mock_chat: Description of mock_chat.
        ollama_unit_test_env: Description of ollama_unit_test_env.
        chat_history: Description of chat_history.
        mock_chat_completion_response_reasoning: Description of mock_chat_completion_response_reasoning.
    """
...
async def test_cmc_chat_failure(
    ...
    """Validates behavior for cmc chat failure.
...
async def test_cmc_streaming(
    ...
    """Validates behavior for cmc streaming.
    
    Args:
        mock_chat: Description of mock_chat.
        ollama_unit_test_env: Description of ollama_unit_test_env.
        chat_history: Description of chat_history.
        mock_streaming_chat_completion_response: Description of mock_streaming_chat_completion_response.
    """
...
async def test_cmc_streaming_maps_done_reason_and_usage(
    ...
    """Validates behavior for cmc streaming maps done reason and usage.
...
async def test_cmc_streaming_ignores_done_reason_and_usage_before_final_chunk(
    ...
    """Validates behavior for cmc streaming ignores done reason and usage before final chunk.
...
async def test_cmc_streaming_reasoning(
    ...
    """Validates behavior for cmc streaming reasoning.
    
    Args:
        mock_chat: Description of mock_chat.
        ollama_unit_test_env: Description of ollama_unit_test_env.
        chat_history: Description of chat_history.
        mock_streaming_chat_completion_response_reasoning: Description of mock_streaming_chat_completion_response_reasoning.
    """
...
async def test_cmc_streaming_chat_failure(
    ...
    """Validates behavior for cmc streaming chat failure.
...
async def test_cmc_streaming_with_tool_call(
    ...
    """Validates behavior for cmc streaming with tool call.
    ...
    Args:
        ...
        chat_history: Description of chat_history.
        mock_streaming_chat_completion_response: Description of mock_streaming_chat_completion_response.
        mock_streaming_chat_completion_tool_call: Description of mock_streaming_chat_completion_tool_call.
    """
...
async def test_cmc_with_data_content_type(
    ...
    """Validates behavior for cmc with data content type.
...
async def test_cmc_with_invalid_data_content_media_type(
    ...
    """Validates behavior for cmc with invalid data content media type.
...
async def test_cmc_with_invalid_content_type(
    ...
    """Validates behavior for cmc with invalid content type.
...
async def test_cmc_integration_with_tool_call(
    ...
    """Validates behavior for cmc integration with tool call.
...
async def test_cmc_integration_with_chat_completion(
    ...
    """Validates behavior for cmc integration with chat completion.
...
async def test_cmc_streaming_integration_with_tool_call(
    ...
    """Validates behavior for cmc streaming integration with tool call.
...
async def test_cmc_streaming_integration_with_chat_completion(
    ...
    """Validates behavior for cmc streaming integration with chat completion.
