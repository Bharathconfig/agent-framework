"""This module defines functionality for packages/lab/tau2/agent_framework_lab_tau2/_sliding_window.
...
class SlidingWindowHistoryProvider(InMemoryHistoryProvider):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            max_tokens: Description of max_tokens.
            system_message: Description of system_message.
            tool_definitions: Description of tool_definitions.
        """
    ...
    def _estimate_any_object_token_count(self, obj: Any) -> int:
        """Implements  estimate any object token count.
