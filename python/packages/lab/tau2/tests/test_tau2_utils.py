...
class _DummyToolInput(BaseModel):
    """Represents the _DummyToolInput type and related behavior.
    """
    param: str


class _DummyToolResult(BaseModel):
    """Represents the _DummyToolResult type and related behavior.
    """
    output: str


class _DummyTau2Tool:
    """Represents the _DummyTau2Tool type and related behavior.
    """
