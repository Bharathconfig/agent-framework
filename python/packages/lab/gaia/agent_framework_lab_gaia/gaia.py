...
class _OrjsonModule(Protocol):
    """Represents the _OrjsonModule type and related behavior.
    """
    ...
    def _setup_file_export(self) -> None:
        ...
        try:
            ...
            class FileSpanExporter(SpanExporter):
                """Represents the FileSpanExporter type and related behavior.
                """
