...
@dataclass
class InputData:
    """Represents the InputData type and related behavior.
    """
    text: str
    source: str
...
@dataclass
class Address:
    """Represents the Address type and related behavior.
    """
    street: str
    city: str
    zipcode: str
...
@dataclass
class PersonData:
    """Represents the PersonData type and related behavior.
    """
    name: str
    age: int
    address: Address
...
def test_pydantic_model_schema_generation():
    ...
    try:
        ...
        class UserInput(BaseModel):
            """Represents the UserInput type and related behavior.
            """
