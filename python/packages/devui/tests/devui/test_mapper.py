...
async def test_marked_refusal_text_mapping(mapper: MessageMapper, test_request: AgentFrameworkRequest) -> None:
    """Validates behavior for marked refusal text mapping.
    
    Args:
        mapper: Description of mapper.
        test_request: Description of test_request.
    """
...
async def test_marked_refusal_text_aggregation(mapper: MessageMapper, test_request: AgentFrameworkRequest) -> None:
    """Validates behavior for marked refusal text aggregation.
...
async def test_mixed_text_and_refusal_keep_separate_content_indexes(
    ...
    """Validates behavior for mixed text and refusal keep separate content indexes.
...
async def test_unknown_content_fallback(mapper: MessageMapper, test_request: AgentFrameworkRequest) -> None:
    ...
    class MockUnknownContent:
        """Represents the MockUnknownContent type and related behavior.
        """
        def __init__(self):
