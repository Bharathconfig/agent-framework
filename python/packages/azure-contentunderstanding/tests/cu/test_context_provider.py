"""This module defines functionality for packages/azure-contentunderstanding/tests/cu/test_context_provider.
...
def _make_content_from_data(data: bytes, media_type: str, filename: str | None = None) -> Content:
    """Implements  make content from data.
...
def _make_provider(
    ...
    **kwargs: Any,
    ...
    """Implements  make provider.
    
    Args:
        mock_client: Description of mock_client.
...
class TestInit:
    """Represents the TestInit type and related behavior.
    """
    def test_default_values(self) -> None:
        """Validates behavior for default values.
    ...
    def test_custom_values(self) -> None:
        """Validates behavior for custom values.
    ...
    def test_max_wait_none(self) -> None:
        """Validates behavior for max wait none.
...
class TestAsyncContextManager:
    """Represents the TestAsyncContextManager type and related behavior.
    """
    ...
    async def test_aexit_closes_client(self) -> None:
        """Validates behavior for aexit closes client.
...
class TestBeforeRunNewFile:
    """Represents the TestBeforeRunNewFile type and related behavior.
    """
    async def test_single_pdf_analyzed(
        ...
        """Validates behavior for single pdf analyzed.
        
        Args:
            self: Description of self.
            mock_cu_client: Description of mock_cu_client.
            pdf_analysis_result: Description of pdf_analysis_result.
        """
    ...
    async def test_url_input_analyzed(
        ...
        """Validates behavior for url input analyzed.
    ...
    async def test_text_only_skipped(self, mock_cu_client: AsyncMock) -> None:
        """Validates behavior for text only skipped.
...
class TestBeforeRunMultiFile:
    """Represents the TestBeforeRunMultiFile type and related behavior.
    """
    async def test_two_files_both_analyzed(
        ...
        """Validates behavior for two files both analyzed.
        
        Args:
            self: Description of self.
            mock_cu_client: Description of mock_cu_client.
            pdf_analysis_result: Description of pdf_analysis_result.
            image_analysis_result: Description of image_analysis_result.
        """
...
class TestBeforeRunTimeout:
    """Represents the TestBeforeRunTimeout type and related behavior.
    """
    async def test_exceeds_max_wait_defers_to_background(
        ...
        """Validates behavior for exceeds max wait defers to background.
...
class TestBeforeRunPendingResolution:
    """Represents the TestBeforeRunPendingResolution type and related behavior.
    """
    async def test_pending_completes_on_next_turn(
        ...
        """Validates behavior for pending completes on next turn.
...
class TestBeforeRunPendingFailure:
    """Represents the TestBeforeRunPendingFailure type and related behavior.
    """
    async def test_pending_task_failure_updates_state(
        ...
        """Validates behavior for pending task failure updates state.
...
class TestDocumentKeyDerivation:
    """Represents the TestDocumentKeyDerivation type and related behavior.
    """
    def test_filename_from_additional_properties(self) -> None:
        """Validates behavior for filename from additional properties.
    ...
    def test_url_basename(self) -> None:
        """Validates behavior for url basename.
    ...
    def test_content_hash_fallback(self) -> None:
        """Validates behavior for content hash fallback.
...
class TestSessionState:
    """Represents the TestSessionState type and related behavior.
    """
    async def test_documents_persist_across_turns(
        ...
        """Validates behavior for documents persist across turns.
...
class TestListDocumentsTool:
    """Represents the TestListDocumentsTool type and related behavior.
    """
    async def test_returns_all_docs_with_status(
        ...
        """Validates behavior for returns all docs with status.
...
class TestOutputFiltering:
    ...
    def test_default_markdown_and_fields(self, pdf_analysis_result: AnalysisResult) -> None:
        """Validates behavior for default markdown and fields.
    ...
    def test_markdown_only(self, pdf_analysis_result: AnalysisResult) -> None:
        """Validates behavior for markdown only.
    ...
    def test_fields_only(self, invoice_analysis_result: AnalysisResult) -> None:
        """Validates behavior for fields only.
        
        Args:
            self: Description of self.
            invoice_analysis_result: Description of invoice_analysis_result.
        """
    ...
    def test_field_values_extracted(self, invoice_analysis_result: AnalysisResult) -> None:
        """Validates behavior for field values extracted.
...
class TestDuplicateDocumentKey:
    """Represents the TestDuplicateDocumentKey type and related behavior.
    """
...
class TestBinaryStripping:
    """Represents the TestBinaryStripping type and related behavior.
    """
    async def test_supported_files_stripped(
        ...
        """Validates behavior for supported files stripped.
    ...
    async def test_unsupported_files_left_in_place(self, mock_cu_client: AsyncMock) -> None:
        """Validates behavior for unsupported files left in place.
...
class TestErrorHandling:
    ...
    async def test_cu_service_error(self, mock_cu_client: AsyncMock) -> None:
        """Validates behavior for cu service error.
...
class TestMultiModalFixtures:
    ...
    def test_pdf_fixture_loads(self, pdf_analysis_result: AnalysisResult) -> None:
        """Validates behavior for pdf fixture loads.
    ...
    def test_audio_fixture_loads(self, audio_analysis_result: AnalysisResult) -> None:
        """Validates behavior for audio fixture loads.
        
        Args:
            self: Description of self.
            audio_analysis_result: Description of audio_analysis_result.
        """
        provider = _make_provider()
    ...
    def test_video_fixture_loads(self, video_analysis_result: AnalysisResult) -> None:
        """Validates behavior for video fixture loads.
        
        Args:
            self: Description of self.
            video_analysis_result: Description of video_analysis_result.
        """
        provider = _make_provider()
    ...
    def test_image_fixture_loads(self, image_analysis_result: AnalysisResult) -> None:
        """Validates behavior for image fixture loads.
    ...
    def test_invoice_fixture_loads(self, invoice_analysis_result: AnalysisResult) -> None:
        """Validates behavior for invoice fixture loads.
...
class TestSupportedMediaTypes:
    """Represents the TestSupportedMediaTypes type and related behavior.
    """
    def test_pdf_supported(self) -> None:
        """Validates behavior for pdf supported.
    ...
    def test_audio_supported(self) -> None:
        """Validates behavior for audio supported.
    ...
    def test_video_supported(self) -> None:
        """Validates behavior for video supported.
    ...
    def test_zip_not_supported(self) -> None:
        """Validates behavior for zip not supported.
...
class TestAnalyzerAutoDetection:
    ...
    def test_explicit_analyzer_always_wins(self) -> None:
        """Validates behavior for explicit analyzer always wins.
    ...
    def test_auto_detect_pdf(self) -> None:
        """Validates behavior for auto detect pdf.
    ...
    def test_auto_detect_image(self) -> None:
        """Validates behavior for auto detect image.
    ...
    def test_auto_detect_audio(self) -> None:
        """Validates behavior for auto detect audio.
    ...
    def test_auto_detect_video(self) -> None:
        """Validates behavior for auto detect video.
    ...
    def test_auto_detect_unknown_falls_back_to_document(self) -> None:
        """Validates behavior for auto detect unknown falls back to document.
...
class TestFileSearchIntegration:
    """Represents the TestFileSearchIntegration type and related behavior.
    """
    ...
    def _make_file_search_config(self, backend: AsyncMock | None = None) -> Any:
        """Implements  make file search config.
    ...
    async def test_file_search_uploads_to_vector_store(
        ...
        """Validates behavior for file search uploads to vector store.
    ...
    async def test_cleanup_deletes_uploaded_files(
        ...
        """Validates behavior for cleanup deletes uploaded files.
...
class TestCloseCancel:
    """Represents the TestCloseCancel type and related behavior.
    """
...
class TestAnalyzerAutoDetectionE2E:
    ...
    async def test_audio_file_uses_audio_analyzer(
        ...
        """Validates behavior for audio file uses audio analyzer.
    ...
    async def test_video_file_uses_video_analyzer(
        ...
        """Validates behavior for video file uses video analyzer.
    ...
    async def test_pdf_file_uses_document_analyzer(
        ...
        """Validates behavior for pdf file uses document analyzer.
