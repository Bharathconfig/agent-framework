"""This module defines functionality for packages/mistral/tests/mistral/test_mistral_chat_client.
...
def make_response_payload(
    ...
    """Implements make response payload.
    
    Args:
        content: Description of content.
        tool_calls: Description of tool_calls.
        finish_reason: Description of finish_reason.
        usage: Description of usage.
        choices: Description of choices.
...
class MockMistral:
    ...
    def __init__(self, responses: Sequence[httpx.Response]) -> None:
        ...
        Args:
            ...
            responses: Description of responses.
        """
...
def test_mistral_chat_construction_env(monkeypatch: pytest.MonkeyPatch) -> None:
    """Validates behavior for mistral chat construction env.
...
def test_mistral_chat_construction_with_params() -> None:
    """Validates behavior for mistral chat construction with params.
    """
...
def test_mistral_chat_construction_with_server_url() -> None:
    """Validates behavior for mistral chat construction with server url.
    """
    client = MistralChatClient(
...
def test_mistral_chat_construction_with_client_needs_no_api_key(monkeypatch: pytest.MonkeyPatch) -> None:
    """Validates behavior for mistral chat construction with client needs no api key.
...
async def test_mistral_chat_deprecated_client_param_accepts_httpx() -> None:
    """Validates behavior for mistral chat deprecated client param accepts httpx.
    """
    http_client = httpx.AsyncClient(base_url="https://api.mistral.ai")
...
def test_mistral_chat_construction_missing_api_key_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    """Validates behavior for mistral chat construction missing api key raises.
...
def test_mistral_chat_service_url_default() -> None:
    """Validates behavior for mistral chat service url default.
    """
    client = MistralChatClient(model="mistral-large-latest", api_key="test-key")
...
async def test_mistral_chat_close_only_closes_owned_client() -> None:
    """Validates behavior for mistral chat close only closes owned client.
    """
...
async def test_mistral_chat_missing_model_raises_at_request(monkeypatch: pytest.MonkeyPatch) -> None:
    """Validates behavior for mistral chat missing model raises at request.
...
async def test_get_response_marks_feature_used(monkeypatch: pytest.MonkeyPatch) -> None:
    """Validates behavior for get response marks feature used.
...
async def test_get_response_basic() -> None:
    """Validates behavior for get response basic.
    """
...
async def test_get_response_preserves_injected_http_client_timeout() -> None:
    """Validates behavior for get response preserves injected http client timeout.
    """
...
async def test_get_response_includes_cached_input_tokens() -> None:
    """Validates behavior for get response includes cached input tokens.
    """
...
async def test_get_response_includes_extended_usage() -> None:
    """Validates behavior for get response includes extended usage.
    """
    client, _ = make_client(
        json_response(
            make_response_payload(
...
async def test_get_response_ignores_invalid_cached_input_tokens(cached_tokens: Any) -> None:
    """Validates behavior for get response ignores invalid cached input tokens.
    
    Args:
        cached_tokens: Description of cached_tokens.
    """
    client, _ = make_client(
        json_response(
            make_response_payload(
...
async def test_get_response_http_error_wrapped(
    ...
    """Validates behavior for get response http error wrapped.
    
    Args:
        status_code: Description of status_code.
        expected_exception: Description of expected_exception.
    """
...
async def test_get_response_network_error_wrapped() -> None:
    """Validates behavior for get response network error wrapped.
    """
    def raise_connect_error(request: httpx.Request) -> httpx.Response:
        """Implements raise connect error.
...
async def test_get_response_invalid_payload_wrapped(response: httpx.Response, message: str) -> None:
    """Validates behavior for get response invalid payload wrapped.
...
async def test_get_response_option_mapping() -> None:
    """Validates behavior for get response option mapping.
    """
...
async def test_get_response_instructions_prepended_as_system_message() -> None:
    """Validates behavior for get response instructions prepended as system message.
    """
    client, server = make_client(json_response(make_response_payload(content="ok")))
...
async def test_get_response_rejects_per_call_transport_arguments(argument: str) -> None:
    """Validates behavior for get response rejects per call transport arguments.
...
async def test_get_response_model_override() -> None:
    """Validates behavior for get response model override.
    """
    client, server = make_client(json_response(make_response_payload(content="ok")))
...
async def test_message_conversion_roles() -> None:
    """Validates behavior for message conversion roles.
    """
    client, server = make_client(json_response(make_response_payload(content="ok")))
...
async def test_message_conversion_image_content() -> None:
    """Validates behavior for message conversion image content.
    """
    client, server = make_client(json_response(make_response_payload(content="ok")))
...
def test_message_conversion_edge_cases(caplog: pytest.LogCaptureFixture) -> None:
    """Validates behavior for message conversion edge cases.
...
def test_assistant_and_tool_message_edge_cases(caplog: pytest.LogCaptureFixture) -> None:
    """Validates behavior for assistant and tool message edge cases.
...
def test_result_to_text_variants() -> None:
    """Validates behavior for result to text variants.
    """
    client, _ = make_client()
...
def test_sanitize_tool_call_id() -> None:
    """Validates behavior for sanitize tool call id.
    """
...
async def test_tools_and_tool_choice() -> None:
    """Validates behavior for tools and tool choice.
...
async def test_tool_choice_required_function() -> None:
    """Validates behavior for tool choice required function.
...
def test_tool_preparation_edge_cases(
    ...
    """Validates behavior for tool preparation edge cases.
...
async def test_response_format_pydantic_model() -> None:
    """Validates behavior for response format pydantic model.
    """
    client, server = make_client(json_response(make_response_payload(content='{"answer": "42"}')))

    class Answer(BaseModel):
        """Represents the Answer type and related behavior.
        """
        answer: str
...
async def test_response_format_json_object() -> None:
    """Validates behavior for response format json object.
    """
...
async def test_response_format_json_schema_omits_unset_strict() -> None:
    """Validates behavior for response format json schema omits unset strict.
    """
    client, server = make_client(json_response(make_response_payload(content="{}")))
...
def test_response_format_edge_cases(caplog: pytest.LogCaptureFixture) -> None:
    """Validates behavior for response format edge cases.
...
async def test_parse_tool_calls() -> None:
    """Validates behavior for parse tool calls.
    """
    client, _ = make_client(
        json_response(
            make_response_payload(
...
async def test_parse_empty_choices_returns_empty_assistant_message() -> None:
    """Validates behavior for parse empty choices returns empty assistant message.
    """
...
async def test_parse_thinking_chunks() -> None:
    """Validates behavior for parse thinking chunks.
    """
    content = [
...
def test_response_content_edge_cases() -> None:
    """Validates behavior for response content edge cases.
    """
    client, _ = make_client()
...
async def test_parse_finish_reason_model_length() -> None:
    """Validates behavior for parse finish reason model length.
    """
...
async def test_function_invocation_loop() -> None:
    """Validates behavior for function invocation loop.
...
async def test_streaming_function_invocation_loop() -> None:
    """Validates behavior for streaming function invocation loop.
...
async def test_streaming_response() -> None:
    """Validates behavior for streaming response.
    """
    client, server = make_client(
        stream_response(
...
async def test_streaming_uses_first_choice_only() -> None:
    """Validates behavior for streaming uses first choice only.
    """
...
async def test_streaming_tool_calls() -> None:
    """Validates behavior for streaming tool calls.
    """
    client, _ = make_client(
        stream_response(
            make_chunk_payload(
...
async def test_streaming_parallel_calls_without_indexes() -> None:
    """Validates behavior for streaming parallel calls without indexes.
    """
    client, _ = make_client(
        stream_response(
            make_chunk_payload(
...
async def test_streaming_reused_index_flushes_previous_call() -> None:
    """Validates behavior for streaming reused index flushes previous call.
    """
    client, _ = make_client(
        stream_response(
...
async def test_streaming_mid_stream_error_wrapped() -> None:
    ...
    class ExplodingStream(httpx.AsyncByteStream):
        """Represents the ExplodingStream type and related behavior.
        """
...
async def test_streaming_invalid_event_wrapped() -> None:
    """Validates behavior for streaming invalid event wrapped.
    """
    client, _ = make_client(
        httpx.Response(
            200,
...
async def test_streaming_http_error_wrapped() -> None:
    """Validates behavior for streaming http error wrapped.
    """
...
async def test_mistral_chat_integration_basic() -> None:
    """Validates behavior for mistral chat integration basic.
    """
    client = MistralChatClient()
    try:
...
async def test_mistral_chat_integration_streaming() -> None:
    """Validates behavior for mistral chat integration streaming.
    """
    client = MistralChatClient()
    try:
...
async def test_mistral_chat_integration_agent_with_tool() -> None:
    """Validates behavior for mistral chat integration agent with tool.
