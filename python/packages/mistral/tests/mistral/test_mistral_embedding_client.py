"""This module defines functionality for packages/mistral/tests/mistral/test_mistral_embedding_client.
...
def make_embeddings_payload(
    ...
    """Implements make embeddings payload.
    
    Args:
        vectors: Description of vectors.
...
class MockMistral:
    """Represents the MockMistral type and related behavior.
    """
...
def test_mistral_embedding_client_param_accepts_httpx() -> None:
    """Validates behavior for mistral embedding client param accepts httpx.
    """
    http_client = httpx.AsyncClient(base_url="https://api.mistral.ai")
...
def test_mistral_embedding_client_param_rejects_unknown_client() -> None:
    """Validates behavior for mistral embedding client param rejects unknown client.
    """
    class NotAClient:
        """Represents the NotAClient type and related behavior.
        """
        pass
...
def test_mistral_embedding_client_and_http_client_conflict() -> None:
    """Validates behavior for mistral embedding client and http client conflict.
    """
    http_client = httpx.AsyncClient(base_url="https://api.mistral.ai")
...
async def test_mistral_embedding_close_only_closes_owned_client() -> None:
    """Validates behavior for mistral embedding close only closes owned client.
    """
...
async def test_mistral_embedding_marks_feature_used(monkeypatch: pytest.MonkeyPatch) -> None:
    """Validates behavior for mistral embedding marks feature used.
...
async def test_mistral_embedding_preserves_injected_http_client_timeout() -> None:
    """Validates behavior for mistral embedding preserves injected http client timeout.
    """
...
async def test_mistral_embedding_network_error_wrapped() -> None:
    """Validates behavior for mistral embedding network error wrapped.
    """
...
async def test_mistral_embedding_invalid_payload_wrapped(response: httpx.Response, message: str) -> None:
    """Validates behavior for mistral embedding invalid payload wrapped.
