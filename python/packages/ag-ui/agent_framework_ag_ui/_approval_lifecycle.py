...
def _serialized_registration(method: Callable[..., _ReturnT]) -> Callable[..., _ReturnT]:
    """Implements  serialized registration.
...
def _serialized_by_batch(method: Callable[..., _ReturnT]) -> Callable[..., _ReturnT]:
    """Implements  serialized by batch.
...
def _serialized_by_occurrence(method: Callable[..., _ReturnT]) -> Callable[..., _ReturnT]:
    """Implements  serialized by occurrence.
...
class ApprovalLifecycle:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            self: Description of self.
            max_entries: Description of max_entries.
            pending_retention_seconds: Description of pending_retention_seconds.
            indeterminate_retention_seconds: Description of indeterminate_retention_seconds.
            terminal_retention_seconds: Description of terminal_retention_seconds.
            clock: Description of clock.
        """
        if max_entries < 1:
    ...
    def _register_aliases(
        ...
        *,
        ...
        """Implements  register aliases.
        
        Args:
            self: Description of self.
            thread_ids: Description of thread_ids.
            interrupt_id: Description of interrupt_id.
            call_id: Description of call_id.
            name: Description of name.
            arguments: Description of arguments.
            owner: Description of owner.
            scope: Description of scope.
            aliases: Description of aliases.
            response_id: Description of response_id.
            already_approved_requests: Description of already_approved_requests.
            server_label: Description of server_label.
            idempotency_key: Description of idempotency_key.
    ...
    def _snapshot_reconciliation(occurrence: ApprovalOccurrence) -> ApprovalSnapshotReconciliation:
        """Implements  snapshot reconciliation.
        
        Args:
            occurrence: Description of occurrence.
    ...
    def _remove_pending_aliases(self, occurrence: ApprovalOccurrence) -> None:
        """Implements  remove pending aliases.
    ...
    def _purge_expired_terminal(self) -> None:
        """Implements  purge expired terminal.
    ...
    def _locks_for_batch(self, *, thread_id: str, interrupt_ids: list[str]) -> tuple[RLock, ...]:
        """Implements  locks for batch.
        
        Args:
            self: Description of self.
            thread_id: Description of thread_id.
            interrupt_ids: Description of interrupt_ids.
    ...
    def _lock_for_identity(self, identity: ApprovalOccurrenceIdentity) -> RLock:
        """Implements  lock for identity.
        
        Args:
            self: Description of self.
            identity: Description of identity.
    ...
    def _emit_event(
        ...
        *,
        ...
        """Implements  emit event.
        
        Args:
            event: Description of event.
            occurrence: Description of occurrence.
            failure_type: Description of failure_type.
        """
...
class LocalPendingToolTransitionOwner:
    ...
    def __init__(self, executor: Callable[[], Awaitable[list[Content]]]) -> None:
        ...
        Args:
            self: Description of self.
            executor: Description of executor.
        """
...
class ForwardedPendingToolTransitionOwner:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            self: Description of self.
            forwarder: Description of forwarder.
            owner: Description of owner.
        """
