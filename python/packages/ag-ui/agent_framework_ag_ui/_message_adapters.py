...
def _append_synthetic_tool_results(
    ...
    *,
    ...
    """Implements  append synthetic tool results.
    
    Args:
        sanitized: Description of sanitized.
        pending_tool_call_ids: Description of pending_tool_call_ids.
        result: Description of result.
        excluded_tool_call_ids: Description of excluded_tool_call_ids.
    """
...
def _ordered_unique_tool_call_ids(contents: list[Content]) -> list[str]:
    """Implements  ordered unique tool call ids.
...
def _function_result_call_ids(messages: list[Message]) -> set[str]:
    """Implements  function result call ids.
...
def agui_messages_to_agent_framework(messages: list[dict[str, Any]]) -> list[Message]:
    ...
    def _update_tool_call_arguments(
        ...
        """Implements  update tool call arguments.
        
        Args:
            raw_messages: Description of raw_messages.
            tool_call_id: Description of tool_call_id.
            modified_args: Description of modified_args.
        """
    ...
    def _find_matching_func_call(call_id: str) -> Content | None:
        """Implements  find matching func call.
    ...
    def _resolve_approval_call_id(tool_call_id: str, parsed_payload: dict[str, Any] | None) -> str | None:
        """Implements  resolve approval call id.
        
        Args:
            tool_call_id: Description of tool_call_id.
            parsed_payload: Description of parsed_payload.
    ...
    def _filter_modified_args(
        ...
        """Implements  filter modified args.
        
        Args:
            modified_args: Description of modified_args.
            original_args: Description of original_args.
