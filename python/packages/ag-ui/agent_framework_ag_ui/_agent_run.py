...
def _local_approval_content_ids_to_remove(
    ...
    *,
    ...
    def add_occurrence(function_call: Content, *, closed: bool = False) -> _LocalApprovalOccurrence | None:
        """Implements add occurrence.
        
        Args:
            function_call: Description of function_call.
            closed: Description of closed.
    ...
    def matching_occurrence(
        ...
        *,
        ...
        """Implements matching occurrence.
        
        Args:
            candidates: Description of candidates.
            function_call: Description of function_call.
            require_open: Description of require_open.
            require_unbound: Description of require_unbound.
            newest_first: Description of newest_first.
            prefer_open: Description of prefer_open.
...
def _pending_approval_name(entry: ApprovalOccurrence) -> str:
    """Implements  pending approval name.
...
def _pending_approval_arguments(entry: ApprovalOccurrence) -> str:
    """Implements  pending approval arguments.
...
def _pending_approval_already_approved_requests(
    ...
    """Implements  pending approval already approved requests.
...
def _pending_approval_server_label(entry: ApprovalOccurrence) -> str | None:
    """Implements  pending approval server label.
...
def _approval_arguments_match_pending(pending_arguments: str | None, response_arguments: str | None) -> bool:
    """Implements  approval arguments match pending.
    
    Args:
        pending_arguments: Description of pending_arguments.
        response_arguments: Description of response_arguments.
...
def _json_schema_value_matches(original_value: Any, edited_value: Any) -> bool:
    """Implements  json schema value matches.
    
    Args:
        original_value: Description of original_value.
        edited_value: Description of edited_value.
    ...
    if (
        ...
        for approval in validated_forwarded_approvals:
            ...
            async def forward_hosted_decision(approval: Content = approval) -> list[Content]:
                """Implements forward hosted decision.
                
                Args:
                    approval: Description of approval.
...
def _confirm_changes_target_call_id(
    ...
    """Implements  confirm changes target call id.
    
    Args:
        snapshot_messages: Description of snapshot_messages.
        confirm_call_id: Description of confirm_call_id.
        approval_payload: Description of approval_payload.
