...
def _get_snapshot_store(
    ...
    """Implements  get snapshot store.
    
    Args:
        protocol_runner: Description of protocol_runner.
...
def _configure_snapshot_persistence(
    ...
    *,
    ...
    """Implements  configure snapshot persistence.
...
def _validate_keepalive_seconds(keepalive_seconds: float | None) -> None:
    """Implements  validate keepalive seconds.
    
    Args:
        keepalive_seconds: Description of keepalive_seconds.
    """
    ...
    async def agent_endpoint(request_body: AGUIRequest) -> Response:
        ...
        try:
            ...
            def prepare_frame(encoded: str) -> str | bytes:
                """Implements prepare frame.
                
                Args:
                    encoded: Description of encoded.
