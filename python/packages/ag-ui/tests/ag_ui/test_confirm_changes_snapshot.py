"""This module defines functionality for packages/ag-ui/tests/ag_ui/test_confirm_changes_snapshot.
...
def _confirm_snapshot(
    *,
    ...
    """Implements  confirm snapshot.
    
    Args:
        original_call_id: Description of original_call_id.
...
def test_confirm_changes_target_ignores_non_list_tool_calls() -> None:
    """Validates behavior for confirm changes target ignores non list tool calls.
    """
...
def test_confirm_changes_target_rejects_malformed_arguments_json() -> None:
    """Validates behavior for confirm changes target rejects malformed arguments json.
    """
    snapshot_messages: list[dict[str, Any]] = [
        {
            "role": "assistant",
...
def test_confirm_changes_snapshot_uses_original_call_id_with_multiple_results() -> None:
    """Validates behavior for confirm changes snapshot uses original call id with multiple results.
    """
...
def test_confirm_changes_snapshot_accepts_explicit_payload_call_id() -> None:
    """Validates behavior for confirm changes snapshot accepts explicit payload call id.
    """
    snapshot_messages: list[dict[str, Any]] = [
        {
            "role": "tool",
...
def test_confirm_changes_snapshot_cleans_rejection_without_results() -> None:
    """Validates behavior for confirm changes snapshot cleans rejection without results.
    """
    snapshot_messages = _confirm_snapshot(
        original_call_id="call_target",
        confirm_call_id="call_confirm",
...
def test_confirm_changes_snapshot_keeps_accepted_payload_when_target_result_is_missing() -> None:
    """Validates behavior for confirm changes snapshot keeps accepted payload when target result is missing.
    """
    snapshot_messages = _confirm_snapshot(
        original_call_id="call_target",
        confirm_call_id="call_confirm",
