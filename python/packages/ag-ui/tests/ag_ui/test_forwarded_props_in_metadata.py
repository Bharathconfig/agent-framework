...
class TestBuildSafeMetadata:
    ...
    def test_string_value_unchanged(self):
        """Validates behavior for string value unchanged.
    ...
    def test_dict_value_serialized_to_json(self):
        """Validates behavior for dict value serialized to json.
    ...
    def test_empty_dict_serialized_to_json(self):
        """Validates behavior for empty dict serialized to json.
    ...
    def test_value_within_limit_kept(self):
        """Validates behavior for value within limit kept.
    ...
    def test_none_input_returns_empty(self):
        """Validates behavior for none input returns empty.
    ...
    def test_empty_input_returns_empty(self):
        """Validates behavior for empty input returns empty.
