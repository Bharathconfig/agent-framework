"""This module defines functionality for packages/ag-ui/tests/ag_ui/test_message_hygiene.
...
def test_deduplicate_messages_prefers_non_empty_tool_results() -> None:
    """Validates behavior for deduplicate messages prefers non empty tool results.
    """
    messages = [
        Message(
            role="tool",
