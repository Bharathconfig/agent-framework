...
class StreamingChatClientStub(
    ...
    def __init__(self, stream_fn: StreamFn, response_fn: ResponseFn | None = None) -> None:
        ...
        Args:
            ...
            stream_fn: Description of stream_fn.
            response_fn: Description of response_fn.
        """
...
def collect_events() -> Callable[..., Any]:
    ...
    async def _collect(async_gen: AsyncIterable[Any]) -> list[Any]:
        ...
        Args:
            async_gen: Description of async_gen.
...
def make_agent_wrapper() -> Callable[..., Any]:
    ...
    def _factory(
        ...
        *,
        ...
        Args:
            stream_fn: Description of stream_fn.
            state_schema: Description of state_schema.
            predict_state_config: Description of predict_state_config.
            require_confirmation: Description of require_confirmation.
    ...
    def _factory(
        ...
        *,
        ...
        Args:
            ...
            state_schema: Description of state_schema.
            predict_state_config: Description of predict_state_config.
            default_state: Description of default_state.
