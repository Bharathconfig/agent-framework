...
def _interrupts_from_finished(event: Any) -> list[dict[str, Any]]:
    """Implements  interrupts from finished.
...
class _StartExecutor(Executor):
    """Represents the _StartExecutor type and related behavior.
    """
    @handler
...
class _MiddleExecutor(Executor):
    """Represents the _MiddleExecutor type and related behavior.
    """
    @handler
...
class _FinishExecutor(Executor):
    """Represents the _FinishExecutor type and related behavior.
    """
    @handler
