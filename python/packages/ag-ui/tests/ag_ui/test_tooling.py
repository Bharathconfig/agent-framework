"""This module defines functionality for packages/ag-ui/tests/ag_ui/test_tooling.
...
class DummyTool:
    """Represents the DummyTool type and related behavior.
    """
...
class MockMCPTool:
    ...
    def __init__(self, functions: list[DummyTool], is_connected: bool = True, name: str = "mock-mcp") -> None:
        ...
        Args:
            ...
            is_connected: Description of is_connected.
            name: Description of name.
        """
        self.name = name
...
def test_merge_tools_filters_duplicates() -> None:
    """Validates behavior for merge tools filters duplicates.
    """
...
def test_collect_server_tools_raises_on_duplicate_agent_and_mcp_tool_names() -> None:
    """Validates behavior for collect server tools raises on duplicate agent and mcp tool names.
    """
...
def test_merge_tools_with_approval_tools_no_client() -> None:
    ...
    class ApprovalTool:
        """Represents the ApprovalTool type and related behavior.
        """
