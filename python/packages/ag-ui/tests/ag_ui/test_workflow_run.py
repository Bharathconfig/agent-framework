...
async def test_workflow_run_resume_restores_checkpoint_exactly_once() -> None:
    ...
    class CountingApprovalExecutor(Executor):
        """Represents the CountingApprovalExecutor type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
...
async def test_workflow_run_resume_message_list_from_json_payload() -> None:
    ...
    class MessageRequestExecutor(Executor):
        """Represents the MessageRequestExecutor type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
...
async def test_workflow_run_does_not_cancel_until_resolved_siblings_validate() -> None:
    ...
    async def get_pending_request_info_events() -> dict[str, Any]:
        """Implements get pending request info events.
...
async def test_workflow_run_accepts_multimodal_input_messages() -> None:
    ...
    class CapturingWorkflow:
        """Represents the CapturingWorkflow type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
...
def test_coerce_response_for_request_leaves_non_message_fields_untouched() -> None:
    ...
    @dataclass
    class Tagged:
        """Represents the Tagged type and related behavior.
        """
        note: Message
...
def test_coerce_response_for_request_rejects_malformed_message_field_payloads() -> None:
    ...
    @dataclass
    class Review:
        """Represents the Review type and related behavior.
        """
        notes: list[Message]
...
def test_coerce_response_for_request_builds_pydantic_model_from_json() -> None:
    ...
    class ReviewDecision(BaseModel):
        """Represents the ReviewDecision type and related behavior.
        """
        approved: bool
...
async def test_workflow_run_emits_run_error_when_stream_raises() -> None:
    ...
    class FailingWorkflow:
        """Represents the FailingWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
class TestCoerceResponseForRequest:
    ...
    def test_unknown_type_mismatch(self):
        ...
        class Custom:
            """Represents the Custom type and related behavior.
            """
            pass
...
class TestMessageRoleValue:
    ...
    def test_enum_role(self):
        ...
        class Role(Enum):
            """Represents the Role type and related behavior.
            """
            USER = "user"
...
async def test_workflow_run_status_enum_state():
    ...
    class WorkflowState(Enum):
        """Represents the WorkflowState type and related behavior.
        """
        IDLE = "idle"

    class StatusWorkflow:
        """Represents the StatusWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_executor_invoked_drains_text():
    ...
    class ExecutorWorkflow:
        """Represents the ExecutorWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_executor_failed_event():
    ...
    class ExecutorFailWorkflow:
        """Represents the ExecutorFailWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_list_base_event_output():
    ...
    class ListEventWorkflow:
        """Represents the ListEventWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_late_run_started():
    ...
    class EmptyWorkflow:
        """Represents the EmptyWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_last_assistant_text_update():
    ...
    class DualTextWorkflow:
        """Represents the DualTextWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_superstep_events():
    ...
    class SuperstepWorkflow:
        """Represents the SuperstepWorkflow type and related behavior.
        """
        def run(self, **kwargs: Any):
            """Implements run.
...
async def test_workflow_run_drops_fwd_kwargs_when_run_lacks_param() -> None:
    ...
    class StrictWorkflow:
        """Represents the StrictWorkflow type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
