"""This module defines functionality for packages/foundry_hosting/agent_framework_foundry_hosting/_responses.
...
@dataclass
class ConsentError:
    """Represents the ConsentError type and related behavior.
    """
    name: str
    consent_url: str
...
class _OutputItemTracker:
    ...
    def _ensure_message_content(
        ...
        """Implements  ensure message content.
    ...
    def _open_message_content(
        ...
        """Implements  open message content.
    ...
    def _close_message_content(self) -> Generator[ResponseStreamEvent]:
        """Implements  close message content.
