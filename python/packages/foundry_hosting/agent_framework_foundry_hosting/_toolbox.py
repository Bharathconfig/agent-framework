"""This module defines functionality for packages/foundry_hosting/agent_framework_foundry_hosting/_toolbox.
...
class _FoundryToolboxSkillsSource(SkillsSource):
    ...
    def __init__(self, toolbox: FoundryToolbox, *, archive_options: dict[str, Any] | None = None) -> None:
        ...
        Args:
            self: Description of self.
            toolbox: Description of toolbox.
            archive_options: Description of archive_options.
        """
