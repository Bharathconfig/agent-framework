...
class TestInit:
    ...
    def test_accepts_supports_agent_run(self) -> None:
        """Validates behavior for accepts supports agent run.
...
class TestPartitionKey:
    """Represents the TestPartitionKey type and related behavior.
    """
    def test_local_returns_session_id(self) -> None:
        """Validates behavior for local returns session id.
    ...
    def test_local_missing_session_id_raises(self) -> None:
        """Validates behavior for local missing session id raises.
    ...
    def test_hosted_missing_user_id_raises(self) -> None:
        """Validates behavior for hosted missing user id raises.
    ...
    def test_hosted_returns_composite_key(self) -> None:
        """Validates behavior for hosted returns composite key.
...
class TestHandleInvoke:
    """Represents the TestHandleInvoke type and related behavior.
    """
    async def test_missing_message_returns_400(self) -> None:
        """Validates behavior for missing message returns 400.
    ...
    async def test_missing_message_streaming_returns_400(self) -> None:
        """Validates behavior for missing message streaming returns 400.
    ...
    async def test_partition_key_failure_returns_500(self) -> None:
        """Validates behavior for partition key failure returns 500.
    ...
    async def test_non_streaming_returns_agent_text(self) -> None:
        """Validates behavior for non streaming returns agent text.
    ...
    async def test_streaming_yields_update_text(self) -> None:
        """Validates behavior for streaming yields update text.
    ...
    async def test_session_is_reused_across_requests(self) -> None:
        """Validates behavior for session is reused across requests.
