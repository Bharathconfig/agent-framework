...
class _CountdownExecutor(Executor):
    ...
    def __init__(self, sleep_seconds: float, id: str = "countdown") -> None:
        ...
        Args:
            self: Description of self.
            sleep_seconds: Description of sleep_seconds.
            id: Description of id.
        """
        super().__init__(id=id)
...
def _start_resilient_server(
    *, port: int, state_root: Path, log_path: Path, build_workflow: Callable[[float], Any] = _build_countdown_workflow
    ...
    """Implements  start resilient server.
    
    Args:
        port: Description of port.
        state_root: Description of state_root.
        log_path: Description of log_path.
        build_workflow: Description of build_workflow.
...
def _clear_stale_stream_lock(state_root: Path, response_id: str) -> None:
    ...
    """Implements  clear stale stream lock.
...
def _output_texts(output_items: list[dict[str, Any]]) -> list[str]:
    """Implements  output texts.
    
    Args:
        output_items: Description of output_items.
