...
def _function_approval_store(request: Content) -> MagicMock:
    """Implements  function approval store.
...
async def _raising_updates(
    ...
    *,
    ...
    """Implements  raising updates.
    
    Args:
        message: Description of message.
        initial_updates: Description of initial_updates.
        before_raise: Description of before_raise.
    """
...
class _RecordingHistoryClient(BaseChatClient):
    """Represents the _RecordingHistoryClient type and related behavior.
    """
    def __init__(self) -> None:
        """Initializes a new instance.
...
class _ServiceStorageRecordingClient(BaseChatClient):
    ...
    def __init__(self, *, honors_store: bool = True) -> None:
        ...
        Args:
            self: Description of self.
            honors_store: Description of honors_store.
        """
        super().__init__()
...
class _PerServiceCallHistoryProvider(HistoryProvider):
    """Represents the _PerServiceCallHistoryProvider type and related behavior.
    """
    def __init__(self) -> None:
        """Initializes a new instance.
...
class _FunctionLoopRecordingClient(
    ...
    """Represents the _FunctionLoopRecordingClient type and related behavior.
    """
...
class _FailingSessionStore(SessionStore):
    """Represents the _FailingSessionStore type and related behavior.
    """
    def __init__(self) -> None:
        """Initializes a new instance.
...
async def test_output_item_tracker_emits_native_refusal_events_for_marked_text() -> None:
    """Validates behavior for output item tracker emits native refusal events for marked text.
    """
...
async def test_output_item_tracker_keeps_mixed_text_and_refusal_in_one_message() -> None:
    """Validates behavior for output item tracker keeps mixed text and refusal in one message.
    """
...
async def test_item_to_message_marks_refusal_text() -> None:
    """Validates behavior for item to message marks refusal text.
    """
...
class _CapturingASGITransport(httpx.AsyncBaseTransport):
    """Represents the _CapturingASGITransport type and related behavior.
    """
    ...
    async def handle_async_request(self, request: httpx.Request) -> httpx.Response:
        """Implements handle async request.
...
async def test_agui_service_storage_native_uuid_uses_backend_created_conversation(
    ...
    async def create_conversation(*, session_id: str) -> AgentSession:
        """Implements create conversation.
...
class TestSerializationHelpers:
    """Represents the TestSerializationHelpers type and related behavior.
    """
    def test_json_safe_to_str_preserves_structured_conversion_and_falls_back_to_string(self) -> None:
        """Validates behavior for json safe to str preserves structured conversion and falls back to string.
        ...
        class DataclassValue:
            """Represents the DataclassValue type and related behavior.
            """
            count: int

        class ToDictValue:
            """Represents the ToDictValue type and related behavior.
            """
        ...
        class SerializationErrorValue:
            """Represents the SerializationErrorValue type and related behavior.
            """
        ...
        class UnexpectedErrorValue:
            """Represents the UnexpectedErrorValue type and related behavior.
            """
            def to_dict(self) -> dict[str, Any]:
                """Implements to dict.
    ...
    def test_stringify_mcp_output_extracts_only_text_content_mappings(self) -> None:
        """Validates behavior for stringify mcp output extracts only text content mappings.
...
class TestResponsesHostServerInit:
    """Represents the TestResponsesHostServerInit type and related behavior.
    """
    def test_init_basic(self) -> None:
        """Validates behavior for init basic.
    ...
    def test_init_uses_default_store_providers(self) -> None:
        """Validates behavior for init uses default store providers.
    ...
    def test_init_rejects_history_provider_with_load_messages(self) -> None:
        ...
        """Validates behavior for init rejects history provider with load messages.
        ...
        class _LoadMessagesHistoryProvider(HistoryProvider):
            """Represents the _LoadMessagesHistoryProvider type and related behavior.
            """
            async def get_messages(
                self, session_id: str | None, *, state: dict[str, Any] | None = None, **kwargs: Any
            ) -> list[Message]:
    ...
    def test_init_allows_history_provider_with_load_messages_for_agent_history(self) -> None:
        """Validates behavior for init allows history provider with load messages for agent history.
    ...
    def test_init_rejects_invalid_history_source(self) -> None:
        """Validates behavior for init rejects invalid history source.
    ...
    def test_init_rejects_default_service_continuation_for_agent_server_history(self, option_name: str) -> None:
        """Validates behavior for init rejects default service continuation for agent server history.
        
        Args:
            self: Description of self.
            option_name: Description of option_name.
        """
        agent = Agent(
    ...
    def test_init_allows_default_conversation_id_for_agent_history(self) -> None:
        """Validates behavior for init allows default conversation id for agent history.
    ...
    def test_init_rejects_custom_agent_for_agent_server_history(self) -> None:
        """Validates behavior for init rejects custom agent for agent server history.
    ...
    def test_init_requires_storage_capability_for_agent_server_history(self) -> None:
        """Validates behavior for init requires storage capability for agent server history.
    ...
    def test_failed_init_does_not_mutate_agent(self) -> None:
        """Validates behavior for failed init does not mutate agent.
    ...
    def test_init_rejects_resilient_background_for_non_workflow_agent(self, tmp_path: Path) -> None:
        """Validates behavior for init rejects resilient background for non workflow agent.
    ...
    def test_init_rejects_steerable_conversations_for_workflow_agent(self) -> None:
        """Validates behavior for init rejects steerable conversations for workflow agent.
    ...
    async def test_previous_response_requires_existing_agent_session(self) -> None:
        """Validates behavior for previous response requires existing agent session.
...
class TestAgentSessionPersistence:
    """Represents the TestAgentSessionPersistence type and related behavior.
    """
    async def test_previous_response_chain_restores_session_state(self) -> None:
        """Validates behavior for previous response chain restores session state.
    ...
    async def test_responses_history_is_not_duplicated_by_default_local_history(self) -> None:
        """Validates behavior for responses history is not duplicated by default local history.
    ...
    async def test_agent_server_history_disables_service_storage(self) -> None:
        """Validates behavior for agent server history disables service storage.
    ...
    async def test_agent_server_history_removes_store_for_non_storing_client(self) -> None:
        """Validates behavior for agent server history removes store for non storing client.
    ...
    async def test_agent_history_does_not_forward_runtime_options_to_custom_agent(self) -> None:
        """Validates behavior for agent history does not forward runtime options to custom agent.
    ...
    async def test_agent_server_history_clears_restored_service_session_id(self) -> None:
        """Validates behavior for agent server history clears restored service session id.
    ...
    async def test_agent_history_preserves_service_storage(self) -> None:
        """Validates behavior for agent history preserves service storage.
    ...
    async def test_agent_history_uses_in_memory_history_from_session_store(self) -> None:
        """Validates behavior for agent history uses in memory history from session store.
    ...
    async def test_client_that_ignores_disabled_storage_fails_without_saving_session(
        ...
        """Validates behavior for client that ignores disabled storage fails without saving session.
    ...
    async def test_per_service_call_persistence_preserves_function_loop_history(self) -> None:
        """Validates behavior for per service call persistence preserves function loop history.
    ...
    async def test_run_saves_final_session_state(self) -> None:
        """Validates behavior for run saves final session state.
    ...
    async def test_failed_run_still_saves_mutated_session(self) -> None:
        """Validates behavior for failed run still saves mutated session.
    ...
    async def test_run_save_failure_emits_failed_response(self) -> None:
        """Validates behavior for run save failure emits failed response.
    ...
    async def test_run_and_save_failure_emit_one_combined_failure(
        ...
        """Validates behavior for run and save failure emit one combined failure.
        ...
        def failing_run(*_args: Any, **_kwargs: Any) -> ResponseStream[AgentResponseUpdate, AgentResponse]:
            ...
            Args:
                *_args: Description of _args.
                **_kwargs: Description of _kwargs.
    ...
    async def test_cancellation_is_preserved_when_best_effort_save_fails(
        ...
        """Validates behavior for cancellation is preserved when best effort save fails.
    ...
    async def test_abandoned_stream_saves_partial_session(self) -> None:
        """Validates behavior for abandoned stream saves partial session.
...
class TestHealthCheck:
    """Represents the TestHealthCheck type and related behavior.
    """
    async def test_readiness(self) -> None:
        """Validates behavior for readiness.
...
class TestNonStreaming:
    ...
    async def test_basic_text_response(self) -> None:
        """Validates behavior for basic text response.
    ...
    async def test_function_call_and_result(self) -> None:
        """Validates behavior for function call and result.
    ...
    async def test_function_result_serializes_json_safely(self, result: Any, expected_output: str) -> None:
        """Validates behavior for function result serializes json safely.
    ...
    async def test_function_result_serialization_failure_falls_back_to_json_string(self) -> None:
        """Validates behavior for function result serialization failure falls back to json string.
    ...
    async def test_shell_call_preserves_execution_limits(self) -> None:
        """Validates behavior for shell call preserves execution limits.
    ...
    async def test_hosted_mcp_call_and_result_persist_as_single_mcp_call(self) -> None:
        """Validates behavior for hosted mcp call and result persist as single mcp call.
    ...
    async def test_mcp_result_serialization_matches_with_and_without_correlated_call(
        ...
        """Validates behavior for mcp result serialization matches with and without correlated call.
    ...
    async def test_reasoning_content(self) -> None:
        """Validates behavior for reasoning content.
    ...
    async def test_empty_response(self) -> None:
        """Validates behavior for empty response.
    ...
    async def test_chat_options_forwarded(self) -> None:
        """Validates behavior for chat options forwarded.
...
class TestStreaming:
    ...
    async def test_basic_text_streaming(self) -> None:
        """Validates behavior for basic text streaming.
    ...
    async def test_usage_is_aggregated_in_completed_response(self, caplog: pytest.LogCaptureFixture) -> None:
        """Validates behavior for usage is aggregated in completed response.
    ...
    async def test_function_call_streaming(self) -> None:
        """Validates behavior for function call streaming.
    ...
    async def test_declaration_only_metadata_replay_requires_none_arguments(
        ...
        """Validates behavior for declaration only metadata replay requires none arguments.
        
        Args:
            self: Description of self.
            arguments: Description of arguments.
            expected_count: Description of expected_count.
        """
    ...
    async def test_function_call_id_can_be_reused_after_terminal_result(self) -> None:
        """Validates behavior for function call id can be reused after terminal result.
    ...
    async def test_function_call_streaming_serializes_dataclass_arguments(self) -> None:
        """Validates behavior for function call streaming serializes dataclass arguments.
        ...
        class HandoffLikeRequest:
            """Represents the HandoffLikeRequest type and related behavior.
            """
    ...
    async def test_alternating_text_and_function_call(self) -> None:
        """Validates behavior for alternating text and function call.
    ...
    async def test_reasoning_then_text_streaming(self) -> None:
        """Validates behavior for reasoning then text streaming.
    ...
    async def test_empty_streaming(self) -> None:
        """Validates behavior for empty streaming.
    ...
    async def test_different_function_call_ids_produce_separate_items(self) -> None:
        """Validates behavior for different function call ids produce separate items.
    ...
    async def test_mcp_tool_call_streaming(self) -> None:
        """Validates behavior for mcp tool call streaming.
    ...
    async def test_mcp_tool_call_and_result_streaming_emit_single_completed_mcp_call(self) -> None:
        """Validates behavior for mcp tool call and result streaming emit single completed mcp call.
...
class TestOutputItemToMessage:
    ...
    async def test_output_message(self) -> None:
        """Validates behavior for output message.
    ...
    async def test_message(self) -> None:
        """Validates behavior for message.
    ...
    async def test_function_call(self) -> None:
        """Validates behavior for function call.
    ...
    async def test_function_call_output(self) -> None:
        """Validates behavior for function call output.
    ...
    async def test_function_call_output_structured_result_is_json(self) -> None:
        """Validates behavior for function call output structured result is json.
    ...
    async def test_function_call_output_without_call_id_raises(self) -> None:
        """Validates behavior for function call output without call id raises.
    ...
    async def test_reasoning(self) -> None:
        """Validates behavior for reasoning.
    ...
    async def test_reasoning_no_summary(self) -> None:
        """Validates behavior for reasoning no summary.
    ...
    async def test_mcp_call(self) -> None:
        """Validates behavior for mcp call.
    ...
    async def test_mcp_call_with_output_reconstructs_mcp_result_content(self) -> None:
        """Validates behavior for mcp call with output reconstructs mcp result content.
    ...
    async def test_mcp_approval_request(self) -> None:
        """Validates behavior for mcp approval request.
    ...
    async def test_mcp_approval_response(self) -> None:
        """Validates behavior for mcp approval response.
    ...
    async def test_code_interpreter_call(self) -> None:
        """Validates behavior for code interpreter call.
    ...
    async def test_image_generation_call(self) -> None:
        """Validates behavior for image generation call.
    ...
    async def test_shell_call(self) -> None:
        """Validates behavior for shell call.
    ...
    async def test_shell_call_output(self) -> None:
        """Validates behavior for shell call output.
    ...
    async def test_local_shell_call(self) -> None:
        """Validates behavior for local shell call.
    ...
    async def test_local_shell_call_output(self) -> None:
        """Validates behavior for local shell call output.
    ...
    async def test_file_search_call(self) -> None:
        """Validates behavior for file search call.
    ...
    async def test_web_search_call(self) -> None:
        """Validates behavior for web search call.
    ...
    async def test_computer_call(self) -> None:
        """Validates behavior for computer call.
    ...
    async def test_computer_call_output(self) -> None:
        """Validates behavior for computer call output.
    ...
    async def test_custom_tool_call(self) -> None:
        """Validates behavior for custom tool call.
    ...
    async def test_custom_tool_call_output(self) -> None:
        """Validates behavior for custom tool call output.
    ...
    async def test_apply_patch_call(self) -> None:
        """Validates behavior for apply patch call.
    ...
    async def test_apply_patch_call_output(self) -> None:
        """Validates behavior for apply patch call output.
    ...
    async def test_oauth_consent_request(self) -> None:
        """Validates behavior for oauth consent request.
    ...
    async def test_structured_outputs_dict(self) -> None:
        """Validates behavior for structured outputs dict.
    ...
    async def test_structured_outputs_string(self) -> None:
        """Validates behavior for structured outputs string.
    ...
    async def test_unsupported_type_raises(self) -> None:
        """Validates behavior for unsupported type raises.
...
class TestItemToMessage:
    ...
    async def test_message_with_string_content(self) -> None:
        """Validates behavior for message with string content.
    ...
    async def test_message_with_input_text_content(self) -> None:
        """Validates behavior for message with input text content.
    ...
    async def test_message_with_multiple_contents(self) -> None:
        """Validates behavior for message with multiple contents.
    ...
    async def test_function_call_output_non_string(self, output: Any) -> None:
        """Validates behavior for function call output non string.
    ...
    async def test_reasoning_with_summary(self) -> None:
        """Validates behavior for reasoning with summary.
    ...
    async def test_custom_tool_call_output_non_string(self) -> None:
        """Validates behavior for custom tool call output non string.
...
class TestFunctionApprovalConversion:
    ...
    async def test_output_item_mcp_approval_request_loads_from_storage(self) -> None:
        """Validates behavior for output item mcp approval request loads from storage.
    ...
    async def test_output_item_mcp_approval_request_without_storage_raises(self) -> None:
        """Validates behavior for output item mcp approval request without storage raises.
    ...
    async def test_output_item_mcp_approval_response_resolves_to_approval_response(self) -> None:
        """Validates behavior for output item mcp approval response resolves to approval response.
    ...
    async def test_output_item_mcp_approval_response_without_storage_raises(self) -> None:
        """Validates behavior for output item mcp approval response without storage raises.
    ...
    async def test_input_item_mcp_approval_request_loads_from_storage(self) -> None:
        """Validates behavior for input item mcp approval request loads from storage.
    ...
    async def test_input_item_mcp_approval_response_resolves_to_approval_response(self) -> None:
        """Validates behavior for input item mcp approval response resolves to approval response.
...
class TestFunctionApprovalRoundTrip:
    ...
    async def test_non_streaming_emits_mcp_approval_request_and_persists_to_storage(self) -> None:
        """Validates behavior for non streaming emits mcp approval request and persists to storage.
    ...
    async def test_streaming_emits_mcp_approval_request_and_persists_to_storage(self) -> None:
        """Validates behavior for streaming emits mcp approval request and persists to storage.
...
class TestCheckpointContextValidation:
    """Represents the TestCheckpointContextValidation type and related behavior.
    """
    @pytest.mark.parametrize(
    ...
    async def test_workflow_rejects_invalid_checkpoint_scope(
        ...
        """Validates behavior for workflow rejects invalid checkpoint scope.
        
        Args:
            self: Description of self.
            context_field: Description of context_field.
            bad_id: Description of bad_id.
        """
...
class TestConsentUrlFromError:
    """Represents the TestConsentUrlFromError type and related behavior.
    """
    def test_returns_consent_url_when_inner_arg_is_consent_mcp_error(self) -> None:
        """Validates behavior for returns consent url when inner arg is consent mcp error.
    ...
    def test_returns_consent_url_for_a2a_preview_source(self) -> None:
        """Validates behavior for returns consent url for a2a preview source.
    ...
    def test_returns_none_when_no_mcp_error_in_args(self) -> None:
        """Validates behavior for returns none when no mcp error in args.
    ...
    def test_returns_none_when_mcp_error_has_different_code(self) -> None:
        """Validates behavior for returns none when mcp error has different code.
    ...
    def test_returns_none_for_bare_mcp_error_without_wrapping(self) -> None:
        ...
        """Validates behavior for returns none for bare mcp error without wrapping.
    ...
    def test_returns_none_when_message_has_no_json(self) -> None:
        """Validates behavior for returns none when message has no json.
...
class TestAgentLifecycle:
    """Represents the TestAgentLifecycle type and related behavior.
    """
    async def test_agent_entered_lazily_on_first_request(self) -> None:
        """Validates behavior for agent entered lazily on first request.
    ...
    async def test_agent_entered_only_once_across_requests(self) -> None:
        """Validates behavior for agent entered only once across requests.
    ...
    async def test_cleanup_exits_agent_and_allows_reentry(self) -> None:
        """Validates behavior for cleanup exits agent and allows reentry.
    ...
    async def test_failed_entry_does_not_cache_stack(self) -> None:
        """Validates behavior for failed entry does not cache stack.
...
class TestOAuthConsentSurfacing:
    """Represents the TestOAuthConsentSurfacing type and related behavior.
    """
    async def test_non_streaming_consent_error_emits_oauth_output_item(self) -> None:
        """Validates behavior for non streaming consent error emits oauth output item.
    ...
    async def test_streaming_consent_error_emits_oauth_output_item(self) -> None:
        """Validates behavior for streaming consent error emits oauth output item.
    ...
    async def test_non_consent_error_during_entry_propagates(self) -> None:
        """Validates behavior for non consent error during entry propagates.
    ...
    async def test_retry_after_consent_succeeds(self) -> None:
        """Validates behavior for retry after consent succeeds.
    ...
    async def test_connect_time_consent_preserves_an_existing_session(self) -> None:
        """Validates behavior for connect time consent preserves an existing session.
    ...
    async def test_recovered_consent_is_tracked_and_not_emitted_twice(self) -> None:
        """Validates behavior for recovered consent is tracked and not emitted twice.
    ...
    async def test_mid_run_consent_is_persisted_without_an_incomplete_reason(self) -> None:
        """Validates behavior for mid run consent is persisted without an incomplete reason.
    ...
    async def test_streaming_mid_run_consent_is_emitted_once_and_can_be_retried(self) -> None:
        """Validates behavior for streaming mid run consent is emitted once and can be retried.
    ...
    async def test_mid_run_consent_rejects_unsafe_links(self, consent_link: str) -> None:
        """Validates behavior for mid run consent rejects unsafe links.
        
        Args:
            self: Description of self.
            consent_link: Description of consent_link.
        """
        agent = _make_agent(
            response=AgentResponse(
                messages=[
    ...
    async def test_connect_time_consent_rejects_unsafe_links(self) -> None:
        """Validates behavior for connect time consent rejects unsafe links.
...
class TestResponseFailedSurfacing:
    ...
    async def test_non_streaming_run_failure_emits_response_failed(self) -> None:
        """Validates behavior for non streaming run failure emits response failed.
    ...
    async def test_streaming_run_failure_emits_response_failed(self) -> None:
        """Validates behavior for streaming run failure emits response failed.
    ...
    async def test_streaming_run_failure_includes_usage(self) -> None:
        """Validates behavior for streaming run failure includes usage.
...
class _ToolApprovalWorkflowAgentMock(SupportsAgentRun):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            tool_arguments: Description of tool_arguments.
            approval_request_ids: Description of approval_request_ids.
            final_text: Description of final_text.
        """
    ...
    def _build_approval_request(self) -> Content:
        """Implements  build approval request.
    ...
    def _approval_responses_in(messages: list[Message]) -> list[Content]:
        """Implements  approval responses in.
...
def _build_text_workflow_agent(text: str) -> WorkflowAgent:
    ...
    class _TextAgent(SupportsAgentRun):
        """Represents the _TextAgent type and related behavior.
        """
...
class TestWorkflowAgentHosting:
    ...
    async def test_basic_text_response_streaming(self) -> None:
        """Validates behavior for basic text response streaming.
...
class TestResilientBackgroundCheckpointing:
    ...
    async def test_workflow_yields_checkpoint_event_when_resilient_background(self, tmp_path: Path) -> None:
        """Validates behavior for workflow yields checkpoint event when resilient background.
