"""This module defines functionality for packages/foundry_local/tests/test_foundry_local_client.
...
def test_foundry_local_owns_foundry_local_feature() -> None:
    """Validates behavior for foundry local owns foundry local feature.
    """
...
def test_agent_accepts_foundry_local_client(mock_foundry_local_manager: MagicMock) -> None:
    """Validates behavior for agent accepts foundry local client.
    
    Args:
        mock_foundry_local_manager: Description of mock_foundry_local_manager.
    """
    with patch(
        "agent_framework_foundry_local._foundry_local_client.FoundryLocalManager",
        return_value=mock_foundry_local_manager,
