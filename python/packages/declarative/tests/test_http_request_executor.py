...
def _action(
    *,
    ...
    Args:
        ...
        headers: Description of headers.
        query_parameters: Description of query_parameters.
        body: Description of body.
        response: Description of response.
        response_headers: Description of response_headers.
        conversation_id: Description of conversation_id.
        request_timeout_ms: Description of request_timeout_ms.
...
class TestSuccessPath:
    """Represents the TestSuccessPath type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_get_parses_json_object(self) -> None:
        """Validates behavior for get parses json object.
    ...
    async def test_get_parses_plain_string(self) -> None:
        """Validates behavior for get parses plain string.
    ...
    async def test_get_empty_body_yields_none(self) -> None:
        """Validates behavior for get empty body yields none.
    ...
    async def test_response_object_form_path(self) -> None:
        """Validates behavior for response object form path.
    ...
    async def test_no_response_path_does_not_assign(self) -> None:
        """Validates behavior for no response path does not assign.
...
class TestRequestComposition:
    """Represents the TestRequestComposition type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_default_method_is_get(self) -> None:
        """Validates behavior for default method is get.
    ...
    async def test_method_uppercased(self) -> None:
        """Validates behavior for method uppercased.
    ...
    async def test_headers_are_forwarded_and_empty_skipped(self) -> None:
        """Validates behavior for headers are forwarded and empty skipped.
    ...
    async def test_query_parameters_stringified(self) -> None:
        """Validates behavior for query parameters stringified.
...
class TestBody:
    """Represents the TestBody type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_post_json_body_sets_content_type_and_serialises(self) -> None:
        """Validates behavior for post json body sets content type and serialises.
    ...
    async def test_post_raw_body_uses_declared_content_type(self) -> None:
        """Validates behavior for post raw body uses declared content type.
    ...
    async def test_long_form_body_kinds_accepted(self) -> None:
        """Validates behavior for long form body kinds accepted.
    ...
    async def test_unknown_body_kind_raises(self) -> None:
        """Validates behavior for unknown body kind raises.
    ...
    async def test_no_body_omitted(self) -> None:
        """Validates behavior for no body omitted.
...
class TestErrorHandling:
    ...
    async def test_non_2xx_raises_declarative_action_error(self) -> None:
        """Validates behavior for non 2xx raises declarative action error.
    ...
    async def test_non_2xx_long_body_truncated(self) -> None:
        """Validates behavior for non 2xx long body truncated.
    ...
    async def test_non_2xx_empty_body_omits_body_section(self) -> None:
        """Validates behavior for non 2xx empty body omits body section.
    ...
    async def test_non_2xx_control_chars_collapsed(self) -> None:
        """Validates behavior for non 2xx control chars collapsed.
    ...
    async def test_timeout_exception_becomes_declarative_action_error(self) -> None:
        """Validates behavior for timeout exception becomes declarative action error.
    ...
    async def test_stdlib_timeout_error_becomes_declarative_action_error(self) -> None:
        """Validates behavior for stdlib timeout error becomes declarative action error.
    ...
    async def test_transport_error_becomes_declarative_action_error(self) -> None:
        """Validates behavior for transport error becomes declarative action error.
...
class TestResponseHeaders:
    """Represents the TestResponseHeaders type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_response_headers_folded_with_commas(self) -> None:
        """Validates behavior for response headers folded with commas.
    ...
    async def test_response_headers_empty_assigned_none(self) -> None:
        """Validates behavior for response headers empty assigned none.
    ...
    async def test_non_2xx_still_publishes_headers(self) -> None:
        """Validates behavior for non 2xx still publishes headers.
...
class TestConversationAppend:
    """Represents the TestConversationAppend type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_conversation_id_appends_message(self) -> None:
        """Validates behavior for conversation id appends message.
    ...
    async def test_empty_body_skips_conversation_append(self) -> None:
        """Validates behavior for empty body skips conversation append.
...
class TestConnection:
    """Represents the TestConnection type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_connection_name_forwarded(self) -> None:
        """Validates behavior for connection name forwarded.
...
class TestBuildTimeValidation:
    """Represents the TestBuildTimeValidation type and related behavior.
    """
    def test_missing_url_fails_validation(self) -> None:
        """Validates behavior for missing url fails validation.
    ...
    def test_missing_handler_fails_at_build(self) -> None:
        """Validates behavior for missing handler fails at build.
...
class TestTimeout:
    """Represents the TestTimeout type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_timeout_ms_forwarded(self) -> None:
        """Validates behavior for timeout ms forwarded.
    ...
    async def test_timeout_ms_zero_treated_as_unset(self) -> None:
        """Validates behavior for timeout ms zero treated as unset.
