...
class FakeListToolsResult:  # noqa: B903 - mimics ``mcp.types.ListToolsResult`` shape, not a value type
    ...
    def __init__(self, tools: list[Any], next_cursor: str | None = None) -> None:
        ...
        Args:
            ...
            next_cursor: Description of next_cursor.
        """
        self.tools = tools
...
class FakeMcpTool:
    ...
    def __init__(
        ...
        Args:
            ...
            inputSchema: Description of inputSchema.
            outputSchema: Description of outputSchema.
        """
        self.name = name
...
def _clear_fake_instances() -> None:
    """Implements  clear fake instances.
    """
...
def _invocation(
    *, server_url: str = "https://mcp.example/api", tool_name: str = "search", **overrides: Any
    ...
    Args:
        ...
        tool_name: Description of tool_name.
        **overrides: Description of overrides.
...
class TestConstruction:
    """Represents the TestConstruction type and related behavior.
    """
    def test_invalid_cache_size_raises(self) -> None:
        """Validates behavior for invalid cache size raises.
...
class TestToolKwargs:
    """Represents the TestToolKwargs type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_load_prompts_false_passed_to_tool(self) -> None:
        """Validates behavior for load prompts false passed to tool.
    ...
    async def test_server_label_used_as_tool_name(self) -> None:
        """Validates behavior for server label used as tool name.
    ...
    async def test_default_tool_name_when_no_label(self) -> None:
        """Validates behavior for default tool name when no label.
    ...
    async def test_no_header_provider_when_no_headers(self) -> None:
        """Validates behavior for no header provider when no headers.
    ...
    async def test_header_provider_returns_captured_headers(self) -> None:
        """Validates behavior for header provider returns captured headers.
...
class TestCache:
    """Represents the TestCache type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_same_url_and_headers_hit_cache(self) -> None:
        """Validates behavior for same url and headers hit cache.
    ...
    async def test_different_headers_create_separate_entries(self) -> None:
        """Validates behavior for different headers create separate entries.
    ...
    async def test_different_urls_create_separate_entries(self) -> None:
        """Validates behavior for different urls create separate entries.
    ...
    async def test_lru_eviction_closes_old_entry(self) -> None:
        """Validates behavior for lru eviction closes old entry.
    ...
    async def test_repeated_use_keeps_lru_alive(self) -> None:
        """Validates behavior for repeated use keeps lru alive.
...
class TestAclose:
    """Represents the TestAclose type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_aclose_closes_owned_clients(self) -> None:
        """Validates behavior for aclose closes owned clients.
    ...
    async def test_aclose_does_not_close_caller_supplied_client(self) -> None:
        """Validates behavior for aclose does not close caller supplied client.
    ...
    async def test_async_context_manager(self) -> None:
        """Validates behavior for async context manager.
...
class TestResultNormalisation:
    """Represents the TestResultNormalisation type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_string_result_wrapped_in_text_content(self) -> None:
        """Validates behavior for string result wrapped in text content.
    ...
    async def test_list_result_passed_through(self) -> None:
        """Validates behavior for list result passed through.
...
class TestErrorMapping:
    """Represents the TestErrorMapping type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_tool_execution_exception_returns_error_result(self) -> None:
        """Validates behavior for tool execution exception returns error result.
    ...
    async def test_httpx_error_returns_error_result(self) -> None:
        """Validates behavior for httpx error returns error result.
    ...
    async def test_connect_failure_returns_error_result(self) -> None:
        """Validates behavior for connect failure returns error result.
...
class TestCacheKey:
    """Represents the TestCacheKey type and related behavior.
    """
    def test_key_order_independent(self) -> None:
        """Validates behavior for key order independent.
    ...
    def test_key_distinguishes_values(self) -> None:
        """Validates behavior for key distinguishes values.
    ...
    def test_empty_headers_use_fixed_hash(self) -> None:
        """Validates behavior for empty headers use fixed hash.
    ...
    def test_key_distinguishes_connection_name(self) -> None:
        """Validates behavior for key distinguishes connection name.
    ...
    def test_key_distinguishes_server_label(self) -> None:
        """Validates behavior for key distinguishes server label.
    ...
    def test_key_collapses_header_name_case(self) -> None:
        """Validates behavior for key collapses header name case.
    ...
    def test_key_keeps_header_value_case(self) -> None:
        """Validates behavior for key keeps header value case.
...
class TestListTools:
    ...
    async def test_list_tools_returns_json_catalog(self) -> None:
        """Validates behavior for list tools returns json catalog.
    ...
    def test_class_attribute_value(self) -> None:
        ...
        """Validates behavior for class attribute value.
