...
class TestRequestComposition:
    ...
    async def test_query_parameters_merged_into_url(self) -> None:
        """Validates behavior for query parameters merged into url.
    ...
    async def test_body_content_type_forwarded(self) -> None:
        """Validates behavior for body content type forwarded.
    ...
    async def test_existing_content_type_header_not_overwritten(self) -> None:
        """Validates behavior for existing content type header not overwritten.
...
class TestTimeout:
    ...
    async def test_per_request_timeout_surfaces_as_timeout_exception(self) -> None:
        """Validates behavior for per request timeout surfaces as timeout exception.
...
class TestResponseHeaders:
    ...
    async def test_multi_value_headers_preserved(self) -> None:
        """Validates behavior for multi value headers preserved.
...
class TestClientOwnership:
    """Represents the TestClientOwnership type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_owned_client_is_closed_on_aclose(self) -> None:
        """Validates behavior for owned client is closed on aclose.
    ...
    async def test_caller_owned_client_is_not_closed(self) -> None:
        """Validates behavior for caller owned client is not closed.
...
class TestClientProvider:
    """Represents the TestClientProvider type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_client_provider_overrides_default(self) -> None:
        """Validates behavior for client provider overrides default.
    ...
    async def test_client_provider_returning_none_falls_back(self) -> None:
        """Validates behavior for client provider returning none falls back.
...
class TestValidation:
    """Represents the TestValidation type and related behavior.
    """
    @pytest.mark.asyncio
    async def test_empty_url_raises(self) -> None:
        """Validates behavior for empty url raises.
    ...
    async def test_empty_method_raises(self) -> None:
        """Validates behavior for empty method raises.
