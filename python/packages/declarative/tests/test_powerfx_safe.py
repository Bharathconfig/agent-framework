...
class _StrRole(str, Enum):
    """Represents the _StrRole type and related behavior.
    """
    USER = "user"
    SYSTEM = "system"
...
class _IntCode(IntEnum):
    """Represents the _IntCode type and related behavior.
    """
    ONE = 1
    TWO = 2
...
class _PlainEnum(Enum):
    """Represents the _PlainEnum type and related behavior.
    """
    X = "x"
    Y = 42
...
def test_str_subclass_enum_reduces_to_str():
    """Validates behavior for str subclass enum reduces to str.
    """
...
def test_int_subclass_enum_reduces_to_int():
    """Validates behavior for int subclass enum reduces to int.
    """
...
def test_plain_enum_reduces_to_underlying_value():
    """Validates behavior for plain enum reduces to underlying value.
    """
...
def test_enum_inside_dict_is_coerced():
    """Validates behavior for enum inside dict is coerced.
    """
...
def test_enum_inside_list_is_coerced():
    """Validates behavior for enum inside list is coerced.
    """
