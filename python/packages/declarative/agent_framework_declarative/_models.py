"""This module defines functionality for packages/declarative/agent_framework_declarative/_models.
...
class PropertySchema(SerializationMixin):
    ...
    def __init__(
        ...
        Args:
            self: Description of self.
            examples: Description of examples.
...
class Connection(SerializationMixin):
    ...
    def __init__(
        ...
        Args:
            self: Description of self.
            kind: Description of kind.
            authenticationMode: Description of authenticationMode.
            usageDescription: Description of usageDescription.
        """
        self.kind = kind
...
class ModelOptions(SerializationMixin):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            self: Description of self.
            frequencyPenalty: Description of frequencyPenalty.
            maxOutputTokens: Description of maxOutputTokens.
            presencePenalty: Description of presencePenalty.
            seed: Description of seed.
            temperature: Description of temperature.
            topK: Description of topK.
            topP: Description of topP.
            stopSequences: Description of stopSequences.
            allowMultipleToolCalls: Description of allowMultipleToolCalls.
            additionalProperties: Description of additionalProperties.
...
class Model(SerializationMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            apiType: Description of apiType.
...
class AgentDefinition(SerializationMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            kind: Description of kind.
            name: Description of name.
            displayName: Description of displayName.
            description: Description of description.
...
class Tool(SerializationMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            kind: Description of kind.
            description: Description of description.
            bindings: Description of bindings.
        """
        self.name = _try_powerfx_eval(name)
        self.kind = _try_powerfx_eval(kind)
        self.description = _try_powerfx_eval(description)
...
class FileSearchTool(Tool):
    ...
    def __init__(
        ...
        Args:
            ...
            bindings: Description of bindings.
            connection: Description of connection.
            vectorStoreIds: Description of vectorStoreIds.
            maximumResultCount: Description of maximumResultCount.
            ranker: Description of ranker.
            scoreThreshold: Description of scoreThreshold.
...
class McpServerToolSpecifyApprovalMode(McpServerApprovalMode):
    ...
    def __init__(
        ...
        Args:
            self: Description of self.
            kind: Description of kind.
            alwaysRequireApprovalTools: Description of alwaysRequireApprovalTools.
            neverRequireApprovalTools: Description of neverRequireApprovalTools.
        """
        super().__init__(kind=kind)
...
class McpTool(Tool):
    ...
    def __init__(
        ...
        Args:
            ...
            bindings: Description of bindings.
            connection: Description of connection.
            serverName: Description of serverName.
            serverDescription: Description of serverDescription.
            approvalMode: Description of approvalMode.
            allowedTools: Description of allowedTools.
...
class CodeInterpreterTool(Tool):
    ...
    def __init__(
        ...
        Args:
            ...
            description: Description of description.
            bindings: Description of bindings.
            fileIds: Description of fileIds.
        """
        super().__init__(
            name=name,
            kind=kind,
...
class PromptAgent(AgentDefinition):
    ...
    def __init__(
        ...
        Args:
            ...
            template: Description of template.
            instructions: Description of instructions.
            additionalInstructions: Description of additionalInstructions.
        """
        super().__init__(
            kind=kind,
            name=name,
