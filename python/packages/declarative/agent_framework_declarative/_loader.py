"""This module defines functionality for packages/declarative/agent_framework_declarative/_loader.
...
class ProviderTypeMapping(TypedDict, total=True):
    """Represents the ProviderTypeMapping type and related behavior.
    """
    package: str
    name: str
    model_field: str
