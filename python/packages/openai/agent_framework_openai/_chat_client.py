"""This module defines functionality for packages/openai/agent_framework_openai/_chat_client.
...
class _PromptCacheOptions(TypedDict, total=False):
    """Represents the _PromptCacheOptions type and related behavior.
    """
...
class RawOpenAIChatClient(
        ...
        **kwargs: Any,
        ...
        if stream:
            ...
            def _finalize_with_captured_format(updates: Sequence[ChatResponseUpdate]) -> ChatResponse[Any]:
                ...
                """Implements  finalize with captured format.
    ...
    def _parse_chunk_from_openai(
        ...
        def output_text_properties(output: Any) -> dict[str, Any] | None:
            """Implements output text properties.
    ...
    def _parse_usage_from_openai(self, usage: ResponseUsage) -> UsageDetails | None:
        """Implements  parse usage from openai.
