"""This module defines functionality for packages/openai/tests/openai/test_openai_chat_completion_client.
...
def test_get_response_docstring_surfaces_layered_runtime_docs() -> None:
    """Validates behavior for get response docstring surfaces layered runtime docs.
    """
...
def test_get_response_is_defined_on_openai_class() -> None:
    """Validates behavior for get response is defined on openai class.
    """
...
def test_agent_accepts_openai_chat_completion_clients() -> None:
    """Validates behavior for agent accepts openai chat completion clients.
    """
...
def test_supports_web_search_only() -> None:
    """Validates behavior for supports web search only.
    """
...
def test_init_base_url(openai_unit_test_env: dict[str, str]) -> None:
    # Test successful initialization
    """Validates behavior for init base url.
...
def test_unsupported_tool_handling(openai_unit_test_env: dict[str, str]) -> None:
    ...
    class UnsupportedTool:
        """Represents the UnsupportedTool type and related behavior.
        """
        pass
...
def test_prepare_message_for_openai_omits_unsupported_content() -> None:
    """Validates behavior for prepare message for openai omits unsupported content.
    """
    client = OpenAIChatCompletionClient(model="test-model", api_key="test-key")
...
def test_prepare_message_with_unprotected_text_reasoning_content(
    ...
    """Validates behavior for prepare message with unprotected text reasoning content.
...
def test_mixed_approval_resume_roles_serialize_function_result_as_tool(
    ...
    """Validates behavior for mixed approval resume roles serialize function result as tool.
...
def test_streaming_chunk_with_refusal(openai_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for streaming chunk with refusal.
...
def test_parse_text_and_refusal_preserves_both(openai_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for parse text and refusal preserves both.
...
def test_prepare_marked_refusal_uses_native_assistant_field_and_text_fallback(
    ...
    """Validates behavior for prepare marked refusal uses native assistant field and text fallback.
...
def test_prepare_mixed_text_and_refusal_uses_one_assistant_message(
    ...
    """Validates behavior for prepare mixed text and refusal uses one assistant message.
...
def test_prepare_text_refusal_text_uses_one_assistant_message(
    ...
    """Validates behavior for prepare text refusal text uses one assistant message.
...
async def test_streaming_feature_is_marked_when_request_is_sent(
    ...
    """Validates behavior for streaming feature is marked when request is sent.
...
def test_streaming_tool_call_preserves_choice_local_index_scope(
    ...
    """Validates behavior for streaming tool call preserves choice local index scope.
...
async def test_streaming_tool_call_identity_is_request_local_and_scoped_by_choice_index(
    ...
    """Validates behavior for streaming tool call identity is request local and scoped by choice index.
...
async def test_streaming_tool_call_adopts_late_provider_id_without_changing_occurrence(
    ...
    """Validates behavior for streaming tool call adopts late provider id without changing occurrence.
...
def _make_chat_completion(message: ChatCompletionMessage, model: str = "vllm-model") -> ChatCompletion:
    """Implements  make chat completion.
