"""This module defines functionality for packages/openai/tests/openai/test_openai_chat_completion_client_azure.
...
def test_init_does_not_fall_back_to_openai_chat_model_for_azure_env(
    ...
    """Validates behavior for init does not fall back to openai chat model for azure env.
...
async def test_azure_openai_chat_completion_client_response() -> None:
    """Validates behavior for azure openai chat completion client response.
    """
...
async def test_azure_openai_chat_completion_client_response_tools() -> None:
    """Validates behavior for azure openai chat completion client response tools.
    """
    async with AzureCliCredential() as credential:
        client = OpenAIChatCompletionClient(credential=cast(Any, credential))
...
async def test_azure_openai_chat_completion_client_streaming() -> None:
    """Validates behavior for azure openai chat completion client streaming.
    """
    async with AzureCliCredential() as credential:
        client = OpenAIChatCompletionClient(credential=cast(Any, credential))
...
async def test_azure_openai_chat_completion_client_streaming_tools() -> None:
    """Validates behavior for azure openai chat completion client streaming tools.
    """
    async with AzureCliCredential() as credential:
        client = OpenAIChatCompletionClient(credential=cast(Any, credential))
...
async def test_azure_openai_chat_completion_client_agent_basic_run() -> None:
    """Validates behavior for azure openai chat completion client agent basic run.
    """
    async with (
...
async def test_azure_openai_chat_completion_client_agent_basic_run_streaming() -> None:
    """Validates behavior for azure openai chat completion client agent basic run streaming.
    """
    async with (
        AzureCliCredential() as credential,
...
async def test_azure_openai_chat_completion_client_agent_session_persistence() -> None:
    """Validates behavior for azure openai chat completion client agent session persistence.
    """
    async with (
        AzureCliCredential() as credential,
        Agent(
...
async def test_azure_openai_chat_completion_client_agent_existing_session() -> None:
    """Validates behavior for azure openai chat completion client agent existing session.
    """
    async with AzureCliCredential() as credential:
...
async def test_azure_chat_completion_client_agent_level_tool_persistence() -> None:
    """Validates behavior for azure chat completion client agent level tool persistence.
    """
    async with (
        AzureCliCredential() as credential,
        Agent(
