"""This module defines functionality for packages/openai/tests/openai/test_openai_embedding_client_azure.
...
def _get_azure_embedding_deployment_name() -> str:
    """Implements  get azure embedding deployment name.
...
def _create_azure_embedding_client(
    *,
    ...
    """Implements  create azure embedding client.
    
    Args:
        api_key: Description of api_key.
...
def test_init_auto_detects_azure_embedding_env(azure_openai_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for init auto detects azure embedding env.
...
def test_init_does_not_fall_back_to_openai_embedding_model_for_azure_env(
    ...
    """Validates behavior for init does not fall back to openai embedding model for azure env.
...
def test_init_with_openai_v1_base_url_and_credential_uses_openai_client(monkeypatch) -> None:
    """Validates behavior for init with openai v1 base url and credential uses openai client.
...
def test_init_with_openai_v1_base_url_and_api_key_uses_openai_client(monkeypatch) -> None:
    """Validates behavior for init with openai v1 base url and api key uses openai client.
...
def test_init_with_azure_endpoint_still_uses_azure_client(azure_openai_unit_test_env: dict[str, str]) -> None:
    """Validates behavior for init with azure endpoint still uses azure client.
...
async def test_azure_openai_get_embeddings() -> None:
    """Validates behavior for azure openai get embeddings.
    """
...
async def test_azure_openai_get_embeddings_multiple() -> None:
    """Validates behavior for azure openai get embeddings multiple.
    """
    async with AzureCliCredential() as credential:
        client = _create_azure_embedding_client(credential=cast(Any, credential))
...
async def test_azure_openai_get_embeddings_with_dimensions() -> None:
    """Validates behavior for azure openai get embeddings with dimensions.
    """
    async with AzureCliCredential() as credential:
        client = _create_azure_embedding_client(credential=cast(Any, credential))
