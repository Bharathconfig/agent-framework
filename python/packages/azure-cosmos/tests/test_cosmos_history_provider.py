"""This module defines functionality for packages/azure-cosmos/tests/test_cosmos_history_provider.
...
async def test_save_messages_marks_azure_cosmos_used_before_empty_return() -> None:
    """Validates behavior for save messages marks azure cosmos used before empty return.
    """
...
def mock_cosmos_client(mock_container: MagicMock) -> MagicMock:
    """Implements mock cosmos client.
    
    Args:
        mock_container: Description of mock_container.
...
class TestCosmosHistoryProviderInit:
    """Represents the TestCosmosHistoryProviderInit type and related behavior.
    """
    def test_uses_provided_container_client(self, mock_container: MagicMock) -> None:
        """Validates behavior for uses provided container client.
    ...
    def test_uses_provided_cosmos_client(self, mock_cosmos_client: MagicMock) -> None:
        """Validates behavior for uses provided cosmos client.
        
        Args:
            self: Description of self.
            mock_cosmos_client: Description of mock_cosmos_client.
        """
    ...
    def test_missing_required_settings_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
        """Validates behavior for missing required settings raises.
    ...
    def test_constructs_client_with_string_credential(
        ...
        """Validates behavior for constructs client with string credential.
...
class TestCosmosHistoryProviderContainerConfig:
    """Represents the TestCosmosHistoryProviderContainerConfig type and related behavior.
    """
    async def test_provider_container_name_is_used(self, mock_cosmos_client: MagicMock) -> None:
        """Validates behavior for provider container name is used.
...
class TestCosmosHistoryProviderGetMessages:
    """Represents the TestCosmosHistoryProviderGetMessages type and related behavior.
    """
    ...
    async def test_none_session_id_generates_guid_partition_key(
        ...
        """Validates behavior for none session id generates guid partition key.
    ...
    async def test_skips_non_dict_message_payload(self, mock_container: MagicMock) -> None:
        """Validates behavior for skips non dict message payload.
...
class TestCosmosHistoryProviderListSessions:
    """Represents the TestCosmosHistoryProviderListSessions type and related behavior.
    """
    async def test_list_sessions_returns_unique_sorted_ids(self, mock_container: MagicMock) -> None:
        """Validates behavior for list sessions returns unique sorted ids.
...
class TestCosmosHistoryProviderSaveMessages:
    """Represents the TestCosmosHistoryProviderSaveMessages type and related behavior.
    """
    async def test_saves_messages(self, mock_container: MagicMock) -> None:
        """Validates behavior for saves messages.
    ...
    async def test_batches_when_message_count_exceeds_limit(self, mock_container: MagicMock) -> None:
        """Validates behavior for batches when message count exceeds limit.
...
class TestCosmosHistoryProviderClear:
    """Represents the TestCosmosHistoryProviderClear type and related behavior.
    """
    async def test_clear_deletes_all_session_items(self, mock_container: MagicMock) -> None:
        """Validates behavior for clear deletes all session items.
...
class TestCosmosHistoryProviderBeforeAfterRun:
    """Represents the TestCosmosHistoryProviderBeforeAfterRun type and related behavior.
    """
...
class TestCosmosHistoryProviderClose:
    """Represents the TestCosmosHistoryProviderClose type and related behavior.
    """
    async def test_close_closes_owned_client(
        self, monkeypatch: pytest.MonkeyPatch, mock_cosmos_client: MagicMock
    ) -> None:
        """Validates behavior for close closes owned client.
    ...
    async def test_close_does_not_close_external_client(self, mock_cosmos_client: MagicMock) -> None:
        """Validates behavior for close does not close external client.
    ...
    async def test_async_context_manager_closes_owned_client(
        ...
        """Validates behavior for async context manager closes owned client.
    ...
    async def test_async_context_manager_preserves_original_exception(self, mock_container: MagicMock) -> None:
        """Validates behavior for async context manager preserves original exception.
...
async def test_cosmos_history_provider_roundtrip_with_emulator() -> None:
    """Validates behavior for cosmos history provider roundtrip with emulator.
    """
