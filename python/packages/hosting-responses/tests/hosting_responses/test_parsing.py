...
def _native_usage_payload() -> dict[str, object]:
    """Implements  native usage payload.
...
class TestMessagesFromResponsesInput:
    """Represents the TestMessagesFromResponsesInput type and related behavior.
    """
    def test_string_input_becomes_single_user_message(self) -> None:
        """Validates behavior for string input becomes single user message.
    ...
    def test_input_text_items_collapse_into_one_user_message(self) -> None:
        """Validates behavior for input text items collapse into one user message.
    ...
    def test_text_items_require_non_empty_string_text(self, text: object) -> None:
        """Validates behavior for text items require non empty string text.
    ...
    def test_message_envelope_with_string_content(self) -> None:
        """Validates behavior for message envelope with string content.
    ...
    def test_message_envelope_with_content_parts(self) -> None:
        """Validates behavior for message envelope with content parts.
    ...
    def test_message_envelope_marks_refusal_text(self) -> None:
        """Validates behavior for message envelope marks refusal text.
    ...
    def test_message_envelope_rejects_non_object_content_item(self) -> None:
        """Validates behavior for message envelope rejects non object content item.
    ...
    def test_message_envelope_rejects_invalid_content_shape(self) -> None:
        """Validates behavior for message envelope rejects invalid content shape.
    ...
    def test_message_envelope_requires_supported_role(self, role: object) -> None:
        """Validates behavior for message envelope requires supported role.
    ...
    def test_message_envelope_requires_non_empty_content(self, item: dict[str, object]) -> None:
        """Validates behavior for message envelope requires non empty content.
    ...
    def test_input_file_via_url(self) -> None:
        """Validates behavior for input file via url.
    ...
    def test_input_file_via_file_id(self) -> None:
        """Validates behavior for input file via file id.
    ...
    def test_input_file_missing_anchor_raises(self) -> None:
        """Validates behavior for input file missing anchor raises.
    ...
    def test_pending_text_flushes_before_message_envelope(self) -> None:
        """Validates behavior for pending text flushes before message envelope.
    ...
    def test_image_url_via_string(self) -> None:
        """Validates behavior for image url via string.
    ...
    def test_image_url_via_object(self) -> None:
        """Validates behavior for image url via object.
    ...
    def test_unknown_input_type_raises(self) -> None:
        """Validates behavior for unknown input type raises.
    ...
    def test_empty_list_raises(self) -> None:
        """Validates behavior for empty list raises.
    ...
    def test_empty_string_raises(self) -> None:
        """Validates behavior for empty string raises.
    ...
    def test_non_string_non_list_raises(self) -> None:
        """Validates behavior for non string non list raises.
    ...
    def test_image_url_missing_raises(self) -> None:
        """Validates behavior for image url missing raises.
...
class TestResponsesRunHelpers:
    """Represents the TestResponsesRunHelpers type and related behavior.
    """
    def test_create_conversation_id_shape(self) -> None:
        """Validates behavior for create conversation id shape.
    ...
    def test_create_response_id_shape(self) -> None:
        """Validates behavior for create response id shape.
    ...
    def test_responses_session_id_valid_ids_do_not_warn(self) -> None:
        """Validates behavior for responses session id valid ids do not warn.
    ...
    def test_responses_session_id_warns_for_nonstandard_previous_response_id(self) -> None:
        """Validates behavior for responses session id warns for nonstandard previous response id.
    ...
    def test_responses_session_id_warns_for_nonstandard_conversation(self) -> None:
        """Validates behavior for responses session id warns for nonstandard conversation.
    ...
    def test_responses_session_id_accepts_deprecated_conversation_id_alone(self) -> None:
        """Validates behavior for responses session id accepts deprecated conversation id alone.
    ...
    def test_responses_session_id_rejects_conflicting_continuation_mechanisms(
        ...
        """Validates behavior for responses session id rejects conflicting continuation mechanisms.
    ...
    def test_responses_session_id_rejects_invalid_continuation_values(self, body: dict[str, object]) -> None:
        """Validates behavior for responses session id rejects invalid continuation values.
    ...
    def test_responses_session_id_returns_none_when_absent(self) -> None:
        """Validates behavior for responses session id returns none when absent.
    ...
    def test_responses_to_run_returns_messages_options_and_stream(self) -> None:
        """Validates behavior for responses to run returns messages options and stream.
    ...
    def test_responses_to_run_rejects_conflicting_continuation_mechanisms(self) -> None:
        """Validates behavior for responses to run rejects conflicting continuation mechanisms.
    ...
    def test_responses_from_run_returns_response_payload(self) -> None:
        """Validates behavior for responses from run returns response payload.
    ...
    def test_responses_from_run_reconstructs_refusal_content_from_marked_text(self) -> None:
        """Validates behavior for responses from run reconstructs refusal content from marked text.
    ...
    def test_responses_from_run_preserves_message_boundaries(self) -> None:
        """Validates behavior for responses from run preserves message boundaries.
    ...
    def test_responses_from_run_rejects_non_assistant_message_role(self) -> None:
        """Validates behavior for responses from run rejects non assistant message role.
    ...
    def test_responses_from_run_preserves_tool_role_function_result(self) -> None:
        """Validates behavior for responses from run preserves tool role function result.
    ...
    def test_responses_from_run_rejects_standalone_media(self) -> None:
        """Validates behavior for responses from run rejects standalone media.
    ...
    def test_responses_from_run_preserves_multimodal_output_items(self) -> None:
        """Validates behavior for responses from run preserves multimodal output items.
    ...
    def test_responses_from_run_preserves_status_metadata_and_usage(self) -> None:
        """Validates behavior for responses from run preserves status metadata and usage.
    ...
    def test_responses_from_run_uses_raw_response_fields_as_fallback(self) -> None:
        """Validates behavior for responses from run uses raw response fields as fallback.
    ...
    def test_responses_from_run_prefers_valid_raw_usage_without_merging_af_counts(self) -> None:
        """Validates behavior for responses from run prefers valid raw usage without merging af counts.
    ...
    def test_responses_from_run_falls_back_to_complete_af_usage_when_raw_usage_is_invalid(self) -> None:
        """Validates behavior for responses from run falls back to complete af usage when raw usage is invalid.
    ...
    def test_responses_from_run_omits_invalid_raw_and_partial_af_usage(self) -> None:
        """Validates behavior for responses from run omits invalid raw and partial af usage.
    ...
    def test_responses_from_run_does_not_treat_lookalike_raw_usage_as_responses_usage(self) -> None:
        """Validates behavior for responses from run does not treat lookalike raw usage as responses usage.
    ...
    def test_responses_from_run_does_not_treat_user_metadata_status_as_transport_status(self) -> None:
        """Validates behavior for responses from run does not treat user metadata status as transport status.
    ...
    def test_responses_from_run_rejects_invalid_metadata(self) -> None:
        """Validates behavior for responses from run rejects invalid metadata.
    ...
    def test_responses_from_run_maps_complete_usage_without_cross_filling(
        ...
        """Validates behavior for responses from run maps complete usage without cross filling.
        
        Args:
            self: Description of self.
            usage_details: Description of usage_details.
            expected_usage: Description of expected_usage.
        """
        result = AgentResponse(
            messages=Message(role="assistant", contents=[Content.from_text("hello")]),
    ...
    def test_responses_from_run_omits_partial_usage(
        ...
        """Validates behavior for responses from run omits partial usage.
    ...
    def test_responses_from_run_uses_installed_sdk_usage_detail_schema(self) -> None:
        """Validates behavior for responses from run uses installed sdk usage detail schema.
    ...
    def test_responses_from_run_omits_usage_that_cannot_map_consistently(
        ...
        """Validates behavior for responses from run omits usage that cannot map consistently.
    ...
    def test_responses_from_run_rejects_invalid_usage_count(self, key: str, count: object) -> None:
        """Validates behavior for responses from run rejects invalid usage count.
    ...
    def test_responses_from_run_maps_conversation_id(self) -> None:
        """Validates behavior for responses from run maps conversation id.
    ...
    def test_responses_from_run_omits_conversation_when_absent(self) -> None:
        """Validates behavior for responses from run omits conversation when absent.
    ...
    async def test_responses_from_streaming_run(self) -> None:
        """Validates behavior for responses from streaming run.
    ...
    async def test_responses_from_streaming_run_preserves_marked_refusal_deltas(self) -> None:
        """Validates behavior for responses from streaming run preserves marked refusal deltas.
    ...
    async def test_responses_from_streaming_run_preserves_mixed_text_and_refusal_parts(self) -> None:
        """Validates behavior for responses from streaming run preserves mixed text and refusal parts.
    ...
    async def test_streaming_message_reserves_preceding_function_call_index(
        ...
        """Validates behavior for streaming message reserves preceding function call index.
        
        Args:
            self: Description of self.
            text_content: Description of text_content.
            expected_part_type: Description of expected_part_type.
        """
        async def updates() -> AsyncIterator[AgentResponseUpdate]:
            """Implements updates.
            """
    ...
    async def test_streaming_text_function_refusal_uses_final_output_indexes(self) -> None:
        """Validates behavior for streaming text function refusal uses final output indexes.
    ...
    async def test_streaming_paired_mcp_output_reserves_one_index_before_refusal(self) -> None:
        """Validates behavior for streaming paired mcp output reserves one index before refusal.
    ...
    async def test_streaming_output_index_projection_work_is_linear(
        ...
        """Validates behavior for streaming output index projection work is linear.
        ...
        def tracking_result_to_output_items(result: object, *, status: str) -> Any:
            """Implements tracking result to output items.
    ...
    async def test_empty_text_annotation_does_not_split_streaming_message(self) -> None:
        """Validates behavior for empty text annotation does not split streaming message.
    ...
    async def test_empty_annotation_in_new_message_keeps_terminal_output_indexes(self) -> None:
        """Validates behavior for empty annotation in new message keeps terminal output indexes.
    ...
    async def test_repeated_code_interpreter_chunk_does_not_reserve_new_output_index(self) -> None:
        """Validates behavior for repeated code interpreter chunk does not reserve new output index.
    ...
    async def test_responses_from_streaming_run_emits_failed_when_iteration_raises(self) -> None:
        """Validates behavior for responses from streaming run emits failed when iteration raises.
    ...
    async def test_failed_stream_preserves_partial_marked_refusal(self) -> None:
        """Validates behavior for failed stream preserves partial marked refusal.
    ...
    async def test_responses_from_streaming_run_preserves_final_metadata_and_usage(self) -> None:
        """Validates behavior for responses from streaming run preserves final metadata and usage.
    ...
    async def test_responses_from_streaming_run_emits_matching_terminal_event(self, status: str) -> None:
        """Validates behavior for responses from streaming run emits matching terminal event.
    ...
    async def test_responses_from_streaming_run_preserves_failed_transport_error(self) -> None:
        """Validates behavior for responses from streaming run preserves failed transport error.
    ...
    async def test_responses_from_streaming_run_rejects_nonterminal_final_status(self, status: str) -> None:
        """Validates behavior for responses from streaming run rejects nonterminal final status.
    ...
    async def test_responses_from_streaming_run_emits_failed_when_finalizer_raises(self) -> None:
        """Validates behavior for responses from streaming run emits failed when finalizer raises.
