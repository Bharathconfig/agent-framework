"""This module defines functionality for packages/hosting-mcp/tests/hosting_mcp/test_workflow_tool.
...
async def test_workflow_tool_derives_object_schema_and_runs_workflow() -> None:
    """Validates behavior for workflow tool derives object schema and runs workflow.
    """
...
async def test_workflow_tool_wraps_primitive_input() -> None:
    """Validates behavior for workflow tool wraps primitive input.
    """
...
async def test_workflow_tool_serializes_structured_output_as_json_text() -> None:
    """Validates behavior for workflow tool serializes structured output as json text.
    """
...
def test_workflow_tool_rejects_unhandled_external_input_requests() -> None:
    """Validates behavior for workflow tool rejects unhandled external input requests.
    """
...
def test_workflow_tool_rejects_multiple_start_input_types() -> None:
    """Validates behavior for workflow tool rejects multiple start input types.
    """
