"""This module defines functionality for packages/azure-ai-search/tests/test_aisearch_context_provider.
...
async def test_before_run_marks_azure_ai_search_used() -> None:
    """Validates behavior for before run marks azure ai search used.
    """
...
class _StubReasoningEffort:
    """Represents the _StubReasoningEffort type and related behavior.
    """
    def __init__(self, *args: object, **kwargs: object) -> None: ...


class _StubOutputMode:
    """Represents the _StubOutputMode type and related behavior.
    """
...
class TestInitSemantic:
    ...
    def test_valid_init(self) -> None:
        """Validates behavior for valid init.
    ...
    def test_source_id_set(self) -> None:
        """Validates behavior for source id set.
    ...
    def test_missing_endpoint_raises(self) -> None:
        """Validates behavior for missing endpoint raises.
    ...
    def test_missing_index_name_semantic_raises(self) -> None:
        """Validates behavior for missing index name semantic raises.
    ...
    def test_env_variable_fallback(self) -> None:
        """Validates behavior for env variable fallback.
    ...
    def test_top_k_and_semantic_config(self) -> None:
        """Validates behavior for top k and semantic config.
    ...
    def test_default_context_prompt(self) -> None:
        """Validates behavior for default context prompt.
    ...
    def test_custom_context_prompt(self) -> None:
        """Validates behavior for custom context prompt.
    ...
    def test_model_explicit(self) -> None:
        """Validates behavior for model explicit.
...
class TestInitCredentialResolution:
    ...
    def test_token_credential_used(self) -> None:
        """Validates behavior for token credential used.
    ...
    def test_azure_key_credential_passed_through(self) -> None:
        """Validates behavior for azure key credential passed through.
    ...
    def test_no_credential_raises(self) -> None:
        """Validates behavior for no credential raises.
...
class TestInitAgenticValidation:
    ...
    def test_both_index_and_kb_raises(self) -> None:
        """Validates behavior for both index and kb raises.
    ...
    def test_neither_index_nor_kb_raises(self) -> None:
        """Validates behavior for neither index nor kb raises.
    ...
    def test_missing_model_raises(self) -> None:
        """Validates behavior for missing model raises.
    ...
    def test_vector_field_without_embedding_raises(self) -> None:
        """Validates behavior for vector field without embedding raises.
    ...
    def test_agentic_missing_aoai_url_with_index_raises(self) -> None:
        """Validates behavior for agentic missing aoai url with index raises.
    ...
    def test_agentic_with_kb_name_sets_use_existing(self) -> None:
        """Validates behavior for agentic with kb name sets use existing.
    ...
    def test_agentic_with_index_generates_kb_name(self) -> None:
        """Validates behavior for agentic with index generates kb name.
    ...
    def test_invalid_query_source_credential_raises_before_client_construction(self) -> None:
        """Validates behavior for invalid query source credential raises before client construction.
    ...
    def test_agentic_explicit_kb_ignores_env_index_name(self) -> None:
        """Validates behavior for agentic explicit kb ignores env index name.
    ...
    def test_agentic_explicit_index_ignores_env_kb_name(self) -> None:
        """Validates behavior for agentic explicit index ignores env kb name.
...
class TestClientConstruction:
    ...
    def test_common_client_kwargs_has_no_api_version(self) -> None:
        """Validates behavior for common client kwargs has no api version.
    ...
    def test_search_client_built_without_api_version(self) -> None:
        """Validates behavior for search client built without api version.
    ...
    def test_index_client_built_without_api_version_agentic(self) -> None:
        """Validates behavior for index client built without api version agentic.
...
class TestPreviewFeatureGating:
    ...
    def _agentic(
        ...
        *,
        ...
        Args:
            self: Description of self.
            knowledge_base_output_mode: Description of knowledge_base_output_mode.
            retrieval_reasoning_effort: Description of retrieval_reasoning_effort.
    ...
    def test_answer_synthesis_rejected_without_preview_sdk(self) -> None:
        """Validates behavior for answer synthesis rejected without preview sdk.
    ...
    def test_medium_effort_rejected_without_preview_sdk(self) -> None:
        """Validates behavior for medium effort rejected without preview sdk.
    ...
    def test_low_effort_rejected_without_preview_sdk(self) -> None:
        """Validates behavior for low effort rejected without preview sdk.
    ...
    def test_defaults_allowed_without_preview_sdk(self) -> None:
        """Validates behavior for defaults allowed without preview sdk.
    ...
    def test_preview_options_allowed_with_preview_sdk(self) -> None:
        """Validates behavior for preview options allowed with preview sdk.
    ...
    async def test_kb_creation_omits_preview_fields_on_stable_sdk(self) -> None:
        """Validates behavior for kb creation omits preview fields on stable sdk.
...
class TestAsyncContextManager:
    ...
    async def test_aenter_returns_self(self) -> None:
        """Validates behavior for aenter returns self.
    ...
    async def test_closes_retrieval_client(self) -> None:
        """Validates behavior for closes retrieval client.
    ...
    async def test_no_retrieval_client_no_error(self) -> None:
        """Validates behavior for no retrieval client no error.
...
class TestBeforeRunSemantic:
    ...
    async def test_results_added_to_context(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for results added to context.
        
        Args:
            self: Description of self.
            mock_search_client: Description of mock_search_client.
        """
        provider = _make_provider()
    ...
    async def test_empty_input_no_search(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for empty input no search.
    ...
    async def test_no_results_no_messages(self, mock_search_client_empty: AsyncMock) -> None:
        """Validates behavior for no results no messages.
        
        Args:
            self: Description of self.
            mock_search_client_empty: Description of mock_search_client_empty.
        """
        provider = _make_provider()
    ...
    async def test_context_prompt_prepended(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for context prompt prepended.
...
class TestBeforeRunFiltering:
    ...
    async def test_filters_non_user_assistant(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for filters non user assistant.
    ...
    async def test_only_system_messages_no_search(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for only system messages no search.
    ...
    async def test_whitespace_only_messages_filtered(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for whitespace only messages filtered.
    ...
    async def test_assistant_messages_included(self, mock_search_client: AsyncMock) -> None:
        """Validates behavior for assistant messages included.
...
class TestFindVectorFields:
    ...
    def test_finds_fields_with_dimensions(self) -> None:
        """Validates behavior for finds fields with dimensions.
    ...
    def test_returns_empty_for_no_vector_fields(self) -> None:
        """Validates behavior for returns empty for no vector fields.
    ...
    def test_multiple_vector_fields(self) -> None:
        """Validates behavior for multiple vector fields.
...
class TestFindVectorizableFields:
    ...
    def test_finds_vectorizable_fields(self) -> None:
        """Validates behavior for finds vectorizable fields.
    ...
    def test_returns_empty_when_no_vector_search(self) -> None:
        """Validates behavior for returns empty when no vector search.
    ...
    def test_returns_empty_when_no_profiles(self) -> None:
        """Validates behavior for returns empty when no profiles.
    ...
    def test_field_not_in_vector_fields_excluded(self) -> None:
        """Validates behavior for field not in vector fields excluded.
    ...
    def test_profile_without_vectorizer_not_included(self) -> None:
        """Validates behavior for profile without vectorizer not included.
    ...
    def test_field_without_profile_name_excluded(self) -> None:
        """Validates behavior for field without profile name excluded.
...
class TestAutoDiscoverVectorField:
    ...
    async def test_skip_if_already_discovered(self) -> None:
        """Validates behavior for skip if already discovered.
    ...
    async def test_skip_if_vector_field_set(self) -> None:
        """Validates behavior for skip if vector field set.
    ...
    async def test_no_index_name_warns(self) -> None:
        """Validates behavior for no index name warns.
    ...
    async def test_no_vector_fields_sets_flag(self) -> None:
        """Validates behavior for no vector fields sets flag.
    ...
    async def test_single_vectorizable_field_discovered(self) -> None:
        """Validates behavior for single vectorizable field discovered.
    ...
    async def test_multiple_vectorizable_fields_warns(self) -> None:
        """Validates behavior for multiple vectorizable fields warns.
    ...
    async def test_single_vector_field_without_embedding_clears_field(self) -> None:
        """Validates behavior for single vector field without embedding clears field.
    ...
    async def test_single_vector_field_with_embedding_function(self) -> None:
        """Validates behavior for single vector field with embedding function.
    ...
    async def test_multiple_vector_fields_no_vectorizable_warns(self) -> None:
        """Validates behavior for multiple vector fields no vectorizable warns.
    ...
    async def test_exception_falls_back_to_keyword_search(self) -> None:
        """Validates behavior for exception falls back to keyword search.
    ...
    async def test_creates_index_client_if_none(self) -> None:
        """Validates behavior for creates index client if none.
...
class TestSemanticSearch:
    ...
    async def test_basic_keyword_search(self) -> None:
        """Validates behavior for basic keyword search.
    ...
    async def test_vectorizable_text_query(self) -> None:
        """Validates behavior for vectorizable text query.
    ...
    async def test_vectorized_query_with_embedding_function(self) -> None:
        """Validates behavior for vectorized query with embedding function.
    ...
    async def test_semantic_configuration_params(self) -> None:
        """Validates behavior for semantic configuration params.
    ...
    async def test_vector_k_with_semantic_config(self) -> None:
        """Validates behavior for vector k with semantic config.
    ...
    async def test_no_search_client_raises(self) -> None:
        """Validates behavior for no search client raises.
    ...
    async def test_empty_results_returns_empty_list(self) -> None:
        """Validates behavior for empty results returns empty list.
    ...
    async def test_doc_without_text_excluded(self) -> None:
        """Validates behavior for doc without text excluded.
...
class TestExtractDocumentText:
    ...
    def test_content_field_extracted(self) -> None:
        """Validates behavior for content field extracted.
    ...
    def test_text_field_extracted(self) -> None:
        """Validates behavior for text field extracted.
    ...
    def test_description_field_extracted(self) -> None:
        """Validates behavior for description field extracted.
    ...
    def test_body_field_extracted(self) -> None:
        """Validates behavior for body field extracted.
    ...
    def test_chunk_field_extracted(self) -> None:
        """Validates behavior for chunk field extracted.
    ...
    def test_content_field_priority(self) -> None:
        """Validates behavior for content field priority.
    ...
    def test_fallback_to_string_fields(self) -> None:
        """Validates behavior for fallback to string fields.
    ...
    def test_empty_doc_returns_empty(self) -> None:
        """Validates behavior for empty doc returns empty.
    ...
    def test_no_doc_id_returns_text_only(self) -> None:
        """Validates behavior for no doc id returns text only.
    ...
    def test_only_id_and_metadata_returns_empty(self) -> None:
        """Validates behavior for only id and metadata returns empty.
    ...
    def test_non_string_values_excluded_from_fallback(self) -> None:
        """Validates behavior for non string values excluded from fallback.
...
class TestEnsureKnowledgeBase:
    ...
    async def test_already_initialized_returns_early(self) -> None:
        """Validates behavior for already initialized returns early.
    ...
    async def test_missing_kb_name_raises(self) -> None:
        """Validates behavior for missing kb name raises.
    ...
    async def test_existing_kb_sets_initialized(self) -> None:
        """Validates behavior for existing kb sets initialized.
    ...
    async def test_close_then_existing_kb_reuse_clears_source_params(self) -> None:
        """Validates behavior for close then existing kb reuse clears source params.
    ...
    async def test_missing_index_client_raises(self) -> None:
        """Validates behavior for missing index client raises.
    ...
    async def test_missing_aoai_url_raises(self) -> None:
        """Validates behavior for missing aoai url raises.
    ...
    async def test_missing_deployment_name_raises(self) -> None:
        """Validates behavior for missing deployment name raises.
    ...
    async def test_missing_index_name_raises(self) -> None:
        """Validates behavior for missing index name raises.
    ...
    async def test_creates_knowledge_source_when_not_found(self) -> None:
        """Validates behavior for creates knowledge source when not found.
    ...
    async def test_uses_existing_knowledge_source(self) -> None:
        """Validates behavior for uses existing knowledge source.
    ...
    async def test_answer_synthesis_output_mode(self) -> None:
        """Validates behavior for answer synthesis output mode.
    ...
    async def test_medium_reasoning_effort(self) -> None:
        """Validates behavior for medium reasoning effort.
...
class TestAgenticSearch:
    ...
    async def test_no_retrieval_client_raises(self) -> None:
        """Validates behavior for no retrieval client raises.
    ...
    async def test_minimal_reasoning_returns_results(self) -> None:
        """Validates behavior for minimal reasoning returns results.
    ...
    async def test_non_minimal_reasoning_uses_messages(self) -> None:
        """Validates behavior for non minimal reasoning uses messages.
    ...
    async def test_no_response_returns_default_message(self) -> None:
        """Validates behavior for no response returns default message.
    ...
    async def test_empty_content_returns_default_message(self) -> None:
        """Validates behavior for empty content returns default message.
    ...
    async def test_content_without_text_excluded(self) -> None:
        """Validates behavior for content without text excluded.
    ...
    async def test_none_response_returns_default_message(self) -> None:
        """Validates behavior for none response returns default message.
    ...
    async def test_requests_reference_source_data_per_source(self) -> None:
        ...
        """Validates behavior for requests reference source data per source.
    ...
    async def test_no_source_params_when_no_sources(self) -> None:
        ...
        """Validates behavior for no source params when no sources.
    ...
    async def test_existing_mixed_source_kb_preserves_source_kinds(self) -> None:
        """Validates behavior for existing mixed source kb preserves source kinds.
    ...
    async def test_concurrent_existing_kb_initialization_publishes_complete_source_params(self) -> None:
        """Validates behavior for concurrent existing kb initialization publishes complete source params.
        ...
        async def get_knowledge_source(name: str) -> SimpleNamespace:
            """Implements get knowledge source.
...
class TestPrepareMessagesForKbSearch:
    ...
    def test_text_only_messages(self) -> None:
        """Validates behavior for text only messages.
    ...
    def test_image_uri_content(self) -> None:
        """Validates behavior for image uri content.
    ...
    def test_mixed_text_and_image_content(self) -> None:
        """Validates behavior for mixed text and image content.
    ...
    def test_skips_non_text_non_image_content(self) -> None:
        ...
        """Validates behavior for skips non text non image content.
    ...
    def test_skips_empty_text(self) -> None:
        ...
        """Validates behavior for skips empty text.
    ...
    def test_fallback_to_msg_text_when_no_contents(self) -> None:
        """Validates behavior for fallback to msg text when no contents.
    ...
    def test_data_uri_image(self) -> None:
        """Validates behavior for data uri image.
    ...
    def test_non_image_uri_skipped(self) -> None:
        ...
        """Validates behavior for non image uri skipped.
...
class TestParseReferencesToAnnotations:
    ...
    def test_none_references(self) -> None:
        """Validates behavior for none references.
    ...
    def test_empty_references(self) -> None:
        """Validates behavior for empty references.
    ...
    def test_search_index_reference_captures_doc_key(self) -> None:
        """Validates behavior for search index reference captures doc key.
    ...
    def test_web_reference_with_url_and_title(self) -> None:
        """Validates behavior for web reference with url and title.
    ...
    def test_blob_reference_extracts_blob_url(self) -> None:
        """Validates behavior for blob reference extracts blob url.
    ...
    def test_source_data_and_reranker_score(self) -> None:
        """Validates behavior for source data and reranker score.
    ...
    def test_raw_representation_stores_original_ref(self) -> None:
        """Validates behavior for raw representation stores original ref.
    ...
    def test_remote_sharepoint_captures_sensitivity_label(self) -> None:
        ...
        """Validates behavior for remote sharepoint captures sensitivity label.
    ...
    def test_multiple_references(self) -> None:
        """Validates behavior for multiple references.
...
class TestParseMessagesFromKbResponse:
    ...
    def test_converts_all_messages(self) -> None:
        """Validates behavior for converts all messages.
    ...
    def test_none_response_returns_default(self) -> None:
        """Validates behavior for none response returns default.
    ...
    def test_empty_response_returns_default(self) -> None:
        """Validates behavior for empty response returns default.
    ...
    def test_image_content(self) -> None:
        """Validates behavior for image content.
    ...
    def test_references_become_annotations(self) -> None:
        """Validates behavior for references become annotations.
    ...
    def test_multiple_messages_with_references(self) -> None:
        """Validates behavior for multiple messages with references.
...
class TestBeforeRunAgentic:
    ...
    async def test_query_source_credential_requires_preview_sdk_before_transport(self) -> None:
        """Validates behavior for query source credential requires preview sdk before transport.
    ...
    async def test_query_source_credential_is_serialized_as_http_header(self) -> None:
        """Validates behavior for query source credential is serialized as http header.
        ...
        async def capture_request(_transport: AioHttpTransport, request: Any, **_kwargs: Any) -> None:
            """Implements capture request.
            
            Args:
                _transport: Description of _transport.
    ...
    async def test_query_source_token_failure_happens_before_knowledge_base_access(self) -> None:
        """Validates behavior for query source token failure happens before knowledge base access.
    ...
    async def test_without_query_source_credential_omits_authorization(self) -> None:
        """Validates behavior for without query source credential omits authorization.
    ...
    async def test_sync_query_source_credential_is_forwarded_to_retrieval(self) -> None:
        """Validates behavior for sync query source credential is forwarded to retrieval.
    ...
    async def test_agentic_mode_calls_agentic_search(self) -> None:
        """Validates behavior for agentic mode calls agentic search.
