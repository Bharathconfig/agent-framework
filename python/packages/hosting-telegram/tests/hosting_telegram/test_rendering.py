...
class TestTelegramFromRun:
    """Represents the TestTelegramFromRun type and related behavior.
    """
    def test_text_response_renders_send_message(self) -> None:
        """Validates behavior for text response renders send message.
    ...
    def test_parse_mode_is_included_when_given(self) -> None:
        """Validates behavior for parse mode is included when given.
    ...
    def test_no_text_or_image_falls_back_to_no_response(self) -> None:
        """Validates behavior for no text or image falls back to no response.
    ...
    def test_text_is_truncated_to_max_length(self) -> None:
        """Validates behavior for text is truncated to max length.
    ...
    def test_text_is_truncated_by_utf16_code_units(self) -> None:
        """Validates behavior for text is truncated by utf16 code units.
    ...
    def test_image_uri_renders_send_photo(self) -> None:
        """Validates behavior for image uri renders send photo.
    ...
    def test_image_with_text_uses_caption(self) -> None:
        """Validates behavior for image with text uses caption.
    ...
    def test_image_caption_is_truncated_by_utf16_code_units(self) -> None:
        """Validates behavior for image caption is truncated by utf16 code units.
    ...
    def test_inline_image_data_is_not_rendered_as_photo(self) -> None:
        """Validates behavior for inline image data is not rendered as photo.
    ...
    def test_non_image_uri_is_not_rendered_as_photo(self) -> None:
        """Validates behavior for non image uri is not rendered as photo.
    ...
    def test_only_first_image_is_rendered(self) -> None:
        """Validates behavior for only first image is rendered.
...
class TestTelegramFromStreamingRun:
    """Represents the TestTelegramFromStreamingRun type and related behavior.
    """
    async def test_accumulates_text_across_updates(self) -> None:
        """Validates behavior for accumulates text across updates.
    ...
    async def test_final_edit_includes_parse_mode(self) -> None:
        """Validates behavior for final edit includes parse mode.
    ...
    async def test_edit_matching_initial_placeholder_is_omitted(self) -> None:
        """Validates behavior for edit matching initial placeholder is omitted.
    ...
    async def test_final_text_is_truncated(self) -> None:
        """Validates behavior for final text is truncated.
    ...
    async def test_images_from_final_response_render_as_send_photo(self) -> None:
        """Validates behavior for images from final response render as send photo.
    ...
    async def test_no_text_and_no_image_falls_back_to_no_response(self) -> None:
        """Validates behavior for no text and no image falls back to no response.
    ...
    async def test_image_only_final_response_skips_text_edit(self) -> None:
        """Validates behavior for image only final response skips text edit.
    ...
    async def test_error_during_iteration_propagates(self) -> None:
        """Validates behavior for error during iteration propagates.
    ...
    async def test_error_during_finalization_propagates(self) -> None:
        """Validates behavior for error during finalization propagates.
