...
class InlineCodeBridge:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            type_stubs: Description of type_stubs.
            mounts: Description of mounts.
    ...
    def _schedule_direct_tool(self, snapshot: Any, name: str) -> Any:
        ...
        """Implements  schedule direct tool.
