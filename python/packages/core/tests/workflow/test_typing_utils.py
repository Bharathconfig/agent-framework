"""This module defines functionality for packages/core/tests/workflow/test_typing_utils.
...
def test_normalize_type_to_list_custom_types() -> None:
    ...
    @dataclass
    class CustomMessage:
        """Represents the CustomMessage type and related behavior.
        """
        content: str
...
def test_resolve_type_annotation_string_custom_type() -> None:
    ...
    @dataclass
    class MyCustomType:
        """Represents the MyCustomType type and related behavior.
        """
        value: int
...
def test_custom_type() -> None:
    ...
    @dataclass
    class CustomClass:
        """Represents the CustomClass type and related behavior.
        """
        value: int
...
def test_serialize_type() -> None:
    ...
    @dataclass
    class TestClass:
        """Represents the TestClass type and related behavior.
        """
        value: int
...
def test_deserialize_type_accepts_explicit_allowed_type() -> None:
    ...
    class ExplicitType:
        """Represents the ExplicitType type and related behavior.
        """
        pass
...
def test_type_compatibility_basic() -> None:
    ...
    class Animal:
        """Represents the Animal type and related behavior.
        """
        pass

    class Dog(Animal):
        """Represents the Dog type and related behavior.
        """
        pass
...
def test_type_compatibility_collections() -> None:
    ...
    @dataclass
    class Message:
        """Represents the Message type and related behavior.
        """
        text: str
...
def test_coerce_dict_to_dataclass() -> None:
    ...
    @dataclass
    class Point:
        """Represents the Point type and related behavior.
        """
        x: int
        y: int
...
def test_coerce_dict_to_dataclass_coerces_nested_fields() -> None:
    ...
    @dataclass
    class Path:
        """Represents the Path type and related behavior.
        """
        points: list[Point]
        label: str | None
...
def test_coerce_dict_to_dataclass_respects_post_init_validation() -> None:
    ...
    @dataclass
    class Decision:
        """Represents the Decision type and related behavior.
        """
        scores: list[int]
...
def test_coerce_dict_to_dataclass_survives_arbitrary_constructor_errors() -> None:
    ...
    @dataclass
    class Strict:
        """Represents the Strict type and related behavior.
        """
        value: int
...
def test_coerce_dict_to_dataclass_allows_annotations_isinstance_cannot_check() -> None:
    ...
    @dataclass
    class Owner:
        """Represents the Owner type and related behavior.
        """
        user_id: UserId
...
def test_coerce_dict_to_dataclass_accepts_init_only_variables() -> None:
    ...
    @dataclass
    class Scaled:
        """Represents the Scaled type and related behavior.
        """
        value: int
        scale: InitVar[int] = 1
...
def test_coerce_dict_to_dataclass_checks_literal_fields() -> None:
    ...
    @dataclass
    class Verdict:
        """Represents the Verdict type and related behavior.
        """
...
def test_coerce_dict_to_dataclass_coerces_container_fields() -> None:
    ...
    @dataclass
    class Config:
        """Represents the Config type and related behavior.
        """
