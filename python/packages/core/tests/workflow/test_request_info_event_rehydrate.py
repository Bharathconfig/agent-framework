"""This module defines functionality for packages/core/tests/workflow/test_request_info_event_rehydrate.
...
class SimpleApproval:
    """Represents the SimpleApproval type and related behavior.
    """
    prompt: str = ""
    draft: str = ""
    iteration: int = 0
...
class SlottedApproval:
    """Represents the SlottedApproval type and related behavior.
    """
    note: str = ""
...
@dataclass
class TimedApproval:
    """Represents the TimedApproval type and related behavior.
    """
...
def test_workflow_event_from_dict_accepts_explicit_allowed_types() -> None:
    ...
    class ExplicitResponse:
        """Represents the ExplicitResponse type and related behavior.
        """
        pass
...
def _write_observable_type_module(tmp_path: Path, module_name: str) -> Path:
    """Implements  write observable type module.
...
async def test_request_info_event_serializes_non_json_payloads() -> None:
    """Validates behavior for request info event serializes non json payloads.
    """
