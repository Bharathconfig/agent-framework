...
class TestStateBasicOperations:
    ...
    def test_set_and_get(self) -> None:
        """Validates behavior for set and get.
    ...
    def test_set_does_not_alias_caller_value(self) -> None:
        """Validates behavior for set does not alias caller value.
    ...
    def test_get_does_not_expose_pending_value(self) -> None:
        """Validates behavior for get does not expose pending value.
    ...
    def test_get_does_not_expose_committed_value(self) -> None:
        """Validates behavior for get does not expose committed value.
    ...
    def test_get_mutate_set_updates_state(self) -> None:
        """Validates behavior for get mutate set updates state.
    ...
    def test_get_with_default(self) -> None:
        """Validates behavior for get with default.
    ...
    def test_has_returns_true_for_existing_key(self) -> None:
        """Validates behavior for has returns true for existing key.
    ...
    def test_has_returns_false_for_missing_key(self) -> None:
        """Validates behavior for has returns false for missing key.
    ...
    def test_delete_existing_key(self) -> None:
        """Validates behavior for delete existing key.
    ...
    def test_delete_missing_key_raises(self) -> None:
        """Validates behavior for delete missing key raises.
...
class TestSuperstepCaching:
    ...
    def test_set_writes_to_pending_not_committed(self) -> None:
        """Validates behavior for set writes to pending not committed.
    ...
    def test_commit_moves_pending_to_committed(self) -> None:
        """Validates behavior for commit moves pending to committed.
    ...
    def test_discard_clears_pending_without_committing(self) -> None:
        """Validates behavior for discard clears pending without committing.
    ...
    def test_pending_overrides_committed_on_get(self) -> None:
        """Validates behavior for pending overrides committed on get.
    ...
    def test_multiple_sets_before_commit(self) -> None:
        """Validates behavior for multiple sets before commit.
...
class TestDeleteWithSuperstepCaching:
    ...
    def test_delete_pending_only_key(self) -> None:
        """Validates behavior for delete pending only key.
    ...
    def test_delete_committed_key_marks_for_deletion(self) -> None:
        """Validates behavior for delete committed key marks for deletion.
    ...
    def test_delete_committed_key_removed_on_commit(self) -> None:
        """Validates behavior for delete committed key removed on commit.
    ...
    def test_discard_after_delete_restores_committed_value(self) -> None:
        """Validates behavior for discard after delete restores committed value.
...
class TestExportImport:
    ...
    def test_export_returns_committed_only(self) -> None:
        """Validates behavior for export returns committed only.
    ...
    def test_import_merges_into_committed(self) -> None:
        """Validates behavior for import merges into committed.
    ...
    def test_import_does_not_affect_pending(self) -> None:
        """Validates behavior for import does not affect pending.
    ...
    def test_export_isolates_nested_mutable_values(self) -> None:
        """Validates behavior for export isolates nested mutable values.
    ...
    def test_exported_dict_does_not_mutate_state(self) -> None:
        """Validates behavior for exported dict does not mutate state.
    ...
    def test_import_does_not_alias_caller_state(self) -> None:
        """Validates behavior for import does not alias caller state.
    ...
    def test_export_import_roundtrip_isolates_snapshot(self) -> None:
        """Validates behavior for export import roundtrip isolates snapshot.
