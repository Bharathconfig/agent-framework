"""This module defines functionality for packages/core/tests/workflow/test_workflow_kwargs.
...
async def test_kwargs_stored_in_state() -> None:
    ...
    class _StateInspector(Executor):
        """Represents the _StateInspector type and related behavior.
        """
        @handler
...
async def test_empty_kwargs_stored_as_empty_dict() -> None:
    ...
    class _StateChecker(Executor):
        """Represents the _StateChecker type and related behavior.
        """
        @handler
...
async def test_magentic_kwargs_flow_to_agents() -> None:
    ...
    class _MockManager(MagenticManagerBase):
        """Represents the _MockManager type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
...
async def test_workflow_tools_do_not_break_exact_supports_agent_run_signature() -> None:
    ...
    class ExactSignatureAgent(BaseAgent):
        """Represents the ExactSignatureAgent type and related behavior.
        """
        @overload
        def run(
            self,
...
async def test_workflow_cancellation_normalizes_tools_for_resumed_agent() -> None:
    ...
    class ApprovalRequestAgent(BaseAgent):
        """Represents the ApprovalRequestAgent type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
...
async def test_continuation_tools_preserve_existing_invocation_kwargs() -> None:
    ...
    class RequestingExecutor(Executor):
        """Represents the RequestingExecutor type and related behavior.
        """
        @handler
