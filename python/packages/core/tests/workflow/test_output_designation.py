...
def test_omitted_selection_designation_marks_every_executor_as_terminal() -> None:
    """Validates behavior for omitted selection designation marks every executor as terminal.
    """
...
def test_strict_empty_designation_marks_no_executor_as_terminal() -> None:
    """Validates behavior for strict empty designation marks no executor as terminal.
    """
...
def test_strict_designated_set_only_terminal_for_members() -> None:
    """Validates behavior for strict designated set only terminal for members.
    """
...
def test_designation_is_frozen() -> None:
    """Validates behavior for designation is frozen.
    """
...
def test_get_output_executors_throws_when_designation_references_missing_executor() -> None:
    """Validates behavior for get output executors throws when designation references missing executor.
    """
    workflow = Workflow(
        [],
...
def test_get_intermediate_executors_throws_when_designation_references_missing_executor() -> None:
    """Validates behavior for get intermediate executors throws when designation references missing executor.
    """
    workflow = Workflow(
        [],
        {_emit_one.id: _emit_one},
