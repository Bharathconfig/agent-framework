"""This module defines functionality for packages/core/tests/workflow/test_validation.
...
class StringExecutor(Executor):
    """Represents the StringExecutor type and related behavior.
    """
    @handler
...
class IntExecutor(Executor):
    """Represents the IntExecutor type and related behavior.
    """
    @handler
    async def handle_int(self, message: int, ctx: WorkflowContext[int]) -> None:
        """Implements handle int.
...
class AnyExecutor(Executor):
    """Represents the AnyExecutor type and related behavior.
    """
    @handler
    async def handle_any(self, message: Any, ctx: WorkflowContext[Any]) -> None:
        """Implements handle any.
...
class NoOutputTypesExecutor(Executor):
    """Represents the NoOutputTypesExecutor type and related behavior.
    """
    @handler
...
class MultiTypeExecutor(Executor):
    """Represents the MultiTypeExecutor type and related behavior.
    """
    @handler
    async def handle_string(self, message: str, ctx: WorkflowContext[str]) -> None:
        """Implements handle string.
...
def test_valid_workflow_passes_validation():
    """Validates behavior for valid workflow passes validation.
    """
...
def test_duplicate_executor_ids_fail_validation():
    """Validates behavior for duplicate executor ids fail validation.
    """
...
def test_edge_duplication_validation_fails():
    """Validates behavior for edge duplication validation fails.
    """
...
def test_type_compatibility_validation_fails():
    """Validates behavior for type compatibility validation fails.
    """
...
def test_type_compatibility_with_any_type_passes():
    """Validates behavior for type compatibility with any type passes.
    """
    string_executor = StringExecutor(id="string_executor")
...
def test_type_compatibility_with_no_output_types():
    """Validates behavior for type compatibility with no output types.
    """
...
def test_multi_type_executor_compatibility():
    """Validates behavior for multi type executor compatibility.
    """
    string_executor = StringExecutor(id="string_executor")
...
def test_graph_connectivity_unreachable_executors():
    """Validates behavior for graph connectivity unreachable executors.
    """
    executor1 = StringExecutor(id="executor1")
    executor2 = StringExecutor(id="executor2")
...
def test_graph_connectivity_isolated_executors():
    """Validates behavior for graph connectivity isolated executors.
    """
    executor1 = StringExecutor(id="executor1")
    executor2 = StringExecutor(id="executor2")
...
def test_disconnected_start_executor_not_in_graph():
    """Validates behavior for disconnected start executor not in graph.
    """
    executor1 = StringExecutor(id="executor1")
    executor2 = StringExecutor(id="executor2")
...
def test_missing_start_executor():
    """Validates behavior for missing start executor.
    """
...
def test_workflow_validation_error_base_class():
    """Validates behavior for workflow validation error base class.
    """
...
def test_complex_workflow_validation():
    ...
    """Validates behavior for complex workflow validation.
    """
    executor1 = StringExecutor(id="executor1")
...
def test_type_compatibility_inheritance():
    """Validates behavior for type compatibility inheritance.
    """
    class BaseExecutor(Executor):
        """Represents the BaseExecutor type and related behavior.
        """
        @handler
        async def handle_base(self, message: str, ctx: WorkflowContext[str]) -> None:
            """Implements handle base.
    ...
    class DerivedExecutor(Executor):
        """Represents the DerivedExecutor type and related behavior.
        """
        @handler
        async def handle_derived(self, message: str, ctx: WorkflowContext[str]) -> None:
            """Implements handle derived.
...
def test_direct_validation_function():
    """Validates behavior for direct validation function.
    """
    executor1 = StringExecutor(id="executor1")
    executor2 = StringExecutor(id="executor2")
...
def test_fan_out_validation():
    """Validates behavior for fan out validation.
    """
...
def test_fan_in_validation():
    """Validates behavior for fan in validation.
    """
...
def test_chain_validation():
    """Validates behavior for chain validation.
    """
    executor1 = StringExecutor(id="executor1")
    executor2 = StringExecutor(id="executor2")
...
def test_logging_for_missing_output_types(caplog: Any) -> None:
    """Validates behavior for logging for missing output types.
...
def test_logging_for_missing_input_types(caplog: Any) -> None:
    """Validates behavior for logging for missing input types.
    ...
    class NoInputTypesExecutor(Executor):
        ...
        """Represents the NoInputTypesExecutor type and related behavior.
        """
...
def test_self_loop_detection_warning(caplog: Any) -> None:
    """Validates behavior for self loop detection warning.
...
def test_handler_validation_basic(caplog: Any) -> None:
    """Validates behavior for handler validation basic.
...
def test_dead_end_detection(caplog: Any) -> None:
    """Validates behavior for dead end detection.
...
def test_successful_type_compatibility_logging(caplog: Any) -> None:
    """Validates behavior for successful type compatibility logging.
...
def test_multiple_dead_ends_detection(caplog: Any) -> None:
    """Validates behavior for multiple dead ends detection.
...
def test_single_executor_workflow(caplog: Any) -> None:
    """Validates behavior for single executor workflow.
...
def test_enhanced_type_compatibility_error_details():
    """Validates behavior for enhanced type compatibility error details.
    """
    string_executor = StringExecutor(id="string_executor")
    int_executor = IntExecutor(id="int_executor")
...
def test_union_type_compatibility_validation() -> None:
    """Validates behavior for union type compatibility validation.
    """
...
def test_generic_type_compatibility() -> None:
    """Validates behavior for generic type compatibility.
    """
    class ListOutputExecutor(Executor):
        """Represents the ListOutputExecutor type and related behavior.
        """
        @handler
    ...
    class ListInputExecutor(Executor):
        """Represents the ListInputExecutor type and related behavior.
        """
        @handler
...
def test_validation_enum_usage() -> None:
    ...
    """Validates behavior for validation enum usage.
    """
...
def test_handler_ctx_missing_annotation_raises() -> None:
    ...
    """Validates behavior for handler ctx missing annotation raises.
    """
    with pytest.raises(ValueError) as exc:

        class BadExecutor(Executor):  # pyright: ignore[reportUnusedClass]
            """Represents the BadExecutor type and related behavior.
            """
...
def test_handler_ctx_invalid_t_out_entries_raises() -> None:
    # Validation now happens at handler registration time, not workflow build time
    """Validates behavior for handler ctx invalid t out entries raises.
    """
    with pytest.raises(ValueError) as exc:
...
def test_handler_ctx_none_is_allowed() -> None:
    """Validates behavior for handler ctx none is allowed.
    """
    class NoneExecutor(Executor):
        """Represents the NoneExecutor type and related behavior.
        """
        @handler
...
def test_handler_ctx_any_is_allowed_but_skips_type_checks(caplog: Any) -> None:
    """Validates behavior for handler ctx any is allowed but skips type checks.
    ...
    class AnyOutExecutor(Executor):
        """Represents the AnyOutExecutor type and related behavior.
        """
        @handler
...
class OutputExecutor(Executor):
    """Represents the OutputExecutor type and related behavior.
    """
    @handler
