"""This module defines functionality for packages/core/tests/workflow/test_workflow_context.
...
async def make_context(
    ...
    Args:
        executor_id: Description of executor_id.
    """
    from agent_framework._workflows._runner_context import InProcRunnerContext
...
async def test_executor_cannot_emit_framework_lifecycle_event(caplog: "LogCaptureFixture") -> None:
    """Validates behavior for executor cannot emit framework lifecycle event.
...
async def test_executor_cannot_emit_output_selection_events(
    ...
    """Validates behavior for executor cannot emit output selection events.
...
async def test_executor_emits_normal_event() -> None:
    """Validates behavior for executor emits normal event.
    """
    async with make_context() as (ctx, runner_ctx):
...
class _TestEvent(WorkflowEvent):
    """Represents the _TestEvent type and related behavior.
    """
...
async def test_workflow_context_type_annotations_no_parameter() -> None:
    ...
    """Validates behavior for workflow context type annotations no parameter.
    """
    @executor(id="func1")
    ...
    class _exec1(Executor):
        """Represents the _exec1 type and related behavior.
        """
        @handler
...
async def test_workflow_context_type_annotations_message_type_parameter() -> None:
    # Test function-based executor
    """Validates behavior for workflow context type annotations message type parameter.
    """
    @executor(id="func1")
    ...
    class _exec2(Executor):
        """Represents the _exec2 type and related behavior.
        """
        @handler
...
async def test_workflow_context_type_annotations_message_and_output_type_parameters() -> None:
    # Test function-based executor
    """Validates behavior for workflow context type annotations message and output type parameters.
    """
    @executor(id="func1")
    async def func1(text: str, ctx: WorkflowContext[str]) -> None:
        """Implements func1.
...
async def test_workflow_context_type_annotations_any() -> None:
    """Validates behavior for workflow context type annotations any.
    """
    class _exec1(Executor):
        """Represents the _exec1 type and related behavior.
        """
