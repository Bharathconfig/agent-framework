"""This module defines functionality for packages/core/tests/workflow/test_agent_executor.
        ...
        **kwargs: Any,
        ...
        if stream:
            ...
            async def _mark_result_hook_called(
                ...
                """Implements  mark result hook called.
...
class _ApprovalEmittingAgent(BaseAgent):
    ...
    def _build_approval_content(self) -> Content:
        """Implements  build approval content.
