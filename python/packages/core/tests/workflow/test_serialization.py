"""This module defines functionality for packages/core/tests/workflow/test_serialization.
...
def test_to_dict_preserves_compatibility_wire_keys_for_output_designation() -> None:
    ...
    class _Yielder(Executor):
        """Represents the _Yielder type and related behavior.
        """
        @handler
    ...
    class _Terminal(Executor):
        """Represents the _Terminal type and related behavior.
        """
        @handler
        async def handle(self, message: str, ctx: WorkflowContext[str, str]) -> None:
            """Implements handle.
