"""This module defines functionality for packages/core/tests/workflow/test_workflow_builder.
...
class DummyAgent(BaseAgent):
    """Represents the DummyAgent type and related behavior.
    """
    @overload
    def run(
        self,
...
def test_builder_accepts_agents_directly():
    """Validates behavior for builder accepts agents directly.
    """
