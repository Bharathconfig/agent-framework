"""This module defines functionality for packages/core/tests/workflow/test_function_executor.
...
class FuncExecForwardRefMessage:
    """Represents the FuncExecForwardRefMessage type and related behavior.
    """
    content: str
...
class FuncExecForwardRefTypeA:
    """Represents the FuncExecForwardRefTypeA type and related behavior.
    """
    value: str
...
class FuncExecForwardRefTypeB:
    """Represents the FuncExecForwardRefTypeB type and related behavior.
    """
    value: int
...
class FuncExecForwardRefResponse:
    """Represents the FuncExecForwardRefResponse type and related behavior.
    """
    result: str
...
class TestFunctionExecutor:
    ...
    def test_union_output_types(self):
        ...
        async def multi_workflow_output(data: str, ctx: WorkflowContext[Never, str | int | bool]) -> None:  # type: ignore[valid-type]
            """Implements multi workflow output.
    ...
    def test_validation_errors(self):
        ...
        async def unparameterized_ctx(data: str, ctx: WorkflowContext) -> None:  # type: ignore
            """Implements unparameterized ctx.
    ...
    def test_sync_function_validation(self):
        ...
        def valid_sync_with_ctx(data: int, ctx: WorkflowContext[str]):
            """Implements valid sync with ctx.
    ...
    async def test_async_staticmethod_detection_behavior(self):
        ...
        class C:
            """Represents the C type and related behavior.
            """
