...
class FrameworkHelperPayload:
    ...
    def __init__(self, nested_payload: str) -> None:
        ...
        Args:
            self: Description of self.
            nested_payload: Description of nested_payload.
        """
...
class _NestedTypeContainer:
    """Represents the _NestedTypeContainer type and related behavior.
    """
    @dataclass
    class NestedType:
        """Represents the NestedType type and related behavior.
        """
        value: int


class _NestedSetStateContainer:
    """Represents the _NestedSetStateContainer type and related behavior.
    """
    class Evil:
        """Represents the Evil type and related behavior.
        """
...
class _NamedPickleColor(enum.Enum):
    """Represents the _NamedPickleColor type and related behavior.
    """
    RED = 1
    BLUE = 2
    CRIMSON = 1
    ...
    def __reduce_ex__(self, proto: object) -> tuple[Any, tuple[type[enum.Enum], str]]:
        """Implements   reduce ex  .
        
        Args:
            self: Description of self.
            proto: Description of proto.
...
class _EnumNonMemberAttributePayload:
    """Represents the _EnumNonMemberAttributePayload type and related behavior.
    """
    def __reduce__(self):
        """Implements   reduce  .
