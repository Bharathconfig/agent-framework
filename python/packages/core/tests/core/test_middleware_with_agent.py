"""This module defines functionality for packages/core/tests/core/test_middleware_with_agent.
...
class _IterableAgentMiddleware(AgentMiddleware):
    """Represents the _IterableAgentMiddleware type and related behavior.
    """
...
class TestChatAgentClassBasedMiddleware:
    ...
    async def test_class_based_agent_middleware_with_chat_agent(self, client: SupportsChatGetResponse) -> None:
        ...
        class TrackingAgentMiddleware(AgentMiddleware):
            """Represents the TrackingAgentMiddleware type and related behavior.
            """
    ...
    async def test_class_based_function_middleware_with_chat_agent(self, client: "MockChatClient") -> None:
        ...
        class TrackingFunctionMiddleware(FunctionMiddleware):
            """Represents the TrackingFunctionMiddleware type and related behavior.
            """
            async def process(
                self,
...
class TestChatAgentFunctionBasedMiddleware:
    ...
    async def test_agent_middleware_with_pre_termination(self, client: "MockChatClient") -> None:
        ...
        class PreTerminationMiddleware(AgentMiddleware):
            """Represents the PreTerminationMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_agent_middleware_with_post_termination(self, client: "MockChatClient") -> None:
        ...
        class PostTerminationMiddleware(AgentMiddleware):
            """Represents the PostTerminationMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_function_middleware_with_pre_termination(self, client: "MockChatClient") -> None:
        ...
        class PreTerminationFunctionMiddleware(FunctionMiddleware):
            """Represents the PreTerminationFunctionMiddleware type and related behavior.
            """
            async def process(
                self,
                context: FunctionInvocationContext,
    ...
    async def test_function_middleware_with_post_termination(self, client: "MockChatClient") -> None:
        ...
        class PostTerminationFunctionMiddleware(FunctionMiddleware):
            """Represents the PostTerminationFunctionMiddleware type and related behavior.
            """
            async def process(
                self,
                context: FunctionInvocationContext,
    ...
    async def test_function_based_agent_middleware_with_chat_agent(self, client: "MockChatClient") -> None:
        ...
        async def tracking_agent_middleware(context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements tracking agent middleware.
    ...
    async def test_function_based_function_middleware_with_chat_agent(self, client: "MockChatClient") -> None:
        ...
        async def tracking_function_middleware(
            ...
            """Implements tracking function middleware.
...
class TestChatAgentStreamingMiddleware:
    ...
    async def test_agent_middleware_with_streaming(self, client: "MockChatClient") -> None:
        ...
        class StreamingTrackingMiddleware(AgentMiddleware):
            """Represents the StreamingTrackingMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_non_streaming_vs_streaming_flag_validation(self, client: "MockChatClient") -> None:
        ...
        class FlagTrackingMiddleware(AgentMiddleware):
            """Represents the FlagTrackingMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
...
class TestChatAgentMultipleMiddlewareOrdering:
    ...
    async def test_multiple_agent_middleware_execution_order(self, client: "MockChatClient") -> None:
        ...
        class OrderedMiddleware(AgentMiddleware):
            """Represents the OrderedMiddleware type and related behavior.
            """
            def __init__(self, name: str):
                """Initializes a new instance.
    ...
    async def test_mixed_middleware_types_with_chat_agent(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        class ClassAgentMiddleware(AgentMiddleware):
            """Represents the ClassAgentMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
        ...
        async def function_agent_middleware(context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements function agent middleware.
        ...
        class ClassFunctionMiddleware(FunctionMiddleware):
            """Represents the ClassFunctionMiddleware type and related behavior.
            """
            async def process(
                self,
                context: FunctionInvocationContext,
        ...
        async def function_function_middleware(
            ...
            """Implements function function middleware.
    ...
    async def test_provider_added_agent_middleware_is_rejected(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        class ProviderMiddlewareContextProvider(ContextProvider):
            """Represents the ProviderMiddlewareContextProvider type and related behavior.
            """
    ...
    class TrackingAgentMiddleware(AgentMiddleware):
        ...
        def __init__(self, name: str, execution_log: list[str]):
            ...
            Args:
                self: Description of self.
                name: Description of name.
                execution_log: Description of execution_log.
            """
            self.name = name
...
class TestRunLevelMiddleware:
    ...
    async def test_agent_plus_run_middleware_execution_order(self, client: "MockChatClient") -> None:
        ...
        class MetadataAgentMiddleware(AgentMiddleware):
            """Represents the MetadataAgentMiddleware type and related behavior.
            """
            def __init__(self, name: str):
                """Initializes a new instance.
        ...
        class MetadataRunMiddleware(AgentMiddleware):
            """Represents the MetadataRunMiddleware type and related behavior.
            """
            def __init__(self, name: str):
                """Initializes a new instance.
    ...
    async def test_agent_and_run_level_both_agent_and_function_middleware(
        ...
        class AgentLevelAgentMiddleware(AgentMiddleware):
            """Represents the AgentLevelAgentMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
        ...
        class AgentLevelFunctionMiddleware(FunctionMiddleware):
            """Represents the AgentLevelFunctionMiddleware type and related behavior.
            """
            async def process(
                self,
                context: FunctionInvocationContext,
        ...
        class RunLevelAgentMiddleware(AgentMiddleware):
            """Represents the RunLevelAgentMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
        ...
        class RunLevelFunctionMiddleware(FunctionMiddleware):
            """Represents the RunLevelFunctionMiddleware type and related behavior.
            """
            async def process(
                self,
                context: FunctionInvocationContext,
...
class TestMiddlewareDecoratorLogic:
    ...
    async def test_decorator_and_type_match(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        async def matching_agent_middleware(context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements matching agent middleware.
        ...
        async def matching_function_middleware(
            ...
            """Implements matching function middleware.
    ...
    async def test_decorator_and_type_mismatch(self, client: MockChatClient) -> None:
        ...
        with pytest.raises(MiddlewareException, match="MiddlewareTypes type mismatch"):
            ...
            async def mismatched_middleware(
                ...
                """Implements mismatched middleware.
    ...
    async def test_only_decorator_specified(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        async def decorator_only_agent(context: Any, call_next: Any) -> None:  # No type annotation
            """Implements decorator only agent.
        ...
        async def decorator_only_function(context: Any, call_next: Any) -> None:  # No type annotation
            """Implements decorator only function.
    ...
    async def test_insufficient_parameters_error(self, client: Any) -> None:
        ...
        with pytest.raises(MiddlewareException, match="must have at least 2 parameters"):
            ...
            async def insufficient_params_middleware(context: Any) -> None:  # Missing 'next' parameter
                """Implements insufficient params middleware.
    ...
    async def test_decorator_markers_preserved(self) -> None:
        ...
        async def test_agent_middleware(context: Any, call_next: Any) -> None:
            """Validates behavior for agent middleware.
        ...
        async def test_function_middleware(context: Any, call_next: Any) -> None:
            """Validates behavior for function middleware.
...
class TestChatAgentSessionBehavior:
    ...
    async def test_agent_context_session_behavior_across_multiple_runs(self, client: "MockChatClient") -> None:
        ...
        class SessionTrackingMiddleware(AgentMiddleware):
            """Represents the SessionTrackingMiddleware type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
...
class TestChatAgentChatMiddleware:
    ...
    async def test_class_based_chat_middleware_with_chat_agent(self) -> None:
        ...
        class TrackingChatMiddleware(ChatMiddleware):
            """Represents the TrackingChatMiddleware type and related behavior.
            """
    ...
    async def test_function_based_chat_middleware_with_chat_agent(self) -> None:
        ...
        async def tracking_chat_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements tracking chat middleware.
    ...
    async def test_chat_middleware_can_modify_messages(self) -> None:
        ...
        async def message_modifier_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            ...
            """Implements message modifier middleware.
    ...
    async def test_chat_middleware_can_override_response(self) -> None:
        ...
        async def response_override_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            ...
            """Implements response override middleware.
    ...
    async def test_chat_middleware_with_streaming(self) -> None:
        ...
        class StreamingTrackingChatMiddleware(ChatMiddleware):
            """Represents the StreamingTrackingChatMiddleware type and related behavior.
            """
            async def process(self, context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_chat_middleware_termination_before_execution(self) -> None:
        ...
        class PreTerminationChatMiddleware(ChatMiddleware):
            """Represents the PreTerminationChatMiddleware type and related behavior.
            """
            async def process(self, context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_chat_middleware_termination_after_execution(self) -> None:
        ...
        class PostTerminationChatMiddleware(ChatMiddleware):
            """Represents the PostTerminationChatMiddleware type and related behavior.
            """
            async def process(self, context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_combined_middleware(self) -> None:
        ...
        async def function_middleware(
            ...
            """Implements function middleware.
    ...
    async def test_provider_added_chat_and_function_middleware_are_forwarded(
        ...
        async def constructor_chat_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements constructor chat middleware.
        ...
        async def provider_chat_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements provider chat middleware.
        ...
        async def run_chat_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements run chat middleware.
        ...
        async def constructor_function_middleware(
            ...
            """Implements constructor function middleware.
        ...
        async def provider_function_middleware(
            ...
            """Implements provider function middleware.
        ...
        async def run_function_middleware(
            ...
            """Implements run function middleware.
...
class TestCallableClassMiddlewareErrorHandling:
    ...
    def test_callable_class_middleware_insufficient_params_raises_middleware_exception(self) -> None:
        ...
        class InsufficientParamsMiddleware:
            """Represents the InsufficientParamsMiddleware type and related behavior.
            """
    ...
    def test_callable_class_middleware_type_mismatch_raises_middleware_exception(self) -> None:
        ...
        class MismatchedCallableMiddleware:
            """Represents the MismatchedCallableMiddleware type and related behavior.
            """
    ...
    def test_callable_class_middleware_undetermined_type_raises_middleware_exception(self) -> None:
        ...
        class UndeterminedCallableMiddleware:
            """Represents the UndeterminedCallableMiddleware type and related behavior.
            """
...
class TestMiddlewareFailure:
    ...
    async def test_failure_before_tool_aborts_run(self, chat_client_base: "MockBaseChatClient") -> None:
        """Validates behavior for failure before tool aborts run.
        ...
        class Enforcement(FunctionMiddleware):
            """Represents the Enforcement type and related behavior.
            """
            async def process(
    ...
    async def test_failure_after_tool_aborts_run_before_next_model_turn(
        ...
        """Validates behavior for failure after tool aborts run before next model turn.
        ...
        class PostCheck(FunctionMiddleware):
            """Represents the PostCheck type and related behavior.
            """
            async def process(
                self, context: FunctionInvocationContext, call_next: Callable[[], Awaitable[None]]
            ) -> None:
    ...
    async def test_failure_cause_chain_reaches_caller(self, chat_client_base: "MockBaseChatClient") -> None:
        """Validates behavior for failure cause chain reaches caller.
    ...
    async def test_ordinary_exception_still_becomes_tool_error(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        class Broken(FunctionMiddleware):
            """Represents the Broken type and related behavior.
            """
            async def process(
                self, context: FunctionInvocationContext, call_next: Callable[[], Awaitable[None]]
            ) -> None:
    ...
    async def test_failure_cancels_concurrent_sibling_tool(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        class FailFast(FunctionMiddleware):
            """Represents the FailFast type and related behavior.
            """
            async def process(
                self, context: FunctionInvocationContext, call_next: Callable[[], Awaitable[None]]
            ) -> None:
    ...
    async def test_failure_streaming_reaches_stream_consumer(self, chat_client_base: "MockBaseChatClient") -> None:
        """Validates behavior for failure streaming reaches stream consumer.
    ...
    async def test_failure_from_agent_middleware_propagates(self, chat_client_base: "MockBaseChatClient") -> None:
        ...
        class Guard(AgentMiddleware):
            """Represents the Guard type and related behavior.
            """
            async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_failure_settles_dangling_calls_on_service_conversation(
        ...
        class Recorder(ChatMiddleware):
            """Represents the Recorder type and related behavior.
            """
            async def process(self, context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
                """Implements process.
    ...
    async def test_failure_during_approved_replay_settles_and_escapes(
        ...
        class FailReplay(FunctionMiddleware):
            """Represents the FailReplay type and related behavior.
            """
            async def process(
                self, context: FunctionInvocationContext, call_next: Callable[[], Awaitable[None]]
            ) -> None:
...
async def test_agent_middleware_observes_and_controls_original_tool_objects() -> None:
    ...
    class IdentityGuard(AgentMiddleware):
        """Represents the IdentityGuard type and related behavior.
        """
        async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements process.
...
async def test_named_tools_parameter_wins_over_options_tools_entry() -> None:
    ...
    class CaptureChatMiddleware(ChatMiddleware):
        """Represents the CaptureChatMiddleware type and related behavior.
        """
        async def process(self, context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements process.
...
async def test_losing_run_tool_route_is_never_iterated() -> None:
    ...
    def losing_source() -> Any:
        """Implements losing source.
        """
        iterations.append("iterated")
        yield losing_tool

    class Passthrough(AgentMiddleware):
        """Represents the Passthrough type and related behavior.
        """
        async def process(self, context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements process.
