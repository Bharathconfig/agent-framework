"""This module defines functionality for packages/core/tests/core/test_types.
...
def test_marked_refusal_text_is_visible_and_serializable() -> None:
    """Validates behavior for marked refusal text is visible and serializable.
    """
    content = Content.from_text(
...
def test_marked_refusal_text_is_excluded_from_structured_output() -> None:
    """Validates behavior for marked refusal text is excluded from structured output.
    """
...
def test_final_marked_refusal_does_not_fall_back_to_earlier_structured_output(response_type: type) -> None:
    """Validates behavior for final marked refusal does not fall back to earlier structured output.
    
    Args:
        response_type: Description of response_type.
    """
...
def test_mixed_final_message_with_refusal_has_no_structured_output() -> None:
    """Validates behavior for mixed final message with refusal has no structured output.
    """
    response = ChatResponse(
        messages=[
            Message(
...
def test_code_interpreter_tool_call_content_parses_inputs():
    """Validates behavior for code interpreter tool call content parses inputs.
    """
...
def test_code_interpreter_tool_result_content_outputs():
    """Validates behavior for code interpreter tool result content outputs.
    """
...
def test_image_generation_tool_contents():
    """Validates behavior for image generation tool contents.
    """
...
def test_mcp_server_tool_call_and_result():
    """Validates behavior for mcp server tool call and result.
    """
...
def test_mcp_server_tool_call_is_always_informational_only():
    """Validates behavior for mcp server tool call is always informational only.
    """
...
def test_shell_tool_call_content_creation():
    """Validates behavior for shell tool call content creation.
    """
...
def test_shell_tool_call_content_minimal():
    """Validates behavior for shell tool call content minimal.
    """
...
def test_shell_tool_result_content_creation():
    """Validates behavior for shell tool result content creation.
    """
...
def test_shell_tool_result_with_timeout():
    """Validates behavior for shell tool result with timeout.
    """
    result = Content.from_shell_tool_result(
        call_id="shell-t",
...
def test_shell_command_output_content_creation():
    """Validates behavior for shell command output content creation.
    """
...
def test_shell_content_serialization_roundtrip():
    """Validates behavior for shell content serialization roundtrip.
    """
    call = Content.from_shell_tool_call(
        call_id="shell-r",
        commands=["echo hello"],
...
def test_function_call_content_informational_only_serialization():
    """Validates behavior for function call content informational only serialization.
    """
...
def test_function_call_content_parse_arguments():
    """Validates behavior for function call content parse arguments.
    """
...
def test_function_call_content_add_merging_and_errors():
    ...
    """Validates behavior for function call content add merging and errors.
    """
...
def test_usage_details():
    """Validates behavior for usage details.
    """
...
def test_usage_details_addition():
    """Validates behavior for usage details addition.
    """
...
def test_usage_details_fail():
    ...
    """Validates behavior for usage details fail.
    """
    usage = cast(
        UsageDetails,
...
def test_usage_details_additional_counts():
    """Validates behavior for usage details additional counts.
    """
...
def test_usage_details_add_with_none_and_type_errors():
    """Validates behavior for usage details add with none and type errors.
    """
...
def test_usage_details_add_skips_non_int():
    """Validates behavior for usage details add skips non int.
    """
...
def test_function_approval_serialization_roundtrip():
    """Validates behavior for function approval serialization roundtrip.
    """
...
def test_function_call_occurrence_id_roundtrips_without_regeneration():
    """Validates behavior for function call occurrence id roundtrips without regeneration.
    """
...
def test_local_function_approval_request_warns_for_legacy_occurrence_identity() -> None:
    """Validates behavior for local function approval request warns for legacy occurrence identity.
    """
    function_call = Content.from_function_call(
        call_id="provider-call",
        name="f",
...
def test_hosted_function_approval_request_allows_provider_request_identity_without_warning() -> None:
    """Validates behavior for hosted function approval request allows provider request identity without warning.
    """
    function_call = Content.from_function_call(
        call_id="provider-call",
        name="hosted",
...
def test_legacy_function_call_deserialization_does_not_generate_an_occurrence_id():
    """Validates behavior for legacy function call deserialization does not generate an occurrence id.
    """
    with warnings.catch_warnings(record=True) as caught:
        warnings.simplefilter("always")
...
def test_ai_content_serialization(args: dict):
    """Validates behavior for ai content serialization.
...
def test_chat_message_with_chatrole_instance():
    """Validates behavior for chat message with chatrole instance.
    """
...
class OutputModel(BaseModel):
    """Represents the OutputModel type and related behavior.
    """
    response: str
...
def test_chat_response_value_raises_on_invalid_schema():
    ...
    class StrictSchema(BaseModel):
        """Represents the StrictSchema type and related behavior.
        """
        id: Literal[5]
...
async def test_chat_response_from_async_generator():
    """Validates behavior for chat response from async generator.
    """
...
async def test_chat_response_from_async_generator_output_format():
    """Validates behavior for chat response from async generator output format.
    """
    async def gen() -> AsyncIterable[ChatResponseUpdate]:
        """Implements gen.
        """
...
async def test_chat_response_from_async_generator_output_format_in_method():
    """Validates behavior for chat response from async generator output format in method.
    """
    async def gen() -> AsyncIterable[ChatResponseUpdate]:
        """Implements gen.
        """
...
async def test_chat_response_from_async_generator_mapping_response_format() -> None:
    """Validates behavior for chat response from async generator mapping response format.
    """
    async def gen() -> AsyncIterable[ChatResponseUpdate]:
        """Implements gen.
        """
...
def agent_response(chat_message: Message) -> AgentResponse:
    """Implements agent response.
    
    Args:
        chat_message: Description of chat_message.
...
def agent_response_update(text_content: Content) -> AgentResponseUpdate:
    """Implements agent response update.
...
def test_agent_run_response_init_single_message(chat_message: Message) -> None:
    """Validates behavior for agent run response init single message.
...
def test_agent_run_response_init_list_messages(chat_message: Message) -> None:
    """Validates behavior for agent run response init list messages.
...
def test_agent_run_response_init_none_messages() -> None:
    """Validates behavior for agent run response init none messages.
    """
    response = AgentResponse()
...
def test_agent_run_response_text_property(chat_message: Message) -> None:
    """Validates behavior for agent run response text property.
...
def test_agent_run_response_text_property_empty() -> None:
    """Validates behavior for agent run response text property empty.
    """
    response = AgentResponse()
...
def test_agent_run_response_from_updates(agent_response_update: AgentResponseUpdate) -> None:
    """Validates behavior for agent run response from updates.
    
    Args:
        agent_response_update: Description of agent_response_update.
    """
...
def test_agent_run_response_str_method(chat_message: Message) -> None:
    """Validates behavior for agent run response str method.
...
def test_agent_run_response_update_init_content_list(text_content: Content) -> None:
    """Validates behavior for agent run response update init content list.
...
def test_agent_run_response_update_init_none_content() -> None:
    """Validates behavior for agent run response update init none content.
    """
...
def test_agent_run_response_update_text_property(text_content: Content) -> None:
    """Validates behavior for agent run response update text property.
...
def test_agent_run_response_update_text_property_empty() -> None:
    """Validates behavior for agent run response update text property empty.
    """
    update = AgentResponseUpdate()
    assert update.text == ""
...
def test_agent_run_response_update_str_method(text_content: Content) -> None:
    """Validates behavior for agent run response update str method.
...
def test_error_content_str():
    """Validates behavior for error content str.
    """
...
def test_annotations_models_and_roundtrip():
    """Validates behavior for annotations models and roundtrip.
    """
...
def test_function_call_merge_in_process_update_and_usage_aggregation():
    ...
    """Validates behavior for function call merge in process update and usage aggregation.
    """
...
def test_function_call_incompatible_ids_are_not_merged():
    """Validates behavior for function call incompatible ids are not merged.
    """
...
def test_chat_role_str_and_repr():
    ...
    """Validates behavior for chat role str and repr.
    """
    assert "user" == "user"
...
def test_chat_finish_reason_constants():
    ...
    """Validates behavior for chat finish reason constants.
    """
    assert "stop" == "stop"


def test_response_update_propagates_fields_and_metadata():
    """Validates behavior for response update propagates fields and metadata.
    """
...
def test_text_coalescing_preserves_first_serializable_properties():
    """Validates behavior for text coalescing preserves first serializable properties.
    """
...
def test_function_call_content_parse_numeric_or_list():
    """Validates behavior for function call content parse numeric or list.
    """
...
def test_chat_tool_mode_eq_with_string():
    """Validates behavior for chat tool mode eq with string.
    """
...
def agent_run_response_async() -> AgentResponse:
    """Implements agent run response async.
...
async def test_agent_run_response_from_async_generator():
    """Validates behavior for agent run response from async generator.
    """
    async def gen():
        """Implements gen.
        """
...
def test_agent_response_from_updates_preserves_refusal_marker() -> None:
    """Validates behavior for agent response from updates preserves refusal marker.
    """
...
def test_response_coalescing_preserves_model_output_kind_boundaries(
    ...
    """Validates behavior for response coalescing preserves model output kind boundaries.
...
def test_message_roundtrip_preserves_compaction_annotation_dict() -> None:
    """Validates behavior for message roundtrip preserves compaction annotation dict.
    """
    message = Message(
        role="assistant",
        contents=[Content.from_text("Hello")],
...
def test_content_roundtrip_preserves_compaction_annotation_dict() -> None:
    """Validates behavior for content roundtrip preserves compaction annotation dict.
    """
    content = Content.from_text(
        text="Hello",
        additional_properties={
...
def test_chat_response_roundtrip_preserves_compaction_annotation_dict() -> None:
    """Validates behavior for chat response roundtrip preserves compaction annotation dict.
    """
    response = ChatResponse(
        messages=[
            Message(
...
def test_parse_result_text_content_single():
    ...
    class MockTextContent:
        """Represents the MockTextContent type and related behavior.
        """
        text: str
...
def test_parse_result_text_content_with_non_string_text():
    ...
    class BadTextContent:
        """Represents the BadTextContent type and related behavior.
        """
        def __init__(self):
...
class TestResponseStreamFinalizer:
    ...
    async def test_finalizer_receives_all_updates(self) -> None:
        ...
        def capturing_finalizer(updates: list[ChatResponseUpdate]) -> ChatResponse:
            """Implements capturing finalizer.
