...
class TestAgentEvalConverterCompatibility:
    """Represents the TestAgentEvalConverterCompatibility type and related behavior.
    """
    def test_root_export_is_legacy_converter(self) -> None:
        """Validates behavior for root export is legacy converter.
    ...
    def test_convert_messages_preserves_legacy_foundry_wire_format(self) -> None:
        """Validates behavior for convert messages preserves legacy foundry wire format.
    ...
    def test_to_eval_item_delegates_to_provider_neutral_builder(self) -> None:
        """Validates behavior for to eval item delegates to provider neutral builder.
...
class TestToEvalItem:
    """Represents the TestToEvalItem type and related behavior.
    """
    def test_string_query(self) -> None:
        """Validates behavior for string query.
    ...
    def test_message_query(self) -> None:
        """Validates behavior for message query.
    ...
    def test_with_explicit_tools(self) -> None:
        """Validates behavior for with explicit tools.
    ...
    def test_with_agent_and_mcp_tools(self) -> None:
        """Validates behavior for with agent and mcp tools.
    ...
    def test_explicit_tools_override_agent(self) -> None:
        """Validates behavior for explicit tools override agent.
...
class TestEvalItemSplitting:
    """Represents the TestEvalItemSplitting type and related behavior.
    """
    def test_split_messages_format(self) -> None:
        """Validates behavior for split messages format.
    ...
    def test_multiturn_preserves_interleaving(self) -> None:
        """Validates behavior for multiturn preserves interleaving.
    ...
    def test_full_split(self) -> None:
        """Validates behavior for full split.
    ...
    def test_full_split_includes_system_message(self) -> None:
        """Validates behavior for full split includes system message.
    ...
    def test_full_split_puts_tool_interactions_in_response(self) -> None:
        """Validates behavior for full split puts tool interactions in response.
    ...
    def test_last_turn_is_default(self) -> None:
        """Validates behavior for last turn is default.
    ...
    def test_per_turn_items(self) -> None:
        """Validates behavior for per turn items.
    ...
    def test_per_turn_items_preserve_tools(self) -> None:
        """Validates behavior for per turn items preserve tools.
    ...
    def test_per_turn_items_without_user_messages(self) -> None:
        """Validates behavior for per turn items without user messages.
    ...
    def test_per_turn_items_single_turn(self) -> None:
        """Validates behavior for per turn items single turn.
    ...
    def test_custom_splitter_callable(self) -> None:
        """Validates behavior for custom splitter callable.
        ...
        def split_before_memory(messages: list[Message]) -> tuple[list[Message], list[Message]]:
            """Implements split before memory.
    ...
    def test_custom_splitter_fallback(self) -> None:
        """Validates behavior for custom splitter fallback.
    ...
    def test_custom_splitter_lambda(self) -> None:
        """Validates behavior for custom splitter lambda.
    ...
    def test_item_split_strategy_is_default(self) -> None:
        """Validates behavior for item split strategy is default.
    ...
    def test_explicit_split_overrides_item_strategy(self) -> None:
        """Validates behavior for explicit split overrides item strategy.
    ...
    def test_no_split_defaults_to_last_turn(self) -> None:
        """Validates behavior for no split defaults to last turn.
