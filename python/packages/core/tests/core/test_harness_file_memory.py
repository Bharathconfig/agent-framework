"""This module defines functionality for packages/core/tests/core/test_harness_file_memory.
...
async def test_tools_surface_store_value_errors() -> None:
    ...
    class _ValueErrorStore(InMemoryAgentFileStore):
        """Represents the _ValueErrorStore type and related behavior.
        """
...
async def test_before_run_skips_injection_when_index_unreadable() -> None:
    ...
    class _UnreadableIndexStore(InMemoryAgentFileStore):
        """Represents the _UnreadableIndexStore type and related behavior.
        """
        async def read(self, path: str) -> str | None:
            """Implements read.
