"""This module defines functionality for packages/core/tests/core/test_clients.
...
class _NoOpChatMiddleware(ChatMiddleware):
    """Represents the _NoOpChatMiddleware type and related behavior.
    """
...
class _TupleMessagesChatMiddleware(ChatMiddleware):
    """Represents the _TupleMessagesChatMiddleware type and related behavior.
    """
    async def process(self, context: Any, call_next: Any) -> None:
        """Implements process.
...
class _RestoreMessagesChatMiddleware(ChatMiddleware):
    """Represents the _RestoreMessagesChatMiddleware type and related behavior.
    """
    async def process(self, context: Any, call_next: Any) -> None:
        """Implements process.
...
class _FixedSummarizer:
    """Represents the _FixedSummarizer type and related behavior.
    """
...
def test_chat_client_type(client: SupportsChatGetResponse):
    """Validates behavior for chat client type.
...
async def test_chat_client_get_response(client: SupportsChatGetResponse):
    """Validates behavior for chat client get response.
...
async def test_chat_client_get_response_streaming(client: SupportsChatGetResponse):
    """Validates behavior for chat client get response streaming.
...
def test_base_client(chat_client_base: SupportsChatGetResponse):
    """Validates behavior for base client.
...
def test_base_client_rejects_direct_additional_properties(chat_client_base: SupportsChatGetResponse) -> None:
    """Validates behavior for base client rejects direct additional properties.
...
def test_base_client_as_agent_uses_explicit_additional_properties(chat_client_base: SupportsChatGetResponse) -> None:
    """Validates behavior for base client as agent uses explicit additional properties.
...
def test_base_client_as_agent_rejects_function_invocation_configuration(
    ...
    """Validates behavior for base client as agent rejects function invocation configuration.
...
async def test_base_client_get_response_uses_explicit_client_kwargs(chat_client_base: SupportsChatGetResponse) -> None:
    """Validates behavior for base client get response uses explicit client kwargs.
    ...
    async def fake_inner_get_response(**kwargs):
        """Implements fake inner get response.
...
async def test_base_client_get_response(chat_client_base: SupportsChatGetResponse):
    """Validates behavior for base client get response.
...
async def test_base_client_get_response_streaming(chat_client_base: SupportsChatGetResponse):
    """Validates behavior for base client get response streaming.
...
async def test_base_client_applies_compaction_before_non_streaming_inner_call(
    ...
    """Validates behavior for base client applies compaction before non streaming inner call.
...
async def test_base_client_applies_compaction_before_streaming_inner_call(
    ...
    """Validates behavior for base client applies compaction before streaming inner call.
...
async def test_base_client_per_call_compaction_override_applies_before_inner_call(
    ...
    """Validates behavior for base client per call compaction override applies before inner call.
...
async def test_base_client_per_call_tokenizer_override_annotates_messages(
    ...
    """Validates behavior for base client per call tokenizer override annotates messages.
...
async def test_base_client_per_call_tokenizer_override_without_strategy_annotates_messages(
    ...
    """Validates behavior for base client per call tokenizer override without strategy annotates messages.
...
async def test_base_client_default_tokenizer_without_strategy_annotates_messages(
    ...
    """Validates behavior for base client default tokenizer without strategy annotates messages.
...
def _is_tool_result_summary(message: Message) -> bool:
    """Implements  is tool result summary.
...
async def test_function_loop_persists_inserted_summaries_across_iterations(
    ...
    """Validates behavior for function loop persists inserted summaries across iterations.
    
    Args:
        chat_client_base: Description of chat_client_base.
        chat_middleware: Description of chat_middleware.
...
async def test_function_loop_persists_inserted_summaries_across_iterations_streaming(
    ...
    """Validates behavior for function loop persists inserted summaries across iterations streaming.
    
    Args:
        chat_client_base: Description of chat_client_base.
        with_chat_middleware: Description of with_chat_middleware.
...
async def test_function_loop_compaction_conversation_id_mode_does_not_resend_history(
    ...
    """Validates behavior for function loop compaction conversation id mode does not resend history.
    ...
    def _conversation_tool_call(call_id: str, location: str) -> ChatResponse:
        """Implements  conversation tool call.
...
async def test_chat_middleware_does_not_persist_summary_of_middleware_messages(
    ...
    """Validates behavior for chat middleware does not persist summary of middleware messages.
    
    Args:
        chat_client_base: Description of chat_client_base.
    """
    class _InsertEphemeralMessage(ChatMiddleware):
        """Represents the _InsertEphemeralMessage type and related behavior.
        """
        async def process(self, context: Any, call_next: Any) -> None:
            """Implements process.
...
async def test_chat_middleware_reconciles_compaction_before_downstream(
    ...
    """Validates behavior for chat middleware reconciles compaction before downstream.
    
    Args:
        chat_client_base: Description of chat_client_base.
        continue_pipeline: Description of continue_pipeline.
    """
    class _CompactBeforeDownstream(ChatMiddleware):
        """Represents the _CompactBeforeDownstream type and related behavior.
        """
        async def process(self, context: Any, call_next: Any) -> None:
            """Implements process.
...
async def test_chat_middleware_reconciles_compaction_before_termination_and_restore(
    ...
    """Validates behavior for chat middleware reconciles compaction before termination and restore.
    
    Args:
        chat_client_base: Description of chat_client_base.
    """
    class _RestoreAfterCall(ChatMiddleware):
        """Represents the _RestoreAfterCall type and related behavior.
        """
        async def process(self, context: Any, call_next: Any) -> None:
            """Implements process.
    ...
    class _CompactAndTerminate(ChatMiddleware):
        """Represents the _CompactAndTerminate type and related behavior.
        """
        async def process(self, context: Any, call_next: Any) -> None:
            """Implements process.
...
async def test_chat_middleware_reconciles_nested_compaction_summaries(
    ...
    """Validates behavior for chat middleware reconciles nested compaction summaries.
    
    Args:
        chat_client_base: Description of chat_client_base.
    """
    class _CompactToolsBeforeDownstream(ChatMiddleware):
        """Represents the _CompactToolsBeforeDownstream type and related behavior.
        """
        async def process(self, context: Any, call_next: Any) -> None:
            """Implements process.
...
async def test_chat_middleware_persists_compaction_summary_when_model_call_fails(
    ...
    """Validates behavior for chat middleware persists compaction summary when model call fails.
    
    Args:
        chat_client_base: Description of chat_client_base.
    """
    async def _raise_after_compaction(**kwargs: Any) -> ChatResponse:
        """Implements  raise after compaction.
...
def test_base_client_as_agent_does_not_copy_client_compaction_defaults(
    ...
    """Validates behavior for base client as agent does not copy client compaction defaults.
...
async def test_chat_client_instructions_handling(chat_client_base: SupportsChatGetResponse):
    """Validates behavior for chat client instructions handling.
