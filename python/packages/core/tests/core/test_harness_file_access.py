"""This module defines functionality for packages/core/tests/core/test_harness_file_access.
...
class _ContentOnlyStore(AgentFileStore):
    ...
    async def write(self, path: str, content: str, *, overwrite: bool = True) -> None:
        ...
        Args:
            ...
            content: Description of content.
            overwrite: Description of overwrite.
        """
    ...
    async def search(
        ...
        *,
        ...
        Args:
            self: Description of self.
            directory: Description of directory.
            regex_pattern: Description of regex_pattern.
            glob_pattern: Description of glob_pattern.
...
async def test_base_search_reapplies_glob_and_recursion_when_a_store_over_returns() -> None:
    ...
    class _OverReturningStore(_ContentOnlyStore):
        """Represents the _OverReturningStore type and related behavior.
        """
        async def find_matching_files(
            ...
            *,
            ...
            """Implements find matching files.
...
async def test_base_search_skips_files_read_cannot_decode() -> None:
    ...
    class _PartlyUnreadableStore(_ContentOnlyStore):
        """Represents the _PartlyUnreadableStore type and related behavior.
        """
        async def read(self, path: str) -> str | None:
            """Implements read.
