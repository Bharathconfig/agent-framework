"""This module defines functionality for packages/core/tests/core/test_agents.
...
class _FixedTokenizer:
    """Represents the _FixedTokenizer type and related behavior.
    """
    def __init__(self, token_count: int) -> None:
        ...
        Args:
            ...
            token_count: Description of token_count.
        """
...
class _ConnectedMCPTool(MCPTool):
    """Represents the _ConnectedMCPTool type and related behavior.
    """
    def __init__(self, name: str, function_names: list[str], *, tool_name_prefix: str | None = None) -> None:
        ...
        Args:
            ...
            function_names: Description of function_names.
...
class _RecordingHistoryProvider(HistoryProvider):
    """Represents the _RecordingHistoryProvider type and related behavior.
    """
...
class _ResponseIdRecordingHistoryProvider(_RecordingHistoryProvider):
    """Represents the _ResponseIdRecordingHistoryProvider type and related behavior.
    """
    async def after_run(
        self,
        *,
...
class _ResponseMetadataRecordingHistoryProvider(_RecordingHistoryProvider):
    """Represents the _ResponseMetadataRecordingHistoryProvider type and related behavior.
    """
...
def test_agent_session_type(agent_session: AgentSession) -> None:
    """Validates behavior for agent session type.
    
    Args:
        agent_session: Description of agent_session.
    """
    assert isinstance(agent_session, AgentSession)


def test_agent_type(agent: SupportsAgentRun) -> None:
    """Validates behavior for agent type.
...
async def test_agent_run(agent: SupportsAgentRun) -> None:
    """Validates behavior for agent run.
...
async def test_agent_run_with_content(agent: SupportsAgentRun) -> None:
    """Validates behavior for agent run with content.
...
async def test_agent_run_streaming(agent: SupportsAgentRun) -> None:
    """Validates behavior for agent run streaming.
...
def test_chat_client_agent_type(client: SupportsChatGetResponse) -> None:
    """Validates behavior for chat client agent type.
...
def test_chat_client_agent_uses_client_model_attribute(chat_client_base) -> None:
    """Validates behavior for chat client agent uses client model attribute.
...
def test_chat_client_agent_prefers_default_model_over_client_model(chat_client_base) -> None:
    """Validates behavior for chat client agent prefers default model over client model.
...
def test_agent_init_docstring_surfaces_raw_agent_constructor_docs() -> None:
    """Validates behavior for agent init docstring surfaces raw agent constructor docs.
    """
...
def test_agent_run_docstring_surfaces_raw_agent_runtime_docs() -> None:
    """Validates behavior for agent run docstring surfaces raw agent runtime docs.
    """
...
def test_agent_run_is_defined_on_agent_class() -> None:
    """Validates behavior for agent run is defined on agent class.
    """
...
async def test_chat_client_agent_init(client: SupportsChatGetResponse) -> None:
    """Validates behavior for chat client agent init.
...
async def test_chat_client_agent_init_with_name(
    ...
    """Validates behavior for chat client agent init with name.
...
def test_agent_init_rejects_direct_additional_properties(client: SupportsChatGetResponse) -> None:
    """Validates behavior for agent init rejects direct additional properties.
...
async def test_chat_client_agent_run(client: SupportsChatGetResponse) -> None:
    """Validates behavior for chat client agent run.
...
async def test_chat_client_agent_run_streaming(client: SupportsChatGetResponse) -> None:
    """Validates behavior for chat client agent run streaming.
...
async def test_chat_client_agent_streaming_response_format_from_default_options(
    ...
    class Greeting(BaseModel):
        """Represents the Greeting type and related behavior.
        """
        greeting: str
...
async def test_chat_client_agent_create_session(
    ...
    """Validates behavior for chat client agent create session.
...
async def test_chat_client_agent_prepare_session_and_messages(
    ...
    """Validates behavior for chat client agent prepare session and messages.
...
async def test_prepare_session_does_not_mutate_agent_chat_options(
    ...
    """Validates behavior for prepare session does not mutate agent chat options.
...
async def test_prepare_run_context_handles_function_kwargs(
    ...
    """Validates behavior for prepare run context handles function kwargs.
...
async def test_chat_agent_persists_history_per_service_call(
    ...
    """Validates behavior for chat agent persists history per service call.
...
async def test_message_injection_persists_each_injected_service_call(
    ...
    """Validates behavior for message injection persists each injected service call.
...
async def test_per_service_call_history_provider_receives_full_agent_response_metadata(
    ...
    """Validates behavior for per service call history provider receives full agent response metadata.
...
async def test_chat_agent_persists_history_per_service_call_streaming(
    ...
    """Validates behavior for chat agent persists history per service call streaming.
...
async def test_streaming_per_service_call_persistence_hides_response_id_from_after_run(
    ...
    """Validates behavior for streaming per service call persistence hides response id from after run.
...
async def test_per_service_call_persistence_uses_real_service_storage_when_client_stores_by_default(
    ...
    """Validates behavior for per service call persistence uses real service storage when client stores by default.
...
async def test_service_storage_updates_session_handle_per_service_call_before_non_streaming_failure(
    ...
    """Validates behavior for service storage updates session handle per service call before non streaming failure.
...
async def test_service_storage_updates_session_handle_per_service_call_before_streaming_failure(
    ...
    """Validates behavior for service storage updates session handle per service call before streaming failure.
    ...
    async def _first_stream_updates() -> AsyncIterable[ChatResponseUpdate]:
        """Implements  first stream updates.
        """
    ...
    def _finalize_first_stream(_updates: Sequence[ChatResponseUpdate]) -> ChatResponse[Any]:
        """Implements  finalize first stream.
        
        Args:
            _updates: Description of _updates.
...
async def test_chat_agent_without_per_service_call_persistence_preserves_response_id(
    ...
    """Validates behavior for chat agent without per service call persistence preserves response id.
...
async def test_per_service_call_persistence_rejects_real_service_conversation_id(
    ...
    """Validates behavior for per service call persistence rejects real service conversation id.
...
async def test_per_service_call_persistence_rejects_existing_conversation_id_when_service_not_storing_history(
    ...
    """Validates behavior for per service call persistence rejects existing conversation id when service not storing history.
...
async def test_chat_client_agent_run_with_session(chat_client_base: SupportsChatGetResponse) -> None:
    """Validates behavior for chat client agent run with session.
...
async def test_chat_client_agent_updates_existing_session_id_non_streaming(
    ...
    """Validates behavior for chat client agent updates existing session id non streaming.
...
async def test_chat_client_agent_update_session_id_streaming_uses_conversation_id(
    ...
    """Validates behavior for chat client agent update session id streaming uses conversation id.
...
async def test_chat_client_agent_updates_existing_session_id_streaming(
    ...
    """Validates behavior for chat client agent updates existing session id streaming.
...
async def test_chat_client_agent_update_session_id_streaming_does_not_use_response_id(
    ...
    """Validates behavior for chat client agent update session id streaming does not use response id.
...
async def test_chat_client_agent_update_session_messages(
    ...
    """Validates behavior for chat client agent update session messages.
...
async def test_chat_client_agent_update_session_conversation_id_missing(
    ...
    """Validates behavior for chat client agent update session conversation id missing.
...
async def test_chat_client_agent_default_author_name(
    ...
    """Validates behavior for chat client agent default author name.
...
async def test_chat_client_agent_author_name_as_agent_name(
    ...
    """Validates behavior for chat client agent author name as agent name.
...
async def test_chat_client_agent_author_name_is_used_from_response(
    ...
    """Validates behavior for chat client agent author name is used from response.
...
class MockContextProvider(ContextProvider):
    """Represents the MockContextProvider type and related behavior.
    """
...
async def test_context_provider_receives_full_agent_response_non_streaming(
    ...
    class CapturingContextProvider(ContextProvider):
        """Represents the CapturingContextProvider type and related behavior.
        """
...
async def test_chat_agent_as_tool_with_async_stream_callback(
    ...
    async def async_stream_callback(update: AgentResponseUpdate) -> None:
        """Implements async stream callback.
...
async def test_agent_run_raises_on_local_and_agent_mcp_name_conflict(chat_client_base: Any) -> None:
    """Validates behavior for agent run raises on local and agent mcp name conflict.
...
async def test_agent_run_raises_on_runtime_local_and_runtime_mcp_name_conflict(chat_client_base: Any) -> None:
    """Validates behavior for agent run raises on runtime local and runtime mcp name conflict.
...
async def test_agent_run_raises_on_duplicate_agent_mcp_names(chat_client_base: Any) -> None:
    """Validates behavior for agent run raises on duplicate agent mcp names.
...
async def test_agent_run_accepts_prefixed_mcp_tools(chat_client_base: Any) -> None:
    """Validates behavior for agent run accepts prefixed mcp tools.
...
async def test_agent_tool_receives_explicit_session_via_function_invocation_context_kwargs(
    ...
    def capture_session_context(text: str, ctx: FunctionInvocationContext) -> str:
        """Implements capture session context.
...
async def test_chat_agent_compaction_overrides_client_defaults(chat_client_base: Any) -> None:
    """Validates behavior for chat agent compaction overrides client defaults.
...
async def test_chat_agent_uses_client_compaction_defaults_when_agent_unset(chat_client_base: Any) -> None:
    """Validates behavior for chat agent uses client compaction defaults when agent unset.
...
async def test_chat_agent_run_level_compaction_and_tokenizer_override_agent_defaults(chat_client_base: Any) -> None:
    """Validates behavior for chat agent run level compaction and tokenizer override agent defaults.
...
def test_merge_options_tools_combined():
    ...
    class MockTool:
        """Represents the MockTool type and related behavior.
        """
...
async def test_chat_agent_context_provider_adds_instructions_when_agent_has_none(
    ...
    class InstructionContextProvider(ContextProvider):
        """Represents the InstructionContextProvider type and related behavior.
        """
        def __init__(self):
            """Initializes a new instance.
...
async def test_chat_agent_context_provider_adds_middleware_when_agent_has_none(
    ...
    async def context_chat_middleware(context: ChatContext, call_next: Callable[[], Awaitable[None]]) -> None:
        """Implements context chat middleware.
    ...
    class MiddlewareContextProvider(ContextProvider):
        """Represents the MiddlewareContextProvider type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            stores_by_default: Description of stores_by_default.
            script: Description of script.
            echo_conversation_id: Description of echo_conversation_id.
            **kwargs: Description of kwargs.
        """
...
def _psc_build_agent(
    ...
    *,
    ...
    """Implements  psc build agent.
    
    Args:
        client: Description of client.
        provider: Description of provider.
        require_per_service_call_history_persistence: Description of require_per_service_call_history_persistence.
        default_options: Description of default_options.
