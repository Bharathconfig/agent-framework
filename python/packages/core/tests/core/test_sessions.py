"""This module defines functionality for packages/core/tests/core/test_sessions.
...
class TestSessionContext:
    """Represents the TestSessionContext type and related behavior.
    """
    def test_init_defaults(self) -> None:
        """Validates behavior for init defaults.
    ...
    def test_extend_messages_creates_key(self) -> None:
        """Validates behavior for extend messages creates key.
    ...
    def test_extend_messages_appends_to_existing(self) -> None:
        """Validates behavior for extend messages appends to existing.
    ...
    def test_extend_messages_preserves_source_order(self) -> None:
        """Validates behavior for extend messages preserves source order.
    ...
    def test_extend_messages_sets_attribution(self) -> None:
        """Validates behavior for extend messages sets attribution.
    ...
    def test_extend_messages_does_not_overwrite_existing_attribution(self) -> None:
        """Validates behavior for extend messages does not overwrite existing attribution.
    ...
    def test_extend_messages_copies_messages(self) -> None:
        """Validates behavior for extend messages copies messages.
    ...
    def test_extend_messages_sender_sets_source_type(self) -> None:
        """Validates behavior for extend messages sender sets source type.
        
        Args:
            self: Description of self.
        """
        class MyProvider:
            """Represents the MyProvider type and related behavior.
            """
            source_id = "rag"
    ...
    def test_extend_messages_origin_session_ids_default_omits_field(self) -> None:
        """Validates behavior for extend messages origin session ids default omits field.
    ...
    def test_extend_messages_origin_session_ids_recorded_on_attribution(self) -> None:
        """Validates behavior for extend messages origin session ids recorded on attribution.
    ...
    def test_extend_messages_origin_session_ids_with_provider_object(self) -> None:
        """Validates behavior for extend messages origin session ids with provider object.
        
        Args:
            self: Description of self.
        """
        class MyMemoryProvider:
            """Represents the MyMemoryProvider type and related behavior.
            """
            source_id = "memory"
    ...
    def test_extend_messages_applies_all_origins_to_each_message(self) -> None:
        """Validates behavior for extend messages applies all origins to each message.
    ...
    def test_extend_messages_adds_origin_to_existing_attribution(self) -> None:
        """Validates behavior for extend messages adds origin to existing attribution.
    ...
    def test_extend_instructions_string(self) -> None:
        """Validates behavior for extend instructions string.
    ...
    def test_extend_instructions_sequence(self) -> None:
        """Validates behavior for extend instructions sequence.
    ...
    def test_extend_middleware_creates_key_and_appends(self) -> None:
        """Validates behavior for extend middleware creates key and appends.
    ...
    def test_extend_middleware_preserves_source_order(self) -> None:
        """Validates behavior for extend middleware preserves source order.
    ...
    def test_extend_middleware_rejects_agent_middleware(self) -> None:
        """Validates behavior for extend middleware rejects agent middleware.
        ...
        async def provider_agent_middleware(context: AgentContext, call_next: Callable[[], Awaitable[None]]) -> None:
            """Implements provider agent middleware.
    ...
    def test_get_messages_all(self) -> None:
        """Validates behavior for get messages all.
    ...
    def test_get_messages_filter_sources(self) -> None:
        """Validates behavior for get messages filter sources.
    ...
    def test_get_messages_exclude_sources(self) -> None:
        """Validates behavior for get messages exclude sources.
    ...
    def test_get_messages_include_input(self) -> None:
        """Validates behavior for get messages include input.
    ...
    def test_get_messages_include_response(self) -> None:
        """Validates behavior for get messages include response.
    ...
    def test_response_readonly(self) -> None:
        """Validates behavior for response readonly.
    ...
    def test_local_history_conversation_id_sentinel(self) -> None:
        """Validates behavior for local history conversation id sentinel.
...
class TestContextProvider:
    """Represents the TestContextProvider type and related behavior.
    """
    def test_source_id_required(self) -> None:
        """Validates behavior for source id required.
    ...
    async def test_before_run_is_noop(self) -> None:
        """Validates behavior for before run is noop.
    ...
    async def test_after_run_is_noop(self) -> None:
        """Validates behavior for after run is noop.
...
class ConcreteHistoryProvider(HistoryProvider):
    ...
    def __init__(self, source_id: str, stored_messages: list[Message] | None = None, **kwargs) -> None:
        ...
        Args:
            ...
            stored_messages: Description of stored_messages.
...
def test_filter_approval_controls_preserves_only_unresolved_occurrences() -> None:
    """Validates behavior for filter approval controls preserves only unresolved occurrences.
    """
...
def test_filter_approval_controls_deduplicates_pending_request_replay() -> None:
    """Validates behavior for filter approval controls deduplicates pending request replay.
    """
...
def test_filter_approval_controls_keeps_response_for_pending_placeholder() -> None:
    """Validates behavior for filter approval controls keeps response for pending placeholder.
    """
...
class TestHistoryProviderBase:
    """Represents the TestHistoryProviderBase type and related behavior.
    """
    def test_default_flags(self) -> None:
        """Validates behavior for default flags.
    ...
    def test_custom_flags(self) -> None:
        """Validates behavior for custom flags.
    ...
    async def test_before_run_loads_messages(self) -> None:
        """Validates behavior for before run loads messages.
    ...
    async def test_after_run_stores_inputs_and_responses(self) -> None:
        """Validates behavior for after run stores inputs and responses.
    ...
    async def test_after_run_stores_coalesced_code_interpreter_chunks(self) -> None:
        """Validates behavior for after run stores coalesced code interpreter chunks.
    ...
    async def test_after_run_skips_inputs_when_disabled(self) -> None:
        """Validates behavior for after run skips inputs when disabled.
    ...
    async def test_after_run_skips_responses_when_disabled(self) -> None:
        """Validates behavior for after run skips responses when disabled.
    ...
    async def test_after_run_stores_context_messages(self) -> None:
        """Validates behavior for after run stores context messages.
    ...
    async def test_after_run_stores_context_from_specific_sources(self) -> None:
        """Validates behavior for after run stores context from specific sources.
...
class TestAgentSession:
    """Represents the TestAgentSession type and related behavior.
    """
    def test_auto_generates_session_id(self) -> None:
        """Validates behavior for auto generates session id.
    ...
    def test_custom_session_id(self) -> None:
        """Validates behavior for custom session id.
    ...
    def test_state_starts_empty(self) -> None:
        """Validates behavior for state starts empty.
    ...
    def test_service_session_id(self) -> None:
        """Validates behavior for service session id.
    ...
    def test_service_session_id_accepts_structured_mapping(self) -> None:
        """Validates behavior for service session id accepts structured mapping.
    ...
    def test_to_dict(self) -> None:
        """Validates behavior for to dict.
    ...
    def test_from_dict(self) -> None:
        """Validates behavior for from dict.
    ...
    def test_roundtrip(self) -> None:
        """Validates behavior for roundtrip.
    ...
    def test_roundtrip_with_structured_service_session_id(self) -> None:
        """Validates behavior for roundtrip with structured service session id.
    ...
    def test_from_dict_missing_state(self) -> None:
        """Validates behavior for from dict missing state.
...
class _RegisteredSessionState:
    """Represents the _RegisteredSessionState type and related behavior.
    """
    ...
    def _get_type_identifier(cls) -> str:
        """Implements  get type identifier.
...
class TestStateTypeRegistry:
    """Represents the TestStateTypeRegistry type and related behavior.
    """
    def test_same_registration_is_idempotent(self) -> None:
        """Validates behavior for same registration is idempotent.
    ...
    def test_type_constant_is_used_as_default_identifier(self) -> None:
        """Validates behavior for type constant is used as default identifier.
        ...
        class TypeConstantState:
            """Represents the TypeConstantState type and related behavior.
            """
    ...
    def test_custom_encoder_and_decoder_support_plain_classes(self) -> None:
        """Validates behavior for custom encoder and decoder support plain classes.
        ...
        @dataclass
        class CallbackState:
            """Represents the CallbackState type and related behavior.
            """
            value: str
    ...
    def test_explicit_pydantic_registration_round_trips(self) -> None:
        """Validates behavior for explicit pydantic registration round trips.
        ...
        class PydanticState(BaseModel):
            """Represents the PydanticState type and related behavior.
            """
            value: str
    ...
    def test_conflicting_type_identifier_is_rejected(self) -> None:
        """Validates behavior for conflicting type identifier is rejected.
        ...
        """
        class FirstState:
            """Represents the FirstState type and related behavior.
            """
            def to_dict(self) -> dict[str, Any]:
                """Implements to dict.
        ...
        class SecondState(FirstState):
            """Represents the SecondState type and related behavior.
            """
            pass
    ...
    def test_unregistered_to_dict_object_preserves_legacy_serialization(self) -> None:
        """Validates behavior for unregistered to dict object preserves legacy serialization.
        ...
        class UnregisteredState:
            """Represents the UnregisteredState type and related behavior.
            """
            def to_dict(self) -> dict[str, Any]:
                """Implements to dict.
    ...
    def test_unregistered_container_subclass_uses_to_dict(self) -> None:
        """Validates behavior for unregistered container subclass uses to dict.
        ...
        class MappingState(dict[str, Any]):
            """Represents the MappingState type and related behavior.
            """
            def to_dict(self) -> dict[str, Any]:
                """Implements to dict.
    ...
    def test_unregistered_pydantic_model_preserves_legacy_round_trip(self) -> None:
        """Validates behavior for unregistered pydantic model preserves legacy round trip.
        ...
        class AutoRegisteredPydanticState(BaseModel):
            """Represents the AutoRegisteredPydanticState type and related behavior.
            """
            value: str
    ...
    def test_unknown_type_tag_remains_a_raw_dict(self) -> None:
        """Validates behavior for unknown type tag remains a raw dict.
    ...
    def test_registered_child_tag_does_not_hijack_message_payload(self) -> None:
        """Validates behavior for registered child tag does not hijack message payload.
        ...
        @dataclass
        class TextState:
            """Represents the TextState type and related behavior.
            """
            value: str
    ...
    def test_non_finite_float_preserves_legacy_dictionary_serialization(self, value: float) -> None:
        """Validates behavior for non finite float preserves legacy dictionary serialization.
...
class TestSessionStore:
    """Represents the TestSessionStore type and related behavior.
    """
    def test_is_marked_experimental(self) -> None:
        """Validates behavior for is marked experimental.
    ...
    async def test_get_returns_none_for_missing_id(self) -> None:
        """Validates behavior for get returns none for missing id.
    ...
    async def test_set_then_get_returns_independent_copy(self) -> None:
        """Validates behavior for set then get returns independent copy.
    ...
    async def test_set_stores_independent_snapshot(self) -> None:
        """Validates behavior for set stores independent snapshot.
    ...
    async def test_set_replaces_existing_entry(self) -> None:
        """Validates behavior for set replaces existing entry.
    ...
    async def test_delete_forgets_session(self) -> None:
        """Validates behavior for delete forgets session.
    ...
    async def test_accepts_opaque_non_empty_session_id(self, session_id: str) -> None:
        """Validates behavior for accepts opaque non empty session id.
    ...
    async def test_empty_session_id_raises(self) -> None:
        """Validates behavior for empty session id raises.
    ...
    async def test_operations_mark_feature_usage(self, operation: str) -> None:
        """Validates behavior for operations mark feature usage.
...
class TestFileSessionStore:
    """Represents the TestFileSessionStore type and related behavior.
    """
    @pytest.mark.parametrize("operation", ["get", "set", "delete"])
    ...
    async def test_round_trips_session_across_store_instances(self, tmp_path: Path) -> None:
        """Validates behavior for round trips session across store instances.
    ...
    async def test_round_trips_binary_messagepack_session(self, tmp_path: Path) -> None:
        """Validates behavior for round trips binary messagepack session.
    ...
    async def test_rejects_custom_agent_session_subclass(self, tmp_path: Path) -> None:
        """Validates behavior for rejects custom agent session subclass.
        ...
        class CustomAgentSession(AgentSession):
            """Represents the CustomAgentSession type and related behavior.
            """
            pass
    ...
    async def test_unregistered_to_dict_state_preserves_legacy_durable_serialization(self, tmp_path: Path) -> None:
        """Validates behavior for unregistered to dict state preserves legacy durable serialization.
    ...
    async def test_unregistered_pydantic_state_warns_for_durable_serialization(self, tmp_path: Path) -> None:
        """Validates behavior for unregistered pydantic state warns for durable serialization.
        ...
        class DurableAutoRegisteredPydanticState(BaseModel):
            """Represents the DurableAutoRegisteredPydanticState type and related behavior.
            """
            value: str
    ...
    async def test_unsupported_state_object_is_rejected_for_durable_storage(self, tmp_path: Path) -> None:
        """Validates behavior for unsupported state object is rejected for durable storage.
        ...
        class UnsupportedState:
            """Represents the UnsupportedState type and related behavior.
            """
            pass
    ...
    async def test_non_finite_state_is_rejected_for_durable_storage(self, tmp_path: Path, value: float) -> None:
        """Validates behavior for non finite state is rejected for durable storage.
    ...
    async def test_missing_and_deleted_sessions_return_none(self, tmp_path: Path) -> None:
        """Validates behavior for missing and deleted sessions return none.
    ...
    async def test_set_replaces_atomically_without_leaving_temp_files(self, tmp_path: Path) -> None:
        """Validates behavior for set replaces atomically without leaving temp files.
    ...
    async def test_corrupt_session_file_is_quarantined_and_retry_returns_none(self, tmp_path: Path) -> None:
        """Validates behavior for corrupt session file is quarantined and retry returns none.
    ...
    async def test_invalid_registered_payload_preserves_snapshot(self, tmp_path: Path) -> None:
        """Validates behavior for invalid registered payload preserves snapshot.
    ...
    async def test_registered_decoder_attribute_error_preserves_snapshot(self, tmp_path: Path) -> None:
        """Validates behavior for registered decoder attribute error preserves snapshot.
    ...
    async def test_unsupported_snapshot_version_preserves_snapshot(self, tmp_path: Path) -> None:
        """Validates behavior for unsupported snapshot version preserves snapshot.
    ...
    async def test_invalid_snapshot_schema_preserves_snapshot(self, tmp_path: Path) -> None:
        """Validates behavior for invalid snapshot schema preserves snapshot.
    ...
    async def test_corrupt_quarantine_does_not_remove_concurrent_replacement(
        ...
        """Validates behavior for corrupt quarantine does not remove concurrent replacement.
        ...
        def blocking_quarantine(file_path: Path, serialized: bytes) -> Path | None:
            """Implements blocking quarantine.
            
            Args:
                file_path: Description of file_path.
                serialized: Description of serialized.
    ...
    async def test_invalid_session_id_raises(self, tmp_path: Path, session_id: str) -> None:
        """Validates behavior for invalid session id raises.
    ...
    async def test_opaque_session_id_round_trips_through_safe_filename(
        ...
        """Validates behavior for opaque session id round trips through safe filename.
        
        Args:
            self: Description of self.
            tmp_path: Description of tmp_path.
            session_id: Description of session_id.
            is_encoded: Description of is_encoded.
        """
        store = FileSessionStore(tmp_path)
    ...
    async def test_rejects_symlinked_session_file_within_storage_root(self, tmp_path: Path) -> None:
        """Validates behavior for rejects symlinked session file within storage root.
    ...
    async def test_reserved_windows_filename_is_encoded(self, tmp_path: Path, session_id: str) -> None:
        """Validates behavior for reserved windows filename is encoded.
...
class TestInMemoryHistoryProvider:
    """Represents the TestInMemoryHistoryProvider type and related behavior.
    """
    async def test_empty_state_returns_no_messages(self) -> None:
        """Validates behavior for empty state returns no messages.
    ...
    async def test_stores_and_loads_messages(self) -> None:
        """Validates behavior for stores and loads messages.
    ...
    async def test_state_is_serializable(self) -> None:
        """Validates behavior for state is serializable.
    ...
    async def test_source_id_attribution(self) -> None:
        """Validates behavior for source id attribution.
    ...
    async def test_save_messages_handles_replayed_transcript_with_duplicates(self) -> None:
        """Validates behavior for save messages handles replayed transcript with duplicates.
...
class TestFileHistoryProvider:
    """Represents the TestFileHistoryProvider type and related behavior.
    """
    def test_is_marked_experimental(self) -> None:
        """Validates behavior for is marked experimental.
    ...
    def test_uses_msgspec_json_by_default(self, tmp_path: Path) -> None:
        """Validates behavior for uses msgspec json by default.
    ...
    async def test_stores_and_loads_length_prefixed_msgpack(self, tmp_path: Path) -> None:
        """Validates behavior for stores and loads length prefixed msgpack.
    ...
    async def test_round_trips_marked_refusal_text(
        ...
        """Validates behavior for round trips marked refusal text.
        
        Args:
            self: Description of self.
            tmp_path: Description of tmp_path.
            serialization_format: Description of serialization_format.
        """
    ...
    def test_msgpack_rejects_custom_json_codecs(self, tmp_path: Path) -> None:
        """Validates behavior for msgpack rejects custom json codecs.
    ...
    def test_custom_json_codecs_are_deprecated(self, tmp_path: Path) -> None:
        """Validates behavior for custom json codecs are deprecated.
    ...
    async def test_preserves_non_finite_json_values(self, tmp_path: Path, value: float) -> None:
        """Validates behavior for preserves non finite json values.
    ...
    async def test_reads_existing_stdlib_non_finite_json(self, tmp_path: Path) -> None:
        """Validates behavior for reads existing stdlib non finite json.
    ...
    def test_creates_storage_directory(self, tmp_path: Path) -> None:
        """Validates behavior for creates storage directory.
    ...
    async def test_uses_encoded_filename_for_unsafe_session_id(self, tmp_path: Path) -> None:
        """Validates behavior for uses encoded filename for unsafe session id.
    ...
    async def test_allows_custom_serializers_returning_bytes(self, tmp_path: Path) -> None:
        """Validates behavior for allows custom serializers returning bytes.
    ...
    async def test_invalid_jsonl_line_raises(self, tmp_path: Path) -> None:
        """Validates behavior for invalid jsonl line raises.
    ...
    async def test_truncated_msgpack_record_raises(self, tmp_path: Path) -> None:
        """Validates behavior for truncated msgpack record raises.
    ...
    async def test_missing_session_file_returns_empty_messages(self, tmp_path: Path) -> None:
        """Validates behavior for missing session file returns empty messages.
    ...
    async def test_none_session_id_uses_default_jsonl_file(self, tmp_path: Path) -> None:
        """Validates behavior for none session id uses default jsonl file.
    ...
    async def test_non_mapping_jsonl_line_raises(self, tmp_path: Path) -> None:
        """Validates behavior for non mapping jsonl line raises.
    ...
    async def test_skip_excluded_omits_excluded_messages(self, tmp_path: Path) -> None:
        """Validates behavior for skip excluded omits excluded messages.
    ...
    async def test_serializer_must_return_single_line_json(self, tmp_path: Path) -> None:
        """Validates behavior for serializer must return single line json.
    ...
    async def test_concurrent_writes_for_same_session_are_locked(
        ...
        """Validates behavior for concurrent writes for same session are locked.
        ...
        class _TrackingFile:
            """Represents the _TrackingFile type and related behavior.
            """
            def __init__(self, wrapped: Any) -> None:
                ...
                Args:
                    self: Description of self.
                    wrapped: Description of wrapped.
                """
...
class TestRunPersistenceGate:
    ...
    def _recording_persist(executed: list[str], label: str) -> Callable[[], Awaitable[None]]:
        """Implements  recording persist.
        
        Args:
            executed: Description of executed.
    ...
    async def test_gate_defers_and_flush_runs_in_order(self) -> None:
        """Validates behavior for gate defers and flush runs in order.
    ...
    async def test_flush_inside_the_scope_raises(self) -> None:
        ...
        """Validates behavior for flush inside the scope raises.
    ...
    def test_reentering_an_active_gate_raises(self) -> None:
        """Validates behavior for reentering an active gate raises.
    ...
    async def test_gate_can_be_reused_sequentially(self) -> None:
        ...
        """Validates behavior for gate can be reused sequentially.
    ...
    async def test_drop_discards_deferred_persistence(self) -> None:
        """Validates behavior for drop discards deferred persistence.
    ...
    async def test_nested_gates_collect_independently(self) -> None:
        """Validates behavior for nested gates collect independently.
    ...
    async def test_suspension_makes_nested_persistence_inline(self) -> None:
        ...
        """Validates behavior for suspension makes nested persistence inline.
    ...
    async def test_reentrant_persist_during_flush_runs_inline(self) -> None:
        ...
        """Validates behavior for reentrant persist during flush runs inline.
    ...
    async def test_bound_gate_defers_only_its_owner_run(self) -> None:
        """Validates behavior for bound gate defers only its owner run.
    ...
    async def test_unbound_gate_defers_only_identity_less_persists(self) -> None:
        ...
        """Validates behavior for unbound gate defers only identity less persists.
    ...
    def test_bind_owner_accepts_every_adopted_identity(self) -> None:
        ...
        """Validates behavior for bind owner accepts every adopted identity.
    ...
    def test_claim_handshake_is_keyed_to_the_agent_instance(self) -> None:
        """Validates behavior for claim handshake is keyed to the agent instance.
    ...
    async def test_flush_runs_callables_with_the_gate_context_suspended(self) -> None:
        ...
        """Validates behavior for flush runs callables with the gate context suspended.
