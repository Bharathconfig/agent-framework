"""This module defines functionality for packages/core/tests/core/test_vectors.
...
with warnings.catch_warnings():
    ...
    @dataclass
    class Record:
        """Represents the Record type and related behavior.
        """
...
class MockEmbeddingClient(BaseEmbeddingClient):
    """Represents the MockEmbeddingClient type and related behavior.
    """
...
class MockCollection(BaseVectorCollection[str, Record], BaseVectorSearch[str, Record]):
    """Represents the MockCollection type and related behavior.
    """
    ...
    def __init__(self, *, embedding_generator: MockEmbeddingClient | None = None) -> None:
        ...
        Args:
            self: Description of self.
            embedding_generator: Description of embedding_generator.
        """
    ...
    async def ensure_collection_exists(
        ...
        *,
        ...
        """Implements ensure collection exists.
        
        Args:
            self: Description of self.
            operation_options: Description of operation_options.
        """
        self.created = True
    ...
    async def ensure_collection_deleted(
        ...
        *,
        ...
        """Implements ensure collection deleted.
    ...
    async def _inner_get(
        ...
        *,
        ...
        Args:
            ...
            order_by: Description of order_by.
            include_vectors: Description of include_vectors.
            operation_options: Description of operation_options.
    ...
    async def _inner_search(
        ...
        *,
        ...
        """Implements  inner search.
        
        Args:
            self: Description of self.
            search_type: Description of search_type.
            filter: Description of filter.
            values: Description of values.
            vector: Description of vector.
            top: Description of top.
            skip: Description of skip.
            include_vectors: Description of include_vectors.
            vector_property_name: Description of vector_property_name.
            additional_property_name: Description of additional_property_name.
            score_threshold: Description of score_threshold.
            operation_options: Description of operation_options.
    ...
    def _get_record_from_result(self, result: Any) -> Any:
        """Implements  get record from result.
    ...
    def _get_score_from_result(self, result: Any) -> float | None:
        """Implements  get score from result.
...
class MockStore(BaseVectorStore):
    """Represents the MockStore type and related behavior.
    """
    ...
    def get_collection(
        ...
        *,
        ...
        """Implements get collection.
        
        Args:
            self: Description of self.
            record_type: Description of record_type.
            definition: Description of definition.
            collection_name: Description of collection_name.
            embedding_generator: Description of embedding_generator.
    ...
    async def list_collection_names(
        ...
        *,
        ...
        """Implements list collection names.
    ...
    async def _inner_ensure_collection_deleted(
        ...
        *,
        ...
        """Implements  inner ensure collection deleted.
...
def test_vector_literal_types_and_distance_directions() -> None:
    """Validates behavior for vector literal types and distance directions.
    """
...
def test_vector_apis_are_marked_experimental() -> None:
    """Validates behavior for vector apis are marked experimental.
    """
    staged_apis = (
        VectorStoreField,
        VectorStoreCollectionDefinition,
...
def test_vector_field_validates_vector_options() -> None:
    """Validates behavior for vector field validates vector options.
    """
...
def test_collection_definition_exposes_fields() -> None:
    """Validates behavior for collection definition exposes fields.
    """
...
def test_collection_definition_rejects_invalid_fields(
    ...
    """Validates behavior for collection definition rejects invalid fields.
...
def test_vectorstoremodel_supports_pydantic_models() -> None:
    """Validates behavior for vectorstoremodel supports pydantic models.
    """
    @vectorstoremodel
    class PydanticRecord(BaseModel):
        """Represents the PydanticRecord type and related behavior.
        """
...
def test_vectorstoremodel_supports_plain_classes() -> None:
    """Validates behavior for vectorstoremodel supports plain classes.
    """
    @vectorstoremodel
    class PlainRecord:
        """Represents the PlainRecord type and related behavior.
        """
        def __init__(
            self,
            id: Annotated[str, VectorStoreField("key")],
...
def test_vectorstoremodel_ignores_fields_with_defaults() -> None:
    """Validates behavior for vectorstoremodel ignores fields with defaults.
    """
    assert (
        "category"
        not in cast(
...
def test_vectorstoremodel_detects_factory_and_required_slotted_defaults() -> None:
    """Validates behavior for vectorstoremodel detects factory and required slotted defaults.
    """
    @vectorstoremodel
    @dataclass(slots=True)
    class FactoryRecord:
        """Represents the FactoryRecord type and related behavior.
        """
        id: Annotated[str, VectorStoreField("key")]
    ...
    class InvalidStruct(msgspec.Struct):
        """Represents the InvalidStruct type and related behavior.
        """
        id: Annotated[str, VectorStoreField("key")]
    ...
    class RequiredVector(msgspec.Struct):
        """Represents the RequiredVector type and related behavior.
        """
        id: Annotated[str, VectorStoreField("key")]
...
def test_vectorstoremodel_rejects_required_unmapped_fields() -> None:
    """Validates behavior for vectorstoremodel rejects required unmapped fields.
    """
    class InvalidRecord:
        """Represents the InvalidRecord type and related behavior.
        """
        id: Annotated[str, VectorStoreField("key")]
        required_but_unmapped: str
...
async def test_collection_and_search_validate_paging() -> None:
    """Validates behavior for collection and search validate paging.
    """
...
def test_record_handler_validates_connector_field_types() -> None:
    """Validates behavior for record handler validates connector field types.
    """
    class IntKeyHandler(VectorStoreRecordHandler[str, Record]):
        """Represents the IntKeyHandler type and related behavior.
        """
...
async def test_record_handler_serializes_dict_records_with_explicit_definition() -> None:
    """Validates behavior for record handler serializes dict records with explicit definition.
    """
...
async def test_batch_serializer_preserves_cardinality() -> None:
    """Validates behavior for batch serializer preserves cardinality.
    
    Returns:
        Description of the return value.
    """
    class DroppingHandler(VectorStoreRecordHandler[Any, Record]):
        """Represents the DroppingHandler type and related behavior.
        """
        def _serialize_dicts_to_store_models(
            ...
            *,
            ...
            """Implements  serialize dicts to store models.
...
async def test_record_handler_supports_msgspec_structs() -> None:
    """Validates behavior for record handler supports msgspec structs.
    """
    @vectorstoremodel
    class MsgspecRecord(msgspec.Struct):
        """Represents the MsgspecRecord type and related behavior.
        """
        id: Annotated[str, VectorStoreField("key")]
        vector: Annotated[list[float] | None, VectorStoreField("vector", dimensions=2)] = None
...
async def test_record_handler_uses_registered_codecs() -> None:
    """Validates behavior for record handler uses registered codecs.
    """
    @dataclass
    class CustomRecord:
        """Represents the CustomRecord type and related behavior.
        """
        id: str
        text: str
...
async def test_register_vectorstoremodel_supports_independent_encoder_override() -> None:
    """Validates behavior for register vectorstoremodel supports independent encoder override.
    ...
    class RegisteredRecord:
        """Represents the RegisteredRecord type and related behavior.
        """
        id: str = ""
...
async def test_array_like_vectors_round_trip_without_array_dependency() -> None:
    """Validates behavior for array like vectors round trip without array dependency.
    
    Returns:
        Description of the return value.
    """
    class ArrayLike:
        """Represents the ArrayLike type and related behavior.
        """
        __slots__ = ("values",)
    ...
    def decode_array_record(record: Mapping[str, Any]) -> ArrayRecord:
        """Implements decode array record.
    ...
    @dataclass
    class ArrayRecord:
        """Represents the ArrayRecord type and related behavior.
        """
        id: Annotated[str, VectorStoreField("key")]
...
async def test_custom_encoder_normalizes_array_like_vectors() -> None:
    """Validates behavior for custom encoder normalizes array like vectors.
    ...
    class CustomArrayRecord:
        """Represents the CustomArrayRecord type and related behavior.
        """
        id: str
        vector: ArrayLike
...
async def test_pydantic_aliases_round_trip_by_field_name() -> None:
    """Validates behavior for pydantic aliases round trip by field name.
    """
    @vectorstoremodel
    class AliasedRecord(BaseModel):
        """Represents the AliasedRecord type and related behavior.
        """
...
async def test_collection_serializes_records_and_generates_vectors() -> None:
    """Validates behavior for collection serializes records and generates vectors.
    """
...
async def test_upsert_controls_embedding_generation() -> None:
    """Validates behavior for upsert controls embedding generation.
    """
    embedding_client = MockEmbeddingClient()
    collection = MockCollection(embedding_generator=embedding_client)
...
async def test_collection_crud_preserves_single_and_batch_shapes() -> None:
    """Validates behavior for collection crud preserves single and batch shapes.
    """
...
async def test_collection_wraps_connector_errors() -> None:
    """Validates behavior for collection wraps connector errors.
    """
...
async def test_collection_get_without_keys_lists_records() -> None:
    """Validates behavior for collection get without keys lists records.
    """
    assert await MockCollection().get() == []


async def test_collection_crud_rejects_singular_ordinary_inputs() -> None:
    """Validates behavior for collection crud rejects singular ordinary inputs.
    """
    collection = MockCollection()
...
async def test_vector_search_generates_query_vector_and_filters_threshold() -> None:
    """Validates behavior for vector search generates query vector and filters threshold.
    """
    embedding_client = MockEmbeddingClient()
    collection = MockCollection(embedding_generator=embedding_client)
    await collection.upsert([
...
async def test_keyword_hybrid_search_uses_single_search_method() -> None:
    """Validates behavior for keyword hybrid search uses single search method.
    """
    collection = MockCollection()
...
async def test_vector_search_validates_inputs_and_supported_type() -> None:
    """Validates behavior for vector search validates inputs and supported type.
    """
    collection = MockCollection()
    ...
    class VectorOnlyCollection(MockCollection):
        """Represents the VectorOnlyCollection type and related behavior.
        """
...
async def test_vector_search_requires_explicit_distance_for_score_threshold() -> None:
    """Validates behavior for vector search requires explicit distance for score threshold.
    """
    collection = MockCollection()
...
async def test_vector_search_wraps_embedding_failures() -> None:
    """Validates behavior for vector search wraps embedding failures.
    """
    class FailingEmbeddingClient(MockEmbeddingClient):
        """Represents the FailingEmbeddingClient type and related behavior.
        """
        async def get_embeddings(
            self,
            values: Sequence[Any],
...
def test_vector_search_builds_connector_filter() -> None:
    """Validates behavior for vector search builds connector filter.
    """
    collection = MockCollection()
...
async def test_vector_search_passes_translated_filter_to_connector() -> None:
    """Validates behavior for vector search passes translated filter to connector.
    """
    collection = MockCollection()
...
def test_vector_search_rejects_filter_without_lambda() -> None:
    """Validates behavior for vector search rejects filter without lambda.
    """
...
async def test_create_search_tool_returns_mapped_results() -> None:
    """Validates behavior for create search tool returns mapped results.
    """
    collection = MockCollection()
...
async def test_create_search_tool_supports_declared_filter_parameters() -> None:
    """Validates behavior for create search tool supports declared filter parameters.
    """
    collection = MockCollection()
    collection.records["one"] = {"record_id": "one", "body": "first", "vector": [1.0, 0.0]}
    tool = create_vector_search_tool(
...
def test_create_search_tool_validates_custom_schema() -> None:
    """Validates behavior for create search tool validates custom schema.
    """
    collection = MockCollection()
...
async def test_create_search_tool_enforces_paging_limits_and_result_cap() -> None:
    """Validates behavior for create search tool enforces paging limits and result cap.
    """
    collection = MockCollection()
...
async def test_create_search_tool_supports_multimodal_results() -> None:
    """Validates behavior for create search tool supports multimodal results.
    """
    collection = MockCollection()
    collection.records["one"] = {"record_id": "one", "body": "first", "vector": [1.0, 0.0]}
    tool = create_vector_search_tool(
...
async def test_create_search_tool_uses_msgspec_for_default_result_mapping() -> None:
    """Validates behavior for create search tool uses msgspec for default result mapping.
    """
    collection = MockCollection()
    collection.records["one"] = {"record_id": "one", "body": "first", "vector": [1.0, 0.0]}
...
async def test_create_search_tool_defers_unsupported_type_to_search() -> None:
    """Validates behavior for create search tool defers unsupported type to search.
    """
    class VectorOnlyCollection(MockCollection):
        """Represents the VectorOnlyCollection type and related behavior.
        """
...
def test_search_protocol_and_tool_factory_only_require_search() -> None:
    """Validates behavior for search protocol and tool factory only require search.
    
    Returns:
        Description of the return value.
    """
    class SearchOnly:
        """Represents the SearchOnly type and related behavior.
        """
        async def search(
            self,
            values: Any,
...
def test_collection_satisfies_vector_protocols() -> None:
    """Validates behavior for collection satisfies vector protocols.
    """
    collection = MockCollection()
...
async def test_vector_store_collection_lifecycle_helpers() -> None:
    """Validates behavior for vector store collection lifecycle helpers.
    """
    collection = MockCollection()
...
def test_search_response_holds_record_and_score() -> None:
    """Validates behavior for search response holds record and score.
    """
...
def test_deserialization_rejects_non_mapping_store_records() -> None:
    """Validates behavior for deserialization rejects non mapping store records.
    """
...
def test_additional_field_and_definition_validation_paths() -> None:
    """Validates behavior for additional field and definition validation paths.
    """
...
async def test_default_codecs_cover_pydantic_plain_and_unsupported_models() -> None:
    """Validates behavior for default codecs cover pydantic plain and unsupported models.
    """
    @vectorstoremodel
    class PydanticRecord(BaseModel):
        """Represents the PydanticRecord type and related behavior.
    ...
    @vectorstoremodel
    class SlottedRecord:
        """Represents the SlottedRecord type and related behavior.
        """
        __slots__ = ("id",)
        id: Annotated[str, VectorStoreField("key")]
...
def test_vectorstoremodel_rejects_unresolvable_or_missing_annotations() -> None:
    """Validates behavior for vectorstoremodel rejects unresolvable or missing annotations.
    """
    class UnresolvableRecord:
        """Represents the UnresolvableRecord type and related behavior.
        """
        __annotations__ = {"id": "MissingRecordType"}

    class EmptyRecord:
        """Represents the EmptyRecord type and related behavior.
        """
        pass
...
def test_registration_is_idempotent_and_rejects_changed_codecs() -> None:
    """Validates behavior for registration is idempotent and rejects changed codecs.
...
def test_record_handler_requires_registered_models_or_explicit_dict_definitions() -> None:
    """Validates behavior for record handler requires registered models or explicit dict definitions.
    """
    class UnregisteredRecord:
        """Represents the UnregisteredRecord type and related behavior.
        """
        pass
...
async def test_serialization_shape_and_embedding_failures() -> None:
    """Validates behavior for serialization shape and embedding failures.
    ...
    class EmptyEmbeddingClient(MockEmbeddingClient):
        """Represents the EmptyEmbeddingClient type and related behavior.
        """
        async def get_embeddings(
            self,
            values: Sequence[Any],
...
async def test_array_like_generated_embeddings_are_normalized() -> None:
    """Validates behavior for array like generated embeddings are normalized.
    ...
    class ArrayEmbeddingClient(MockEmbeddingClient):
        """Represents the ArrayEmbeddingClient type and related behavior.
        """
        async def get_embeddings(
            self,
            values: Sequence[Any],
...
async def test_collection_operation_error_boundaries_and_context_manager() -> None:
    """Validates behavior for collection operation error boundaries and context manager.
    """
    collection = MockCollection()
...
async def test_vector_store_context_and_missing_collection_delete() -> None:
    """Validates behavior for vector store context and missing collection delete.
    """
    collection = MockCollection()
    store = MockStore(collection)
...
async def test_additional_search_validation_and_error_boundaries() -> None:
    """Validates behavior for additional search validation and error boundaries.
    """
    collection = MockCollection()
...
async def test_search_embedding_and_result_conversion_failures() -> None:
    """Validates behavior for search embedding and result conversion failures.
    ...
    class StringEmbeddingClient(MockEmbeddingClient):
        """Represents the StringEmbeddingClient type and related behavior.
        """
        async def get_embeddings(
            self,
            values: Sequence[Any],
...
async def test_scoreless_results_remain_when_threshold_cannot_be_applied() -> None:
    """Validates behavior for scoreless results remain when threshold cannot be applied.
    """
    collection = MockCollection()
...
def test_filter_parser_and_default_mapper_edge_paths() -> None:
    """Validates behavior for filter parser and default mapper edge paths.
    """
    collection = MockCollection()
...
async def test_search_tool_filter_mapper_edge_paths() -> None:
    """Validates behavior for search tool filter mapper edge paths.
    """
    collection = MockCollection()
    parameters = {
        "type": "object",
...
async def test_runtime_operations_mark_vector_store_feature_usage() -> None:
    """Validates behavior for runtime operations mark vector store feature usage.
    """
    collection = MockCollection()
    store = MockStore(collection)
