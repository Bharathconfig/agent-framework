"""This module defines functionality for packages/core/tests/core/conftest.
...
def enable_function_calling(request: Any) -> bool:
    """Implements enable function calling.
...
def client(enable_function_calling: bool, max_iterations: int) -> MockChatClient:
    ...
    Args:
        enable_function_calling: Description of enable_function_calling.
        max_iterations: Description of max_iterations.
...
class MockAgentSession(AgentSession):
    """Represents the MockAgentSession type and related behavior.
    """
    pass
