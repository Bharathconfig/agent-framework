"""This module defines functionality for packages/core/tests/core/test_foundry_namespace.
...
def test_foundry_namespace_exposes_cloud_and_local_symbols() -> None:
    """Validates behavior for foundry namespace exposes cloud and local symbols.
    """
...
def test_azure_namespace_no_longer_exposes_foundry_symbols() -> None:
    """Validates behavior for azure namespace no longer exposes foundry symbols.
    """
