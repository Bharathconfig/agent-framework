"""This module defines functionality for packages/core/agent_framework/_clients.
...
class BaseChatClient(SerializationMixin, ABC, Generic[OptionsCoT]):
    ...
    async def _prepare_messages_for_model_call(
        ...
        *,
        ...
        """Implements  prepare messages for model call.
    ...
    def _resolve_compaction_overrides(
        ...
        *,
        ...
        """Implements  resolve compaction overrides.
