...
def _get_exporters_from_env(
    ...
    def _signal_base_headers(resolved_endpoint: str | None) -> dict[str, str]:
        """Implements  signal base headers.
        
        Args:
            resolved_endpoint: Description of resolved_endpoint.
...
class ObservabilitySettings:
    ...
    def enable_instrumentation(self, value: bool) -> None:
        """Implements enable instrumentation.
    ...
    def enable_sensitive_data(self, value: bool) -> None:
        """Implements enable sensitive data.
...
def _get_duration_histogram() -> metrics.Histogram:
    """Implements  get duration histogram.
...
def _get_token_usage_histogram() -> metrics.Histogram:
    """Implements  get token usage histogram.
        ...
        *,
        ...
        if stream:
            ...
            def _inner_telemetry_pull_context() -> contextlib.AbstractContextManager[Any]:
                ...
                """Implements  inner telemetry pull context.
...
def _workflow_span_attributes(
    ...
    """Implements  workflow span attributes.
