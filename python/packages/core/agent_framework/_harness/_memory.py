"""This module defines functionality for packages/core/agent_framework/_harness/_memory.
...
def _normalize_memory_text(memory: str) -> str:
    """Implements  normalize memory text.
...
def _trim_pointer_line(pointer_line: str, *, max_length: int) -> str:
    """Implements  trim pointer line.
    
    Args:
        pointer_line: Description of pointer_line.
...
def _select_recent_turn_messages(
    ...
    *,
    ...
    """Implements  select recent turn messages.
    
    Args:
        messages: Description of messages.
        turn_count: Description of turn_count.
        load_tool_turns: Description of load_tool_turns.
...
def _format_messages_for_memory_model(messages: Sequence[Message]) -> str:
    """Implements  format messages for memory model.
...
def _coerce_summary(summary: str, memories: Sequence[str]) -> str:
    """Implements  coerce summary.
    
    Args:
        summary: Description of summary.
        memories: Description of memories.
...
def _format_search_results(results: Sequence[Mapping[str, Any]]) -> str:
    """Implements  format search results.
...
class MemoryFileStore(MemoryStore):
    ...
    def _encode_path_component(value: str) -> str:
        """Implements  encode path component.
    ...
    def _get_topics_directory(self, session: AgentSession, *, source_id: str) -> Path:
        """Implements  get topics directory.
    ...
    def _serialize_json(value: object, *, dumps: JsonDumps) -> str:
        """Implements  serialize json.
        
        Args:
            value: Description of value.
            dumps: Description of dumps.
    ...
    def _decode_transcript_session_id(file_path: Path) -> str | None:
        """Implements  decode transcript session id.
...
class MemoryContextProvider(HistoryProvider):
    ...
    def _create_history_provider(self, session: AgentSession) -> FileHistoryProvider:
        """Implements  create history provider.
    ...
    def _chat_client(
        ...
        *,
        ...
        """Implements  chat client.
        
        Args:
            agent: Description of agent.
            override: Description of override.
    ...
    def _select_topics(
        ...
        *,
        ...
        """Implements  select topics.
        
        Args:
            self: Description of self.
            entries: Description of entries.
            input_messages: Description of input_messages.
