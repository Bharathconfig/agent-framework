    ...
    async def _judge(
        *, last_result: AgentResponse, original_messages: list[Message], **kwargs: Any
        ...
        Args:
            ...
            original_messages: Description of original_messages.
...
class AgentLoopMiddleware(AgentMiddleware):
    ...
    def _build_loop_kwargs(
        ...
        *,
        ...
        Args:
            ...
            last_result: Description of last_result.
            messages_used: Description of messages_used.
            original_messages: Description of original_messages.
    ...
    async def _resolve_next_message(
        ...
        """Implements  resolve next message.
        
        Args:
            self: Description of self.
            loop_kwargs: Description of loop_kwargs.
            messages_used: Description of messages_used.
            original_messages: Description of original_messages.
