...
class EvalItem:
    ...
    def __init__(
        ...
        Args:
            ...
            split_strategy: Description of split_strategy.
        """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            result_counts: Description of result_counts.
            report_url: Description of report_url.
            error: Description of error.
            per_evaluator: Description of per_evaluator.
            items: Description of items.
            sub_results: Description of sub_results.
        """
...
class _AgentEvalData(TypedDict):
    """Represents the _AgentEvalData type and related behavior.
    """
    executor_id: str
    query: str | Sequence[Message]
    response: AgentResponse[Any]
...
async def _run_evaluators(
    ...
    *,
    ...
    async def _run_single_evaluator(
        ...
        """Implements  run single evaluator.
        
        Args:
            ev: Description of ev.
            eval_items: Description of eval_items.
