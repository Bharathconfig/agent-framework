"""This module defines functionality for packages/core/agent_framework/_docstrings.
...
def _find_next_section_index(lines: list[str], start: int) -> int:
    """Implements  find next section index.
...
def _format_keyword_arg_lines(extra_keyword_args: Mapping[str, str]) -> list[str]:
    """Implements  format keyword arg lines.
    
    Args:
        extra_keyword_args: Description of extra_keyword_args.
