"""This module defines functionality for packages/core/agent_framework/_types.
...
def _restore_compaction_annotation_in_additional_properties(
    ...
    *,
    ...
    """Implements  restore compaction annotation in additional properties.
    
    Args:
        additional_properties: Description of additional_properties.
        allow_none: Description of allow_none.
...
def _parse_structured_response_value(text: str, response_format: Any | None) -> Any | None:
    """Implements  parse structured response value.
...
def _last_non_empty_assistant_message_text(messages: Sequence[Message]) -> str:
    """Implements  last non empty assistant message text.
...
def map_chat_to_agent_update(update: ChatResponseUpdate, agent_name: str | None) -> AgentResponseUpdate:
    """Implements map chat to agent update.
...
if TYPE_CHECKING:
    ...
    class ChatOptions(_ChatOptionsBase, Generic[ResponseModelT], total=False):
        """Represents the ChatOptions type and related behavior.
        """
...
class GeneratedEmbeddings(list[Embedding[EmbeddingT]], Generic[EmbeddingT, EmbeddingOptionsT]):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            self: Description of self.
            embeddings: Description of embeddings.
