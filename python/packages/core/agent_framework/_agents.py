"""This module defines functionality for packages/core/agent_framework/_agents.
...
class _RunContext(TypedDict):
    """Represents the _RunContext type and related behavior.
    """
...
class RawAgent(BaseAgent, Generic[OptionsCoT]):
    ...
    def _get_history_providers(self) -> list[HistoryProvider]:
        """Implements  get history providers.
    ...
    def _resolve_per_service_call_history_providers(
        ...
        *,
        ...
        """Implements  resolve per service call history providers.
        
        Args:
            self: Description of self.
            session: Description of session.
            conversation_id: Description of conversation_id.
            service_stores_history: Description of service_stores_history.
    ...
    def run(
        ...
        *,
        ...
        async def _prepare_run_context() -> _RunContext:
            """Implements  prepare run context.
