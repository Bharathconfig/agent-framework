"""This module defines functionality for packages/core/agent_framework/_mcp.
...
def _make_mcp_tool_caller(
    ...
    async def _call_tool_with_runtime_kwargs(
        ...
        **kwargs: Any,
        ...
        """Implements  call tool with runtime kwargs.
...
class MCPTool:
    ...
    async def _ensure_lifecycle_owner(self) -> None:
        """Implements  ensure lifecycle owner.
    ...
    async def _run_lifecycle_owner(self) -> None:
        """Implements  run lifecycle owner.
    ...
    def _is_lifecycle_owner_task(self) -> bool:
        """Implements  is lifecycle owner task.
    ...
    async def _run_on_lifecycle_owner(
        ...
        *,
        ...
        """Implements  run on lifecycle owner.
        
        Args:
            self: Description of self.
            action: Description of action.
            reset: Description of reset.
            load_configured: Description of load_configured.
        """
    ...
    def _reset_session_state(self) -> None:
        """Implements  reset session state.
    ...
    def _set_server_capabilities(self, capabilities: types.ServerCapabilities | None) -> None:
        """Implements  set server capabilities.
    ...
    async def _reconnect_without_loading(self) -> None:
        """Implements  reconnect without loading.
    ...
    def _determine_approval_mode(
        ...
        *candidate_names: str,
        ...
        """Implements  determine approval mode.
        
        Args:
            self: Description of self.
            *candidate_names: Description of candidate_names.
    ...
    async def _load_prompts_locked(self) -> None:
        """Implements  load prompts locked.
    ...
    async def call_tool_as_task(self, tool_name: str, **kwargs: Any) -> str | list[Content]:
        ...
        async def _await_task_completion() -> str | list[Content]:
            """Implements  await task completion.
...
class MCPStdioTool(MCPTool):
    ...
    def _mcp_base_span_attributes(self) -> dict[str, Any]:
        """Implements  mcp base span attributes.
