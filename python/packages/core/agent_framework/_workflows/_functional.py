...
class WorkflowInterrupted(BaseException):
    ...
    def __init__(self, request_id: str, request_data: Any, response_type: type) -> None:
        ...
        Args:
            ...
            request_id: Description of request_id.
            request_data: Description of request_data.
...
class RunContext:
    ...
    * Workflow-scoped key/value state: :meth:`get_state` / :meth:`set_state`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            run_kwargs: Description of run_kwargs.
        """
    ...
    def _get_step_cache_key(self, step_name: str) -> tuple[str, int]:
        """Implements  get step cache key.
        
        Args:
            self: Description of self.
            step_name: Description of step_name.
    ...
    def _set_cached_step_auto_request_info_count(self, key: tuple[str, int], count: int) -> None:
        """Implements  set cached step auto request info count.
    ...
    def _advance_auto_request_info_index_for_cached_step(self, key: tuple[str, int]) -> None:
        """Implements  advance auto request info index for cached step.
...
class FunctionalWorkflow:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            name: Description of name.
            description: Description of description.
            checkpoint_storage: Description of checkpoint_storage.
        """
        self._func = func
        self.name = name or func.__name__
        self.description = description
    ...
    def _finalize_events(
        ...
        *,
        ...
        """Implements  finalize events.
        
        Args:
            events: Description of events.
            include_status_events: Description of include_status_events.
    ...
    def _validate_run_params(
        ...
        """Implements  validate run params.
...
class FunctionalWorkflowAgent:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            name: Description of name.
            description: Description of description.
            context_providers: Description of context_providers.
            **kwargs: Description of kwargs.
        """
        del kwargs
    ...
    def _result_to_agent_response(self, result: WorkflowRunResult) -> AgentResponse:
        """Implements  result to agent response.
