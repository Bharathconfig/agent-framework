"""This module defines functionality for packages/core/agent_framework/_workflows/_validation.
...
class WorkflowValidationError(WorkflowException):
    ...
    def __init__(self, message: str, validation_type: ValidationTypeEnum):
        ...
        Args:
            ...
            validation_type: Description of validation_type.
        """
...
class EdgeDuplicationError(WorkflowValidationError):
    ...
    def __init__(self, edge_id: str):
        ...
        Args:
            self: Description of self.
            edge_id: Description of edge_id.
        """
        super().__init__(
...
class TypeCompatibilityError(WorkflowValidationError):
    ...
    def __init__(
        ...
        Args:
            self: Description of self.
            source_executor_id: Description of source_executor_id.
            target_executor_id: Description of target_executor_id.
            source_types: Description of source_types.
            target_types: Description of target_types.
        """
        super().__init__(
