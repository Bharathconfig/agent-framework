"""This module defines functionality for packages/core/agent_framework/_workflows/_agent.
...
class WorkflowAgent(BaseAgent):
    ...
    class RequestInfoFunctionArgs:
        """Represents the RequestInfoFunctionArgs type and related behavior.
        """
        request_id: str
    ...
    def merge_updates(updates: list[AgentResponseUpdate], response_id: str) -> AgentResponse:
        ...
        def _merge_responses(current: AgentResponse | None, incoming: AgentResponse) -> AgentResponse:
            """Implements  merge responses.
            
            Args:
                current: Description of current.
                incoming: Description of incoming.
