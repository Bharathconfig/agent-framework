"""This module defines functionality for packages/core/agent_framework/_workflows/_runner.
    ...
    async def _run_iteration(self) -> None:
        ...
        async def _deliver_messages(source_executor_id: str, source_messages: list[WorkflowMessage]) -> None:
            ...
            async def _deliver_messages_for_edge_runner(edge_runner: EdgeRunner) -> None:
                ...
                """Implements  deliver messages for edge runner.
                
                Args:
                    edge_runner: Description of edge_runner.
                """
