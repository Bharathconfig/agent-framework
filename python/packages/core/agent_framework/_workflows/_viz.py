"""This module defines functionality for packages/core/agent_framework/_workflows/_viz.
...
class WorkflowViz:
    ...
    def _emit_workflow_mermaid(
        ...
        """Implements  emit workflow mermaid.
        ...
        Args:
            ...
            ns: Description of ns.
            include_internal_executors: Description of include_internal_executors.
    ...
    def _emit_sub_workflows_mermaid(
        ...
        """Implements  emit sub workflows mermaid.
