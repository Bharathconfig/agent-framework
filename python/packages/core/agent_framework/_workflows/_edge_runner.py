"""This module defines functionality for packages/core/agent_framework/_workflows/_edge_runner.
...
class SingleEdgeRunner(EdgeRunner):
    ...
    def __init__(self, edge_group: SingleEdgeGroup | InternalEdgeGroup, executors: dict[str, Executor]) -> None:
        ...
        Args:
            ...
            edge_group: Description of edge_group.
            executors: Description of executors.
        """
