"""This module defines functionality for packages/bedrock/tests/test_bedrock_structured_output.
...
class WeatherReport(BaseModel):
    """Represents the WeatherReport type and related behavior.
    """
    city: str
    temperature: float
    summary: str
...
class NestedAddress(BaseModel):
    """Represents the NestedAddress type and related behavior.
    """
    street: str
    city: str
    zip_code: str
...
class Person(BaseModel):
    """Represents the Person type and related behavior.
    """
    name: str
    age: int
...
async def test_unsupported_model_validation_exception() -> None:
    ...
    class _FailingStubBedrockRuntime:
        """Represents the _FailingStubBedrockRuntime type and related behavior.
        """
        def converse(self, **kwargs: Any) -> dict[str, Any]:
...
def test_mapping_response_format_accepted() -> None:
    ...
    class _WrappedMapping(MutableMapping):
        """Represents the _WrappedMapping type and related behavior.
        """
