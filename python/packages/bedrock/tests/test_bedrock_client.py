"""This module defines functionality for packages/bedrock/tests/test_bedrock_client.
...
class _StubBedrockRuntime:
    """Represents the _StubBedrockRuntime type and related behavior.
    """
...
def test_agent_accepts_bedrock_chat_client() -> None:
    """Validates behavior for agent accepts bedrock chat client.
    """
    client = _make_client()
...
async def test_get_response_invokes_bedrock_runtime() -> None:
    """Validates behavior for get response invokes bedrock runtime.
    """
...
def test_build_request_requires_non_system_messages() -> None:
    """Validates behavior for build request requires non system messages.
    """
    client = BedrockChatClient(
        model="amazon.titan-text",
        region="us-west-2",
...
def test_init_uses_boto3_session_when_runtime_client_not_supplied() -> None:
    ...
    class _FakeSession:
        """Represents the _FakeSession type and related behavior.
        """
        def __init__(self) -> None:
            """Initializes a new instance.
        ...
        def client(self, service_name: str, *, region_name: str, config: Any) -> _StubBedrockRuntime:
            ...
            Args:
                ...
                region_name: Description of region_name.
...
def test_invoke_converse_requires_mapping_response() -> None:
    ...
    class _BadRuntime:
        """Represents the _BadRuntime type and related behavior.
        """
...
def test_tool_result_helpers_cover_text_json_and_sequence_values() -> None:
    ...
    class _Serializable:
        """Represents the _Serializable type and related behavior.
        """
