"""This module defines functionality for packages/bedrock/agent_framework_bedrock/_chat_client.
...
class BedrockChatClient(
    ...
    def _prepare_bedrock_messages(
        ...
        """Implements  prepare bedrock messages.
    ...
    def _align_tool_results_with_pending(
        ...
        """Implements  align tool results with pending.
        
        Args:
            self: Description of self.
            content_blocks: Description of content_blocks.
            pending_tool_use_ids: Description of pending_tool_use_ids.
    ...
    def _convert_message_to_content_blocks(self, message: Message) -> list[dict[str, Any]]:
        """Implements  convert message to content blocks.
    ...
    def _convert_content_to_bedrock_block(self, content: Content) -> dict[str, Any] | None:
        """Implements  convert content to bedrock block.
    ...
    def _convert_tool_result_to_blocks(self, result: Any) -> list[dict[str, Any]]:
        """Implements  convert tool result to blocks.
    ...
    def _convert_prepared_tool_result_to_blocks(self, value: object) -> list[dict[str, Any]]:
        """Implements  convert prepared tool result to blocks.
    ...
    def _normalize_tool_result_value(self, value: object) -> dict[str, Any]:
        """Implements  normalize tool result value.
    ...
    def _generate_tool_call_id() -> str:
        """Implements  generate tool call id.
    ...
    def _convert_bedrock_tool_result_to_value(self, content: object) -> object:
        """Implements  convert bedrock tool result to value.
