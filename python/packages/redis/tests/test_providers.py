...
async def test_empty_history_save_marks_redis_used() -> None:
    """Validates behavior for empty history save marks redis used.
    """
...
def patch_index_from_dict(mock_index: AsyncMock):
    """Implements patch index from dict.
    
    Args:
        mock_index: Description of mock_index.
    ...
    with patch("agent_framework_redis._context_provider.AsyncSearchIndex") as mock_cls:
        ...
        async def mock_from_existing(index_name: str, redis_url: str):  # noqa: ARG001
            """Implements mock from existing.
            
            Args:
                index_name: Description of index_name.
...
class TestRedisContextProviderInit:
    """Represents the TestRedisContextProviderInit type and related behavior.
    """
    def test_basic_construction(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        ...
        Args:
            ...
            patch_index_from_dict: Description of patch_index_from_dict.
        """
    ...
    def test_custom_params(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        """Validates behavior for custom params.
    ...
    def test_invalid_vectorizer_raises(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        """Validates behavior for invalid vectorizer raises.
...
class TestRedisContextProviderValidateFilters:
    """Represents the TestRedisContextProviderValidateFilters type and related behavior.
    """
    def test_no_filters_raises(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        """Validates behavior for no filters raises.
    ...
    def test_any_single_filter_ok(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        """Validates behavior for any single filter ok.
...
class TestRedisContextProviderSchema:
    """Represents the TestRedisContextProviderSchema type and related behavior.
    """
    def test_schema_has_expected_fields(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        """Validates behavior for schema has expected fields.
    ...
    def test_schema_no_vector_without_vectorizer(self, patch_index_from_dict: MagicMock):  # noqa: ARG002
        """Validates behavior for schema no vector without vectorizer.
...
class TestRedisContextProviderBeforeRun:
    """Represents the TestRedisContextProviderBeforeRun type and related behavior.
    """
    async def test_search_results_added_to_context(
        ...
        """Validates behavior for search results added to context.
    ...
    async def test_empty_results_no_messages(
        ...
        """Validates behavior for empty results no messages.
...
class TestRedisContextProviderAfterRun:
    """Represents the TestRedisContextProviderAfterRun type and related behavior.
    """
    async def test_stores_messages(
        ...
        """Validates behavior for stores messages.
    ...
    async def test_skips_empty_conversations(
        ...
        """Validates behavior for skips empty conversations.
    ...
    async def test_stores_partition_fields(
        ...
        """Validates behavior for stores partition fields.
...
class TestRedisContextProviderContextManager:
    """Represents the TestRedisContextProviderContextManager type and related behavior.
    """
...
class TestRedisHistoryProviderInit:
    """Represents the TestRedisHistoryProviderInit type and related behavior.
    """
    def test_basic_construction(self, mock_redis_client: MagicMock):
        ...
        Args:
            self: Description of self.
            mock_redis_client: Description of mock_redis_client.
        """
    ...
    def test_no_redis_url_or_credential_raises(self):
        """Validates behavior for no redis url or credential raises.
    ...
    def test_both_url_and_credential_raises(self):
        """Validates behavior for both url and credential raises.
    ...
    def test_credential_provider_without_host_raises(self):
        """Validates behavior for credential provider without host raises.
    ...
    def test_negative_max_messages_raises(self):
        """Validates behavior for negative max messages raises.
    ...
    def test_credential_provider_with_host(self):
        """Validates behavior for credential provider with host.
...
class TestRedisHistoryProviderRedisKey:
    """Represents the TestRedisHistoryProviderRedisKey type and related behavior.
    """
    def test_key_format(self, mock_redis_client: MagicMock):
        """Validates behavior for key format.
...
class TestRedisHistoryProviderGetMessages:
    """Represents the TestRedisHistoryProviderGetMessages type and related behavior.
    """
    async def test_returns_deserialized_messages(self, mock_redis_client: MagicMock):
        """Validates behavior for returns deserialized messages.
    ...
    async def test_empty_returns_empty(self, mock_redis_client: MagicMock):
        """Validates behavior for empty returns empty.
...
class TestRedisResultHelper:
    """Represents the TestRedisResultHelper type and related behavior.
    """
    async def test_awaits_an_awaitable_result(self):
        """Validates behavior for awaits an awaitable result.
    ...
    async def test_passes_through_a_plain_result(self):
        """Validates behavior for passes through a plain result.
...
class TestRedisHistoryProviderSaveMessages:
    """Represents the TestRedisHistoryProviderSaveMessages type and related behavior.
    """
    async def test_saves_serialized_messages(self, mock_redis_client: MagicMock):
        """Validates behavior for saves serialized messages.
    ...
    async def test_empty_messages_noop(self, mock_redis_client: MagicMock):
        """Validates behavior for empty messages noop.
    ...
    async def test_max_messages_trimming(self, mock_redis_client: MagicMock):
        """Validates behavior for max messages trimming.
    ...
    async def test_no_trim_when_under_limit(self, mock_redis_client: MagicMock):
        """Validates behavior for no trim when under limit.
...
class TestRedisHistoryProviderClear:
    """Represents the TestRedisHistoryProviderClear type and related behavior.
    """
    async def test_clear_calls_delete(self, mock_redis_client: MagicMock):
        """Validates behavior for clear calls delete.
...
class TestRedisHistoryProviderBeforeAfterRun:
    ...
    async def test_before_run_loads_history(self, mock_redis_client: MagicMock):
        """Validates behavior for before run loads history.
    ...
    async def test_after_run_stores_input_and_response(self, mock_redis_client: MagicMock):
        """Validates behavior for after run stores input and response.
    ...
    async def test_after_run_skips_when_no_messages(self, mock_redis_client: MagicMock):
        """Validates behavior for after run skips when no messages.
...
class TestRedisHistoryProviderDeduplication:
    ...
    async def test_deduplicates_identical_messages(self, mock_redis_client: MagicMock):
        """Validates behavior for deduplicates identical messages.
    ...
    async def test_only_appends_new_messages(self, mock_redis_client: MagicMock):
        """Validates behavior for only appends new messages.
    ...
    async def test_different_roles_same_text_not_deduplicated(self, mock_redis_client: MagicMock):
        """Validates behavior for different roles same text not deduplicated.
