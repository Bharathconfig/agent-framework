...
def parse_args(argv: list[str]) -> tuple[argparse.Namespace, list[str]]:
    ...
    def add_syntax_mode_options(command: argparse.ArgumentParser) -> None:
        """Implements add syntax mode options.
