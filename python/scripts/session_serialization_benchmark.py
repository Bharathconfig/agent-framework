...
def _pydantic_json_encode(value: dict[str, Any]) -> bytes:
    """Implements  pydantic json encode.
...
def _pydantic_json_decode(value: bytes) -> Any:
    """Implements  pydantic json decode.
...
def _encode_via_dict(
    ...
    """Implements  encode via dict.
    
    Args:
        session: Description of session.
        encoder: Description of encoder.
...
def _decode_via_dict(
    ...
    *,
    ...
    """Implements  decode via dict.
    
    Args:
        payload: Description of payload.
        decoder: Description of decoder.
        codec_name: Description of codec_name.
...
def _struct_dec_hook(target_type: type[Any], value: Any) -> Any:
    """Implements  struct dec hook.
    
    Args:
        target_type: Description of target_type.
        value: Description of value.
...
def _percentile(values: list[int], percentile: float) -> float:
    """Implements  percentile.
    
    Args:
        values: Description of values.
        percentile: Description of percentile.
