...
def _coerce_subprocess_output(output: str | bytes | None) -> str:
    """Implements  coerce subprocess output.
...
def _run_test_mode(
    *,
    ...
    Args:
        ...
        timeout_seconds: Description of timeout_seconds.
        dry_run: Description of dry_run.
        output_json: Description of output_json.
...
def _build_optimizer_command(
    *,
    ...
    """Implements  build optimizer command.
    ...
    Args:
        ...
        parallelism: Description of parallelism.
        max_candidates: Description of max_candidates.
        version_source: Description of version_source.
        timeout_seconds: Description of timeout_seconds.
        dry_run: Description of dry_run.
        output_json: Description of output_json.
