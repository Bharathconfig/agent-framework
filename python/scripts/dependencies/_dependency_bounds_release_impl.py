...
def _string_requirements(values: object) -> tuple[str, ...]:
    """Implements  string requirements.
...
def _load_release_project(workspace_root: Path, project_path: Path) -> ReleaseProject:
    """Implements  load release project.
...
def _build_release_project_map(workspace_root: Path) -> dict[str, ReleaseProject]:
    """Implements  build release project map.
...
def _changed_release_project_paths(workspace_root: Path, base_ref: str) -> set[Path]:
    """Implements  changed release project paths.
    
    Args:
        workspace_root: Description of workspace_root.
        base_ref: Description of base_ref.
...
def _selected_release_projects(
    *,
    ...
    """Implements  selected release projects.
    
    Args:
        workspace_root: Description of workspace_root.
        projects: Description of projects.
        base_ref: Description of base_ref.
        package_filter: Description of package_filter.
...
def _requirements_for_extras(project: ReleaseProject, extras: set[str]) -> tuple[str, ...]:
    """Implements  requirements for extras.
    
    Args:
        project: Description of project.
        extras: Description of extras.
...
def _build_release_probe_command(
    ...
    *,
    ...
    """Implements  build release probe command.
    
    Args:
        plan: Description of plan.
        resolution: Description of resolution.
        python_override: Description of python_override.
...
def _parse_probe_payload(stdout: str) -> dict[str, Any] | None:
    """Implements  parse probe payload.
...
def _run_release_probe(
    ...
    *,
    ...
    """Implements  run release probe.
    
    Args:
        plan: Description of plan.
        scenario_name: Description of scenario_name.
        resolution: Description of resolution.
        python_override: Description of python_override.
